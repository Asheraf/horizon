...
function CZ_UPGRADE_SKILLLEVEL.new(o)
	o = o or CZ_UPGRADE_SKILLLEVEL
	setmetatable(o, self)
	self.__index = self
	return o
end

function CZ_UPGRADE_SKILLLEVEL.deserialize(buf)

end

return CZ_UPGRADE_SKILLLEVEL

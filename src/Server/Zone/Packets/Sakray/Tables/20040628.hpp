...
#ifndef HORIZON_ZONE_SHUFFLE_PACKET_LENGTH_TABLE_20040628
#define HORIZON_ZONE_SHUFFLE_PACKET_LENGTH_TABLE_20040628
...
#define ADD_PKT(i, j, k) _packet_length_table.insert(i, std::make_pair<uint16_t, NetworkPacket>(j, k))
		ADD_PKT(0x0208, 11, CZ_ACK_REQ_ADD_FRIENDS(sock));
...
#endif /* HORIZON_ZONE_SHUFFLE_PACKET_LENGTH_TABLE_20040628 */
...
#ifndef HORIZON_ZONE_CZ_CHANGE_CHATROOM_HPP
#define HORIZON_ZONE_CZ_CHANGE_CHATROOM_HPP
...
/**
 * @brief Main object for the aegis packet: CZ_CHANGE_CHATROOM
 * Size : -1 @ 0
 *
 */ 
class CZ_CHANGE_CHATROOM : public Base::NetworkPacket<ZoneSocket>
{
public:
	CZ_CHANGE_CHATROOM(std::shared_ptr<ZoneSocket> sock);
	~CZ_CHANGE_CHATROOM();
...
#endif /* HORIZON_ZONE_CZ_CHANGE_CHATROOM_HPP */

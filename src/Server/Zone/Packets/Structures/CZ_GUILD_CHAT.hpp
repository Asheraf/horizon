...
#ifndef HORIZON_ZONE_CZ_GUILD_CHAT_HPP
#define HORIZON_ZONE_CZ_GUILD_CHAT_HPP
...
/**
 * @brief Main object for the aegis packet: CZ_GUILD_CHAT
 * Size : -1 @ 0
 *
 */ 
class CZ_GUILD_CHAT : public Base::NetworkPacket<ZoneSocket>
{
public:
	CZ_GUILD_CHAT(std::shared_ptr<ZoneSocket> sock);
	~CZ_GUILD_CHAT();
...
#endif /* HORIZON_ZONE_CZ_GUILD_CHAT_HPP */

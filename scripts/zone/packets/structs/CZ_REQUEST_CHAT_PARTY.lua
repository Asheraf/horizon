...
function CZ_REQUEST_CHAT_PARTY.new(o)
	o = o or CZ_REQUEST_CHAT_PARTY
	setmetatable(o, self)
	self.__index = self
	return o
end

function CZ_REQUEST_CHAT_PARTY.deserialize(buf)

end

return CZ_REQUEST_CHAT_PARTY

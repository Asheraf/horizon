...
#ifndef HORIZON_ZONE_RE_20170329_PACKETS_HPP
#define HORIZON_ZONE_RE_20170329_PACKETS_HPP
...
enum packets
{
	CZ_ACK_STORE_PASSWORD = 0x085d,
	CZ_ADD_FRIENDS = 0x0939,
	CZ_CHANGE_DIRECTION = 0x0926,
	CZ_COMMAND_MER = 0x0362,
	CZ_ENTER = 0x092e,
	CZ_GANGSI_RANK = 0x095f,
	CZ_ITEMLISTWIN_RES = 0x0937,
	CZ_ITEM_PICKUP = 0x0929,
	CZ_ITEM_THROW = 0x08a8,
	CZ_JOIN_BATTLE_FIELD = 0x0917,
	CZ_MOVE_ITEM_FROM_BODY_TO_STORE = 0x0363,
	CZ_MOVE_ITEM_FROM_STORE_TO_BODY = 0x0949,
	CZ_PARTY_BOOKING_REQ_REGISTER = 0x087a,
	CZ_PARTY_JOIN_REQ = 0x0281,
	CZ_REQNAME = 0x096a,
...
#endif /* HORIZON_ZONE_RE_20170329_PACKETS_HPP */

...
#ifndef HORIZON_ZONE_SHUFFLE_PACKET_LENGTH_TABLE_20110726
#define HORIZON_ZONE_SHUFFLE_PACKET_LENGTH_TABLE_20110726
...
#define ADD_PKT(i, j, k) _packet_length_table.insert(i, std::make_pair<uint16_t, NetworkPacket>(j, k))
		...
		ADD_PKT(0x022d, 12, CZ_COMMAND_MER(sock));
		...
		ADD_PKT(0x0811, 5, CZ_REQ_OPEN_BUYING_STORE(sock));
...
#endif /* HORIZON_ZONE_SHUFFLE_PACKET_LENGTH_TABLE_20110726 */
...
#ifndef HORIZON_ZONE_CZ_LOCALBROADCAST_HPP
#define HORIZON_ZONE_CZ_LOCALBROADCAST_HPP
...
/**
 * @brief Main object for the aegis packet: CZ_LOCALBROADCAST
 * Size : -1 @ 0
 *
 */ 
class CZ_LOCALBROADCAST : public Base::NetworkPacket<ZoneSocket>
{
public:
	CZ_LOCALBROADCAST(std::shared_ptr<ZoneSocket> sock);
	~CZ_LOCALBROADCAST();
...
#endif /* HORIZON_ZONE_CZ_LOCALBROADCAST_HPP */

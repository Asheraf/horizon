...
#ifndef HORIZON_ZONE_ZC_WAIT_CoreLog_HPP
#define HORIZON_ZONE_ZC_WAIT_CoreLog_HPP
...
/**
 * @brief Main object for the aegis packet: ZC_WAIT_CoreLog
 * Size : 6 @ 0
 *
 */ 
class ZC_WAIT_CoreLog : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_WAIT_CoreLog(std::shared_ptr<ZoneSocket> sock);
	~ZC_WAIT_CoreLog();
...
#endif /* HORIZON_ZONE_ZC_WAIT_CoreLog_HPP */

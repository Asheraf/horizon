...
#ifndef HORIZON_ZONE_SHUFFLE_PACKET_LENGTH_TABLE_20111108
#define HORIZON_ZONE_SHUFFLE_PACKET_LENGTH_TABLE_20111108
...
#define ADD_PKT(i, j, k) _packet_length_table.insert(i, std::make_pair<uint16_t, NetworkPacket>(j, k))
		...
		ADD_PKT(0x07ec, 18, CZ_JOIN_BATTLE_FIELD(sock));
		ADD_PKT(0x0364, -1, CZ_MOVE_ITEM_FROM_BODY_TO_STORE2(sock));
		ADD_PKT(0x0365, 10, CZ_MOVE_ITEM_FROM_STORE_TO_BODY2(sock));
		...
		ADD_PKT(0x0815, 36, CZ_REQ_CLOSE_BUYING_STORE(sock));
		...
		ADD_PKT(0x08e2, 25, ZC_NAVIGATION_ACTIVE(sock));
...
#endif /* HORIZON_ZONE_SHUFFLE_PACKET_LENGTH_TABLE_20111108 */
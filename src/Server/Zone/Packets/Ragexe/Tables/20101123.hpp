...
#ifndef HORIZON_ZONE_SHUFFLE_PACKET_LENGTH_TABLE_20101123
#define HORIZON_ZONE_SHUFFLE_PACKET_LENGTH_TABLE_20101123
...
#define ADD_PKT(i, j, k) _packet_length_table.insert(i, std::make_pair<uint16_t, NetworkPacket>(j, k))
		...
		ADD_PKT(0x0365, 36, CZ_MOVE_ITEM_FROM_STORE_TO_BODY2(sock));
		ADD_PKT(0x0802, 5, CZ_PARTY_BOOKING_REQ_REGISTER(sock));
		...
		ADD_PKT(0x0817, 8, CZ_REQ_CLICK_TO_BUYING_STORE(sock));
		...
		ADD_PKT(0x083c, 7, CZ_SSILIST_ITEM_CLICK(sock));
...
#endif /* HORIZON_ZONE_SHUFFLE_PACKET_LENGTH_TABLE_20101123 */
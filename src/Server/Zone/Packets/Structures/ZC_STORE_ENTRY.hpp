...
#ifndef HORIZON_ZONE_ZC_STORE_ENTRY_HPP
#define HORIZON_ZONE_ZC_STORE_ENTRY_HPP
 ...
 *
 */ 
class ZC_STORE_ENTRY : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_STORE_ENTRY(std::shared_ptr<ZoneSocket> sock);
	~ZC_STORE_ENTRY();
...
#endif /* HORIZON_ZONE_ZC_STORE_ENTRY_HPP */

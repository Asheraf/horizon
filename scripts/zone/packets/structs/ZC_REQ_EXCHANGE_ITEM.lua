...
function ZC_REQ_EXCHANGE_ITEM.new(o)
	o = o or ZC_REQ_EXCHANGE_ITEM
	setmetatable(o, self)
	self.__index = self
	return o
end

function ZC_REQ_EXCHANGE_ITEM.serialize()

end

return ZC_REQ_EXCHANGE_ITEM

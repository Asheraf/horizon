...
d:add(0x093e, 36, require('CZ_ACK_STORE_PASSWORD'))
d:add(0x0962, 26, require('CZ_ADD_FRIENDS'))
d:add(0x0362, 5, require('CZ_CHANGE_DIRECTION'))
d:add(0x0931, 5, require('CZ_COMMAND_MER'))
d:add(0x0943, 19, require('CZ_ENTER'))
d:add(0x0862, 4, require('CZ_GANGSI_RANK'))
d:add(0x0963, -1, require('CZ_ITEMLISTWIN_RES'))
d:add(0x08a1, 6, require('CZ_ITEM_PICKUP'))
d:add(0x0944, 6, require('CZ_ITEM_THROW'))
...
d:add(0x0947, 26, require('CZ_PARTY_JOIN_REQ'))

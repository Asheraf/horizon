...
d:add(0x088b, 36, require('CZ_ACK_STORE_PASSWORD'))
d:add(0x0921, 26, require('CZ_ADD_FRIENDS'))
d:add(0x092e, 5, require('CZ_CHANGE_DIRECTION'))
d:add(0x035f, 5, require('CZ_COMMAND_MER'))
d:add(0x0925, 19, require('CZ_ENTER'))
d:add(0x0957, 4, require('CZ_GANGSI_RANK'))
d:add(0x0946, -1, require('CZ_ITEMLISTWIN_RES'))
d:add(0x0943, 6, require('CZ_ITEM_PICKUP'))
d:add(0x093c, 6, require('CZ_ITEM_THROW'))
d:add(0x092f, 8, require('CZ_JOIN_BATTLE_FIELD'))
d:add(0x086b, 8, require('CZ_MOVE_ITEM_FROM_BODY_TO_STORE'))
d:add(0x08ab, 8, require('CZ_MOVE_ITEM_FROM_STORE_TO_BODY'))
d:add(0x095c, 18, require('CZ_PARTY_BOOKING_REQ_REGISTER'))
d:add(0x0365, 26, require('CZ_PARTY_JOIN_REQ'))
...
d:add(0x022d, 6, require('CZ_REQUEST_TIME'))

...
function CZ_REQ_MAKINGARROW.new(o)
	o = o or CZ_REQ_MAKINGARROW
	setmetatable(o, self)
	self.__index = self
	return o
end

function CZ_REQ_MAKINGARROW.deserialize(buf)

end

return CZ_REQ_MAKINGARROW

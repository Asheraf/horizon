...
#ifndef HORIZON_ZONE_ZC_ADD_SKILL_HPP
#define HORIZON_ZONE_ZC_ADD_SKILL_HPP
 ...
 *
 */ 
class ZC_ADD_SKILL : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_ADD_SKILL(std::shared_ptr<ZoneSocket> sock);
	~ZC_ADD_SKILL();
...
#endif /* HORIZON_ZONE_ZC_ADD_SKILL_HPP */

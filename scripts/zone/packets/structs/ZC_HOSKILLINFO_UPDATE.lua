...
elseif packet_version >= 20080102 then
	local pid = 0x0239
elseif packet_version >= 20050531 then
	local pid = 0x0239
...
function ZC_HOSKILLINFO_UPDATE.new(o)
	o = o or ZC_HOSKILLINFO_UPDATE
	setmetatable(o, self)
	self.__index = self
	return o
end

function ZC_HOSKILLINFO_UPDATE.serialize()

end

return ZC_HOSKILLINFO_UPDATE

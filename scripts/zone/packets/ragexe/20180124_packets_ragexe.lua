...
d:add(0x085f, 36, require('CZ_ACK_STORE_PASSWORD'))
d:add(0x0919, 26, require('CZ_ADD_FRIENDS'))
d:add(0x0958, 5, require('CZ_CHANGE_DIRECTION'))
...
d:add(0x0436, 8, require('CZ_MOVE_ITEM_FROM_BODY_TO_STORE'))
d:add(0x0890, 8, require('CZ_MOVE_ITEM_FROM_STORE_TO_BODY'))
d:add(0x086a, 18, require('CZ_PARTY_BOOKING_REQ_REGISTER'))
d:add(0x087a, 26, require('CZ_PARTY_JOIN_REQ'))

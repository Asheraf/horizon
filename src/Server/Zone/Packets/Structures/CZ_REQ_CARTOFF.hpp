...
#ifndef HORIZON_ZONE_CZ_REQ_CARTOFF_HPP
#define HORIZON_ZONE_CZ_REQ_CARTOFF_HPP
...
/**
 * @brief Main object for the aegis packet: CZ_REQ_CARTOFF
 * Size : 2 @ 0
 *
 */ 
class CZ_REQ_CARTOFF : public Base::NetworkPacket<ZoneSocket>
{
public:
	CZ_REQ_CARTOFF(std::shared_ptr<ZoneSocket> sock);
	~CZ_REQ_CARTOFF();
...
#endif /* HORIZON_ZONE_CZ_REQ_CARTOFF_HPP */

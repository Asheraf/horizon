...
function ZC_REQ_EXCHANGE_ITEM2.new(o)
	o = o or ZC_REQ_EXCHANGE_ITEM2
	setmetatable(o, self)
	self.__index = self
	return o
end

function ZC_REQ_EXCHANGE_ITEM2.serialize()

end

return ZC_REQ_EXCHANGE_ITEM2

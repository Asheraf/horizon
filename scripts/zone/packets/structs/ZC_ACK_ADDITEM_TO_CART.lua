...
function ZC_ACK_ADDITEM_TO_CART.new(o)
	o = o or ZC_ACK_ADDITEM_TO_CART
	setmetatable(o, self)
	self.__index = self
	return o
end

function ZC_ACK_ADDITEM_TO_CART.serialize()

end

return ZC_ACK_ADDITEM_TO_CART

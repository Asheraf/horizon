...
local ZC_NOTIFY_CARTITEM_COUNTINFO = {
	_id = pid,
	_length = 0,
	_buffer = nil
}
...
function ZC_NOTIFY_CARTITEM_COUNTINFO.new(o)
	o = o or ZC_NOTIFY_CARTITEM_COUNTINFO
	setmetatable(o, self)
	self.__index = self
	return o
end

function ZC_NOTIFY_CARTITEM_COUNTINFO.serialize()

end

return ZC_NOTIFY_CARTITEM_COUNTINFO

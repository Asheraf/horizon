...
#ifndef HORIZON_ZONE_ZC_ITEM_THROW_ACK_HPP
#define HORIZON_ZONE_ZC_ITEM_THROW_ACK_HPP
 ...
 *
 */ 
class ZC_ITEM_THROW_ACK : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_ITEM_THROW_ACK(std::shared_ptr<ZoneSocket> sock);
	~ZC_ITEM_THROW_ACK();
...
#endif /* HORIZON_ZONE_ZC_ITEM_THROW_ACK_HPP */

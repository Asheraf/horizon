...
#ifndef HORIZON_ZONE_ZC_OPENSTORE_HPP
#define HORIZON_ZONE_ZC_OPENSTORE_HPP
 ...
 *
 */ 
class ZC_OPENSTORE : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_OPENSTORE(std::shared_ptr<ZoneSocket> sock);
	~ZC_OPENSTORE();
...
#endif /* HORIZON_ZONE_ZC_OPENSTORE_HPP */

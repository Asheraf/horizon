...
#ifndef HORIZON_ZONE_ZC_ACTION_FAILURE_HPP
#define HORIZON_ZONE_ZC_ACTION_FAILURE_HPP
 ...
 *
 */ 
class ZC_ACTION_FAILURE : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_ACTION_FAILURE(std::shared_ptr<ZoneSocket> sock);
	~ZC_ACTION_FAILURE();
...
#endif /* HORIZON_ZONE_ZC_ACTION_FAILURE_HPP */

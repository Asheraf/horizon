...
#ifndef HORIZON_ZONE_ZC_NOTIFY_MOVEENTRY3_HPP
#define HORIZON_ZONE_ZC_NOTIFY_MOVEENTRY3_HPP
 ...
 *
 */ 
class ZC_NOTIFY_MOVEENTRY3 : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_NOTIFY_MOVEENTRY3(std::shared_ptr<ZoneSocket> sock);
...
#endif /* HORIZON_ZONE_ZC_NOTIFY_MOVEENTRY3_HPP */

...
if packet_version >= 20180207 then
	local pid = 0x0af7
...
function ZC_ACK_REQNAME_BYGID.new(o)
	o = o or ZC_ACK_REQNAME_BYGID
	setmetatable(o, self)
	self.__index = self
	return o
end

function ZC_ACK_REQNAME_BYGID.serialize()

end

return ZC_ACK_REQNAME_BYGID

...
#ifndef HORIZON_CHAR_CH_NOT_AVAILABLE_SECOND_PASSWD_HPP
#define HORIZON_CHAR_CH_NOT_AVAILABLE_SECOND_PASSWD_HPP
...
#endif /* HORIZON_CHAR_CH_NOT_AVAILABLE_SECOND_PASSWD_HPP */

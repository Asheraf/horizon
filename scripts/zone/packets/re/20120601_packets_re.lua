...
d:add(0x07e4, 10, require('CZ_ITEMLISTWIN_RES'))
...
d:add(0x0811, 12, require('CZ_REQ_OPEN_BUYING_STORE'))
...
d:add(0x0438, 19, require('CZ_USE_SKILL2'))
d:add(0x0366, 2, require('CZ_USE_SKILL_TOGROUND2'))
d:add(0x0985, -1, require('ZC_SKILL_POSTDELAY_LIST2'))

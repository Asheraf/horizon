...
#ifndef HORIZON_ZONE_ZC_NOTIFY_ACTENTRY_HPP
#define HORIZON_ZONE_ZC_NOTIFY_ACTENTRY_HPP
 ...
 *
 */ 
class ZC_NOTIFY_ACTENTRY : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_NOTIFY_ACTENTRY(std::shared_ptr<ZoneSocket> sock);
	~ZC_NOTIFY_ACTENTRY();
...
#endif /* HORIZON_ZONE_ZC_NOTIFY_ACTENTRY_HPP */

...
function ZC_STATUS_CHANGE_ACK.new(o)
	o = o or ZC_STATUS_CHANGE_ACK
	setmetatable(o, self)
	self.__index = self
	return o
end

function ZC_STATUS_CHANGE_ACK.serialize()

end

return ZC_STATUS_CHANGE_ACK

...
#ifndef HORIZON_ZONE_ZC_STORE_NORMAL_ITEMLIST_HPP
#define HORIZON_ZONE_ZC_STORE_NORMAL_ITEMLIST_HPP
 ...
 *
 */ 
class ZC_STORE_NORMAL_ITEMLIST : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_STORE_NORMAL_ITEMLIST(std::shared_ptr<ZoneSocket> sock);
...
#endif /* HORIZON_ZONE_ZC_STORE_NORMAL_ITEMLIST_HPP */

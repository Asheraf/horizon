...
#ifndef HORIZON_ZONE_RE_20170104_PACKETS_HPP
#define HORIZON_ZONE_RE_20170104_PACKETS_HPP
...
enum packets
{
	CZ_ACK_STORE_PASSWORD = 0x087f,
	CZ_ADD_FRIENDS = 0x085a,
	CZ_CHANGE_DIRECTION = 0x0896,
	CZ_COMMAND_MER = 0x091b,
	CZ_ENTER = 0x0438,
...
#endif /* HORIZON_ZONE_RE_20170104_PACKETS_HPP */

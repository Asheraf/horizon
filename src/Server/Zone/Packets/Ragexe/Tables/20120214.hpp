...
#ifndef HORIZON_ZONE_SHUFFLE_PACKET_LENGTH_TABLE_20120214
#define HORIZON_ZONE_SHUFFLE_PACKET_LENGTH_TABLE_20120214
...
#define ADD_PKT(i, j, k) _packet_length_table.insert(i, std::make_pair<uint16_t, NetworkPacket>(j, k))
		...
		ADD_PKT(0x096e, 10, CZ_REQ_MERGE_ITEM(sock));
		...
		ADD_PKT(0x096f, 3, ZC_ACK_MERGE_ITEM(sock));
		ADD_PKT(0x096d, 2, ZC_MERGE_ITEM_OPEN(sock));
...
#endif /* HORIZON_ZONE_SHUFFLE_PACKET_LENGTH_TABLE_20120214 */

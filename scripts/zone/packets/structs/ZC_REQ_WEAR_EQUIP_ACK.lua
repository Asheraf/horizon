...
if packet_version >= 20101123 then
	local pid = 0x00aa
elseif packet_version >= 20100629 then
	local pid = 0x00aa
...
function ZC_REQ_WEAR_EQUIP_ACK.new(o)
	o = o or ZC_REQ_WEAR_EQUIP_ACK
	setmetatable(o, self)
	self.__index = self
	return o
end

function ZC_REQ_WEAR_EQUIP_ACK.serialize()

end

return ZC_REQ_WEAR_EQUIP_ACK

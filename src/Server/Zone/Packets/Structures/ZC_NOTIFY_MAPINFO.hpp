...
#ifndef HORIZON_ZONE_ZC_NOTIFY_MAPINFO_HPP
#define HORIZON_ZONE_ZC_NOTIFY_MAPINFO_HPP
 ...
 *
 */ 
class ZC_NOTIFY_MAPINFO : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_NOTIFY_MAPINFO(std::shared_ptr<ZoneSocket> sock);
	~ZC_NOTIFY_MAPINFO();
...
#endif /* HORIZON_ZONE_ZC_NOTIFY_MAPINFO_HPP */

...
#ifndef HORIZON_ZONE_CZ_ITEM_THROW2_HPP
#define HORIZON_ZONE_CZ_ITEM_THROW2_HPP
...
/**
 * @brief Main object for the aegis packet: CZ_ITEM_THROW2
 * Size : -1 @ 20080701
 *
 */ 
class CZ_ITEM_THROW2 : public Base::NetworkPacket<ZoneSocket>
{
public:
	CZ_ITEM_THROW2(std::shared_ptr<ZoneSocket> sock);
	~CZ_ITEM_THROW2();
...
#endif /* HORIZON_ZONE_CZ_ITEM_THROW2_HPP */

...
#ifndef HORIZON_ZONE_CZ_REQMAKINGITEM_HPP
#define HORIZON_ZONE_CZ_REQMAKINGITEM_HPP
...
/**
 * @brief Main object for the aegis packet: CZ_REQMAKINGITEM
 * Size : 10 @ 0
 *
 */ 
class CZ_REQMAKINGITEM : public Base::NetworkPacket<ZoneSocket>
{
public:
	CZ_REQMAKINGITEM(std::shared_ptr<ZoneSocket> sock);
	~CZ_REQMAKINGITEM();
...
#endif /* HORIZON_ZONE_CZ_REQMAKINGITEM_HPP */

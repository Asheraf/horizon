...
#ifndef HORIZON_ZONE_ZC_ACK_ADDITEM_TO_CART_HPP
#define HORIZON_ZONE_ZC_ACK_ADDITEM_TO_CART_HPP
 ...
 *
 */ 
class ZC_ACK_ADDITEM_TO_CART : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_ACK_ADDITEM_TO_CART(std::shared_ptr<ZoneSocket> sock);
...
#endif /* HORIZON_ZONE_ZC_ACK_ADDITEM_TO_CART_HPP */

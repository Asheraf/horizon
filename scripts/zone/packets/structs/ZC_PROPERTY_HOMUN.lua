...
elseif packet_version >= 20080102 then
	local pid = 0x022e
elseif packet_version >= 20050624 then
	local pid = 0x022e
elseif packet_version >= 20050622 then
	local pid = 0x022e
elseif packet_version >= 20050530 then
	local pid = 0x022e
elseif packet_version >= 20050523 then
	local pid = 0x022e
elseif packet_version >= 0 then
	local pid = 0x022e
end

local ZC_PROPERTY_HOMUN = {
	_id = pid,
	_length = 0,
	_buffer = nil
}
...
function ZC_PROPERTY_HOMUN.new(o)
	o = o or ZC_PROPERTY_HOMUN
	setmetatable(o, self)
	self.__index = self
	return o
end

function ZC_PROPERTY_HOMUN.serialize()

end

return ZC_PROPERTY_HOMUN

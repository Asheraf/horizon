...
#ifndef HORIZON_ZONE_ZC_TAEKWON_POINT_HPP
#define HORIZON_ZONE_ZC_TAEKWON_POINT_HPP
 ...
 *
 */ 
class ZC_TAEKWON_POINT : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_TAEKWON_POINT(std::shared_ptr<ZoneSocket> sock);
	~ZC_TAEKWON_POINT();
...
#endif /* HORIZON_ZONE_ZC_TAEKWON_POINT_HPP */

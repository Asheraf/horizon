...
local ZC_DELETE_ITEM_FROM_CART = {
	_id = pid,
	_length = 0,
	_buffer = nil
}
...
function ZC_DELETE_ITEM_FROM_CART.new(o)
	o = o or ZC_DELETE_ITEM_FROM_CART
	setmetatable(o, self)
	self.__index = self
	return o
end

function ZC_DELETE_ITEM_FROM_CART.serialize()

end

return ZC_DELETE_ITEM_FROM_CART

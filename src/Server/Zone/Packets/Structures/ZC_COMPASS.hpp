...
#ifndef HORIZON_ZONE_ZC_COMPASS_HPP
#define HORIZON_ZONE_ZC_COMPASS_HPP
 ...
 *
 */ 
class ZC_COMPASS : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_COMPASS(std::shared_ptr<ZoneSocket> sock);
	~ZC_COMPASS();
...
#endif /* HORIZON_ZONE_ZC_COMPASS_HPP */

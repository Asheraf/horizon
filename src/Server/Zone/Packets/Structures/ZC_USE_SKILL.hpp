...
#ifndef HORIZON_ZONE_ZC_USE_SKILL_HPP
#define HORIZON_ZONE_ZC_USE_SKILL_HPP
 ...
 *
 */ 
class ZC_USE_SKILL : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_USE_SKILL(std::shared_ptr<ZoneSocket> sock);
	~ZC_USE_SKILL();
...
#endif /* HORIZON_ZONE_ZC_USE_SKILL_HPP */

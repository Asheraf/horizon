...
#ifndef HORIZON_ZONE_ZC_SKILL_ENTRY2_HPP
#define HORIZON_ZONE_ZC_SKILL_ENTRY2_HPP
 ...
 *
 */ 
class ZC_SKILL_ENTRY2 : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_SKILL_ENTRY2(std::shared_ptr<ZoneSocket> sock);
	~ZC_SKILL_ENTRY2();
...
#endif /* HORIZON_ZONE_ZC_SKILL_ENTRY2_HPP */

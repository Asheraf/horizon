...
if packet_version >= 20090318 then
	local pid = 0x0295
...
function ZC_EQUIPMENT_ITEMLIST2.new(o)
	o = o or ZC_EQUIPMENT_ITEMLIST2
	setmetatable(o, self)
	self.__index = self
	return o
end

function ZC_EQUIPMENT_ITEMLIST2.serialize()

end

return ZC_EQUIPMENT_ITEMLIST2

...
function ZC_NOTIFY_PLAYERCHAT.new(o)
	o = o or ZC_NOTIFY_PLAYERCHAT
	setmetatable(o, self)
	self.__index = self
	return o
end

function ZC_NOTIFY_PLAYERCHAT.serialize()

end

return ZC_NOTIFY_PLAYERCHAT

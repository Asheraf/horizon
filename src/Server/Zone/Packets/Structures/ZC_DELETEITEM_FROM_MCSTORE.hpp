...
#ifndef HORIZON_ZONE_ZC_DELETEITEM_FROM_MCSTORE_HPP
#define HORIZON_ZONE_ZC_DELETEITEM_FROM_MCSTORE_HPP
 ...
 *
 */ 
class ZC_DELETEITEM_FROM_MCSTORE : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_DELETEITEM_FROM_MCSTORE(std::shared_ptr<ZoneSocket> sock);
...
#endif /* HORIZON_ZONE_ZC_DELETEITEM_FROM_MCSTORE_HPP */

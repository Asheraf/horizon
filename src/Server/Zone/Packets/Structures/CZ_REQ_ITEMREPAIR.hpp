...
#ifndef HORIZON_ZONE_CZ_REQ_ITEMREPAIR_HPP
#define HORIZON_ZONE_CZ_REQ_ITEMREPAIR_HPP
...
enum {
	...
	ID_CZ_REQ_ITEMREPAIR = 0x01fd
#elif PACKET_VERSION >= 20070528
	ID_CZ_REQ_ITEMREPAIR = 0x01fd
#elif PACKET_VERSION >= 20070507
	ID_CZ_REQ_ITEMREPAIR = 0x01fd
...
/**
 * @brief Main object for the aegis packet: CZ_REQ_ITEMREPAIR
 * Size : 4 @ 0
 *
 */ 
class CZ_REQ_ITEMREPAIR : public Base::NetworkPacket<ZoneSocket>
{
public:
	CZ_REQ_ITEMREPAIR(std::shared_ptr<ZoneSocket> sock);
	~CZ_REQ_ITEMREPAIR();
...
#endif /* HORIZON_ZONE_CZ_REQ_ITEMREPAIR_HPP */

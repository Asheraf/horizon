...
function ZC_ACK_ITEM_FROM_RODEX.new(o)
	o = o or ZC_ACK_ITEM_FROM_RODEX
	setmetatable(o, self)
	self.__index = self
	return o
end

function ZC_ACK_ITEM_FROM_RODEX.serialize()

end

return ZC_ACK_ITEM_FROM_RODEX

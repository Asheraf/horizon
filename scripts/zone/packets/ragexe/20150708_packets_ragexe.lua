...
d:add(0x0872, 6, require('CZ_ITEM_PICKUP'))
d:add(0x095b, 6, require('CZ_ITEM_THROW'))
d:add(0x0962, 8, require('CZ_JOIN_BATTLE_FIELD'))
d:add(0x085e, 8, require('CZ_MOVE_ITEM_FROM_BODY_TO_STORE'))
d:add(0x092a, 8, require('CZ_MOVE_ITEM_FROM_STORE_TO_BODY'))
d:add(0x091f, 18, require('CZ_PARTY_BOOKING_REQ_REGISTER'))
d:add(0x0366, 26, require('CZ_PARTY_JOIN_REQ'))
d:add(0x096a, 6, require('CZ_REQNAME'))
d:add(0x022d, 6, require('CZ_REQNAME_BYGID'))

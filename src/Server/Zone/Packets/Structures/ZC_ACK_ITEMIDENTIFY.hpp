...
#ifndef HORIZON_ZONE_ZC_ACK_ITEMIDENTIFY_HPP
#define HORIZON_ZONE_ZC_ACK_ITEMIDENTIFY_HPP
 ...
 *
 */ 
class ZC_ACK_ITEMIDENTIFY : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_ACK_ITEMIDENTIFY(std::shared_ptr<ZoneSocket> sock);
	~ZC_ACK_ITEMIDENTIFY();
...
#endif /* HORIZON_ZONE_ZC_ACK_ITEMIDENTIFY_HPP */

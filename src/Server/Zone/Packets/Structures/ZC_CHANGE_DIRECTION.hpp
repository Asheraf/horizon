...
#ifndef HORIZON_ZONE_ZC_CHANGE_DIRECTION_HPP
#define HORIZON_ZONE_ZC_CHANGE_DIRECTION_HPP
 ...
 *
 */ 
class ZC_CHANGE_DIRECTION : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_CHANGE_DIRECTION(std::shared_ptr<ZoneSocket> sock);
	~ZC_CHANGE_DIRECTION();
...
#endif /* HORIZON_ZONE_ZC_CHANGE_DIRECTION_HPP */

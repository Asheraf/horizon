...
#ifndef HORIZON_ZONE_CZ_REQUEST_ACTNPC_HPP
#define HORIZON_ZONE_CZ_REQUEST_ACTNPC_HPP
 ...
 *
 */ 
class CZ_REQUEST_ACTNPC : public Base::NetworkPacket<ZoneSocket>
{
public:
	CZ_REQUEST_ACTNPC(std::shared_ptr<ZoneSocket> sock);
	~CZ_REQUEST_ACTNPC();
...
#endif /* HORIZON_ZONE_CZ_REQUEST_ACTNPC_HPP */

...
function ZC_RESULT_MAKE_GUILD.new(o)
	o = o or ZC_RESULT_MAKE_GUILD
	setmetatable(o, self)
	self.__index = self
	return o
end

function ZC_RESULT_MAKE_GUILD.serialize()

end

return ZC_RESULT_MAKE_GUILD

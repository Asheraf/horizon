...
#ifndef HORIZON_ZONE_ZC_NOTIFY_MOVEENTRY4_HPP
#define HORIZON_ZONE_ZC_NOTIFY_MOVEENTRY4_HPP
 ...
 *
 */ 
class ZC_NOTIFY_MOVEENTRY4 : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_NOTIFY_MOVEENTRY4(std::shared_ptr<ZoneSocket> sock);
...
#endif /* HORIZON_ZONE_ZC_NOTIFY_MOVEENTRY4_HPP */

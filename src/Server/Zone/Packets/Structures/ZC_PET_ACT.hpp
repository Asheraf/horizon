...
#ifndef HORIZON_ZONE_ZC_PET_ACT_HPP
#define HORIZON_ZONE_ZC_PET_ACT_HPP
 ...
 *
 */ 
class ZC_PET_ACT : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_PET_ACT(std::shared_ptr<ZoneSocket> sock);
	~ZC_PET_ACT();
...
#endif /* HORIZON_ZONE_ZC_PET_ACT_HPP */

...
#ifndef HORIZON_ZONE_ZC_NOTIFY_POSITION_TO_GUILDM_HPP
#define HORIZON_ZONE_ZC_NOTIFY_POSITION_TO_GUILDM_HPP
 ...
 *
 */ 
class ZC_NOTIFY_POSITION_TO_GUILDM : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_NOTIFY_POSITION_TO_GUILDM(std::shared_ptr<ZoneSocket> sock);
...
#endif /* HORIZON_ZONE_ZC_NOTIFY_POSITION_TO_GUILDM_HPP */

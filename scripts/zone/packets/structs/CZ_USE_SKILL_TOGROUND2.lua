...
function CZ_USE_SKILL_TOGROUND2.new(o)
	o = o or CZ_USE_SKILL_TOGROUND2
	setmetatable(o, self)
	self.__index = self
	return o
end

function CZ_USE_SKILL_TOGROUND2.deserialize(buf)

end

return CZ_USE_SKILL_TOGROUND2

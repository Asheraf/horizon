...
d:add(0x085d, 5, require('CZ_CHANGE_DIRECTION'))
d:add(0x08a8, 5, require('CZ_COMMAND_MER'))
d:add(0x0961, 19, require('CZ_ENTER'))
d:add(0x095b, 4, require('CZ_GANGSI_RANK'))
d:add(0x0365, -1, require('CZ_ITEMLISTWIN_RES'))
d:add(0x0361, 6, require('CZ_ITEM_PICKUP'))
...
d:add(0x0889, 8, require('CZ_MOVE_ITEM_FROM_STORE_TO_BODY'))
d:add(0x0366, 18, require('CZ_PARTY_BOOKING_REQ_REGISTER'))
d:add(0x0885, 26, require('CZ_PARTY_JOIN_REQ'))
...
d:add(0x0802, 90, require('CZ_USE_SKILL_TOGROUND_WITHTALKBOX'))

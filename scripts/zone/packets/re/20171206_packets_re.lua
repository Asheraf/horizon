...
d:add(0x089d, 36, require('CZ_ACK_STORE_PASSWORD'))
...
d:add(0x086a, 4, require('CZ_GANGSI_RANK'))
d:add(0x0958, -1, require('CZ_ITEMLISTWIN_RES'))
d:add(0x0961, 6, require('CZ_ITEM_PICKUP'))
d:add(0x0867, 6, require('CZ_ITEM_THROW'))
d:add(0x092e, 8, require('CZ_JOIN_BATTLE_FIELD'))
d:add(0x0923, 8, require('CZ_MOVE_ITEM_FROM_BODY_TO_STORE'))
d:add(0x08a4, 8, require('CZ_MOVE_ITEM_FROM_STORE_TO_BODY'))
d:add(0x086e, 18, require('CZ_PARTY_BOOKING_REQ_REGISTER'))
d:add(0x08a2, 26, require('CZ_PARTY_JOIN_REQ'))

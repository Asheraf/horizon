...
#ifndef HORIZON_ZONE_ZC_NOTIFY_CHAT_HPP
#define HORIZON_ZONE_ZC_NOTIFY_CHAT_HPP
 ...
 *
 */ 
class ZC_NOTIFY_CHAT : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_NOTIFY_CHAT(std::shared_ptr<ZoneSocket> sock);
	~ZC_NOTIFY_CHAT();
...
#endif /* HORIZON_ZONE_ZC_NOTIFY_CHAT_HPP */

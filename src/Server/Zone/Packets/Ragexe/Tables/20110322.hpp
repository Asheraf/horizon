...
#ifndef HORIZON_ZONE_SHUFFLE_PACKET_LENGTH_TABLE_20110322
#define HORIZON_ZONE_SHUFFLE_PACKET_LENGTH_TABLE_20110322
...
#define ADD_PKT(i, j, k) _packet_length_table.insert(i, std::make_pair<uint16_t, NetworkPacket>(j, k))
		...
		ADD_PKT(0x0817, 36, CZ_REQ_CLICK_TO_BUYING_STORE(sock));
		ADD_PKT(0x0815, 2, CZ_REQ_CLOSE_BUYING_STORE(sock));
		ADD_PKT(0x0811, 2, CZ_REQ_OPEN_BUYING_STORE(sock));
		ADD_PKT(0x0819, 90, CZ_REQ_TRADE_BUYING_STORE(sock));
...
#endif /* HORIZON_ZONE_SHUFFLE_PACKET_LENGTH_TABLE_20110322 */
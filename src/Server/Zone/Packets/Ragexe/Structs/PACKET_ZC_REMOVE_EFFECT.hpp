...
#ifndef HORIZON_ZONE_RAGEXE_PACKET_ZC_REMOVE_EFFECT_HPP
#define HORIZON_ZONE_RAGEXE_PACKET_ZC_REMOVE_EFFECT_HPP
...
#endif /* HORIZON_ZONE_RAGEXE_PACKET_ZC_REMOVE_EFFECT_HPP */

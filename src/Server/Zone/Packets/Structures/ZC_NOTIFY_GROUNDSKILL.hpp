...
#ifndef HORIZON_ZONE_ZC_NOTIFY_GROUNDSKILL_HPP
#define HORIZON_ZONE_ZC_NOTIFY_GROUNDSKILL_HPP
 ...
 *
 */ 
class ZC_NOTIFY_GROUNDSKILL : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_NOTIFY_GROUNDSKILL(std::shared_ptr<ZoneSocket> sock);
...
#endif /* HORIZON_ZONE_ZC_NOTIFY_GROUNDSKILL_HPP */

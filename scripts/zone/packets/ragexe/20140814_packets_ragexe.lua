...
d:add(0x0819, -1, require('CZ_ITEMLISTWIN_RES'))
d:add(0x08a3, 6, require('CZ_ITEM_PICKUP'))
d:add(0x0899, 6, require('CZ_ITEM_THROW'))
d:add(0x08a7, 8, require('CZ_JOIN_BATTLE_FIELD'))
...
d:add(0x087c, 26, require('CZ_PARTY_JOIN_REQ'))
...
d:add(0x07e4, -1, require('CZ_SEARCH_STORE_INFO'))

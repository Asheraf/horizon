...
#ifndef HORIZON_ZONE_ZC_FRIENDS_LIST_HPP
#define HORIZON_ZONE_ZC_FRIENDS_LIST_HPP
 ...
 *
 */ 
class ZC_FRIENDS_LIST : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_FRIENDS_LIST(std::shared_ptr<ZoneSocket> sock);
	~ZC_FRIENDS_LIST();
...
#endif /* HORIZON_ZONE_ZC_FRIENDS_LIST_HPP */

...
#ifndef HORIZON_ZONE_ZC_NOTIFY_STOREITEM_COUNTINFO_HPP
#define HORIZON_ZONE_ZC_NOTIFY_STOREITEM_COUNTINFO_HPP
 ...
 *
 */ 
class ZC_NOTIFY_STOREITEM_COUNTINFO : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_NOTIFY_STOREITEM_COUNTINFO(std::shared_ptr<ZoneSocket> sock);
...
#endif /* HORIZON_ZONE_ZC_NOTIFY_STOREITEM_COUNTINFO_HPP */

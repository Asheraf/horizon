...
local ZC_ACK_DISORGANIZE_GUILD_RESULT = {
	_id = pid,
	_length = 0,
	_buffer = nil
}
...
function ZC_ACK_DISORGANIZE_GUILD_RESULT.new(o)
	o = o or ZC_ACK_DISORGANIZE_GUILD_RESULT
	setmetatable(o, self)
	self.__index = self
	return o
end

function ZC_ACK_DISORGANIZE_GUILD_RESULT.serialize()

end

return ZC_ACK_DISORGANIZE_GUILD_RESULT

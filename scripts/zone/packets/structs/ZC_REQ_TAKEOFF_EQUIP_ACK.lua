...
local ZC_REQ_TAKEOFF_EQUIP_ACK = {
	_id = pid,
	_length = 0,
	_buffer = nil
}
...
function ZC_REQ_TAKEOFF_EQUIP_ACK.new(o)
	o = o or ZC_REQ_TAKEOFF_EQUIP_ACK
	setmetatable(o, self)
	self.__index = self
	return o
end

function ZC_REQ_TAKEOFF_EQUIP_ACK.serialize()

end

return ZC_REQ_TAKEOFF_EQUIP_ACK

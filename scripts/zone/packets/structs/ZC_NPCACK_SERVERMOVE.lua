...
function ZC_NPCACK_SERVERMOVE.new(o)
	o = o or ZC_NPCACK_SERVERMOVE
	setmetatable(o, self)
	self.__index = self
	return o
end

function ZC_NPCACK_SERVERMOVE.serialize()

end

return ZC_NPCACK_SERVERMOVE

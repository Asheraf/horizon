...
d:add(0x0943, 36, require('CZ_ACK_STORE_PASSWORD'))
d:add(0x085f, 26, require('CZ_ADD_FRIENDS'))
d:add(0x08a3, 5, require('CZ_CHANGE_DIRECTION'))
...
d:add(0x0866, 6, require('CZ_ITEM_THROW'))

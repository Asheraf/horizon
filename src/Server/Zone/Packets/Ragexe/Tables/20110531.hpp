...
#ifndef HORIZON_ZONE_SHUFFLE_PACKET_LENGTH_TABLE_20110531
#define HORIZON_ZONE_SHUFFLE_PACKET_LENGTH_TABLE_20110531
...
#define ADD_PKT(i, j, k) _packet_length_table.insert(i, std::make_pair<uint16_t, NetworkPacket>(j, k))
		...
		ADD_PKT(0x0361, 7, CZ_CHANGE_DIRECTION2(sock));
		...
		ADD_PKT(0x07ec, 4, CZ_JOIN_BATTLE_FIELD(sock));
...
#endif /* HORIZON_ZONE_SHUFFLE_PACKET_LENGTH_TABLE_20110531 */
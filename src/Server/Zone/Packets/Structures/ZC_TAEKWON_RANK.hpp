...
#ifndef HORIZON_ZONE_ZC_TAEKWON_RANK_HPP
#define HORIZON_ZONE_ZC_TAEKWON_RANK_HPP
 ...
 *
 */ 
class ZC_TAEKWON_RANK : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_TAEKWON_RANK(std::shared_ptr<ZoneSocket> sock);
	~ZC_TAEKWON_RANK();
...
#endif /* HORIZON_ZONE_ZC_TAEKWON_RANK_HPP */

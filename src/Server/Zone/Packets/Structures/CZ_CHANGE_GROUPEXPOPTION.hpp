...
#ifndef HORIZON_ZONE_CZ_CHANGE_GROUPEXPOPTION_HPP
#define HORIZON_ZONE_CZ_CHANGE_GROUPEXPOPTION_HPP
...
enum {
	...
	ID_CZ_CHANGE_GROUPEXPOPTION = 0x0102
...
/**
 * @brief Main object for the aegis packet: CZ_CHANGE_GROUPEXPOPTION
 * Size : 6 @ 0
 *
 */ 
class CZ_CHANGE_GROUPEXPOPTION : public Base::NetworkPacket<ZoneSocket>
{
public:
	CZ_CHANGE_GROUPEXPOPTION(std::shared_ptr<ZoneSocket> sock);
...
#endif /* HORIZON_ZONE_CZ_CHANGE_GROUPEXPOPTION_HPP */

...
function CZ_EXEC_EXCHANGE_ITEM.new(o)
	o = o or CZ_EXEC_EXCHANGE_ITEM
	setmetatable(o, self)
	self.__index = self
	return o
end

function CZ_EXEC_EXCHANGE_ITEM.deserialize(buf)

end

return CZ_EXEC_EXCHANGE_ITEM

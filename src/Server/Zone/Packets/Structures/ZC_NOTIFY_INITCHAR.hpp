...
#ifndef HORIZON_ZONE_ZC_NOTIFY_INITCHAR_HPP
#define HORIZON_ZONE_ZC_NOTIFY_INITCHAR_HPP
 ...
 *
 */ 
class ZC_NOTIFY_INITCHAR : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_NOTIFY_INITCHAR(std::shared_ptr<ZoneSocket> sock);
	~ZC_NOTIFY_INITCHAR();
...
#endif /* HORIZON_ZONE_ZC_NOTIFY_INITCHAR_HPP */

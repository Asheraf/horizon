...
#ifndef HORIZON_ZONE_ZC_USE_ITEM_ACK2_HPP
#define HORIZON_ZONE_ZC_USE_ITEM_ACK2_HPP
 ...
 *
 */ 
class ZC_USE_ITEM_ACK2 : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_USE_ITEM_ACK2(std::shared_ptr<ZoneSocket> sock);
	~ZC_USE_ITEM_ACK2();
...
#endif /* HORIZON_ZONE_ZC_USE_ITEM_ACK2_HPP */

...
local CZ_REQ_GUILD_MENUINTERFACE = {
	_id = pid,
	_length = 0,
	_buffer = nil
}
...
function CZ_REQ_GUILD_MENUINTERFACE.new(o)
	o = o or CZ_REQ_GUILD_MENUINTERFACE
	setmetatable(o, self)
	self.__index = self
	return o
end

function CZ_REQ_GUILD_MENUINTERFACE.serialize()

end

return CZ_REQ_GUILD_MENUINTERFACE

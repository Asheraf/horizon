...
#ifndef HORIZON_ZONE_ZC_ENTER_ROOM_HPP
#define HORIZON_ZONE_ZC_ENTER_ROOM_HPP
 ...
 *
 */ 
class ZC_ENTER_ROOM : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_ENTER_ROOM(std::shared_ptr<ZoneSocket> sock);
	~ZC_ENTER_ROOM();
...
#endif /* HORIZON_ZONE_ZC_ENTER_ROOM_HPP */

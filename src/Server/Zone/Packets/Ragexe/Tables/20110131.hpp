...
#ifndef HORIZON_ZONE_SHUFFLE_PACKET_LENGTH_TABLE_20110131
#define HORIZON_ZONE_SHUFFLE_PACKET_LENGTH_TABLE_20110131
...
#define ADD_PKT(i, j, k) _packet_length_table.insert(i, std::make_pair<uint16_t, NetworkPacket>(j, k))
		...
		ADD_PKT(0x0363, 10, CZ_ITEM_THROW2(sock));
		ADD_PKT(0x07ec, 2, CZ_JOIN_BATTLE_FIELD(sock));
		ADD_PKT(0x0364, 90, CZ_MOVE_ITEM_FROM_BODY_TO_STORE2(sock));
		ADD_PKT(0x0802, 2, CZ_PARTY_BOOKING_REQ_REGISTER(sock));
		ADD_PKT(0x0368, 26, CZ_REQNAME2(sock));
		ADD_PKT(0x0369, 2, CZ_REQNAME_BYGID2(sock));
		ADD_PKT(0x0437, 19, CZ_REQUEST_ACT2(sock));
		...
		ADD_PKT(0x0838, 4, CZ_SEARCH_STORE_INFO_NEXT_PAGE(sock));
...
#endif /* HORIZON_ZONE_SHUFFLE_PACKET_LENGTH_TABLE_20110131 */
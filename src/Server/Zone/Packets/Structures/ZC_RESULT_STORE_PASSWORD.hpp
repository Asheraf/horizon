...
#ifndef HORIZON_ZONE_ZC_RESULT_STORE_PASSWORD_HPP
#define HORIZON_ZONE_ZC_RESULT_STORE_PASSWORD_HPP
 ...
 *
 */ 
class ZC_RESULT_STORE_PASSWORD : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_RESULT_STORE_PASSWORD(std::shared_ptr<ZoneSocket> sock);
...
#endif /* HORIZON_ZONE_ZC_RESULT_STORE_PASSWORD_HPP */

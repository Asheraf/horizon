...
#ifndef HORIZON_ZONE_ZC_ROLE_CHANGE_HPP
#define HORIZON_ZONE_ZC_ROLE_CHANGE_HPP
 ...
 *
 */ 
class ZC_ROLE_CHANGE : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_ROLE_CHANGE(std::shared_ptr<ZoneSocket> sock);
	~ZC_ROLE_CHANGE();
...
#endif /* HORIZON_ZONE_ZC_ROLE_CHANGE_HPP */

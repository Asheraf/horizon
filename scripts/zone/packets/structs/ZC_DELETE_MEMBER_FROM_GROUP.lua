...
local ZC_DELETE_MEMBER_FROM_GROUP = {
	_id = pid,
	_length = 0,
	_buffer = nil
}
...
function ZC_DELETE_MEMBER_FROM_GROUP.new(o)
	o = o or ZC_DELETE_MEMBER_FROM_GROUP
	setmetatable(o, self)
	self.__index = self
	return o
end

function ZC_DELETE_MEMBER_FROM_GROUP.serialize()

end

return ZC_DELETE_MEMBER_FROM_GROUP

...
#ifndef HORIZON_ZONE_ZC_IRMAIL_NOTIFY_HPP
#define HORIZON_ZONE_ZC_IRMAIL_NOTIFY_HPP
 ...
 *
 */ 
class ZC_IRMAIL_NOTIFY : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_IRMAIL_NOTIFY(std::shared_ptr<ZoneSocket> sock);
	~ZC_IRMAIL_NOTIFY();
...
#endif /* HORIZON_ZONE_ZC_IRMAIL_NOTIFY_HPP */

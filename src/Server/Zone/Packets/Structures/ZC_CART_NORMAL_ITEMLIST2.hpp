...
#ifndef HORIZON_ZONE_ZC_CART_NORMAL_ITEMLIST2_HPP
#define HORIZON_ZONE_ZC_CART_NORMAL_ITEMLIST2_HPP
 ...
 *
 */ 
class ZC_CART_NORMAL_ITEMLIST2 : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_CART_NORMAL_ITEMLIST2(std::shared_ptr<ZoneSocket> sock);
...
#endif /* HORIZON_ZONE_ZC_CART_NORMAL_ITEMLIST2_HPP */

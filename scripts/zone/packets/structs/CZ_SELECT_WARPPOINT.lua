...
function CZ_SELECT_WARPPOINT.new(o)
	o = o or CZ_SELECT_WARPPOINT
	setmetatable(o, self)
	self.__index = self
	return o
end

function CZ_SELECT_WARPPOINT.deserialize(buf)

end

return CZ_SELECT_WARPPOINT

...
local CZ_PARTY_RECRUIT_ACK_RECALL = {
	_id = pid,
	_length = 0,
	_buffer = nil
}
...
function CZ_PARTY_RECRUIT_ACK_RECALL.new(o)
	o = o or CZ_PARTY_RECRUIT_ACK_RECALL
	setmetatable(o, self)
	self.__index = self
	return o
end

function CZ_PARTY_RECRUIT_ACK_RECALL.serialize()

end

return CZ_PARTY_RECRUIT_ACK_RECALL

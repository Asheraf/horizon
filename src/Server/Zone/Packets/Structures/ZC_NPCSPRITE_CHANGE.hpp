...
#ifndef HORIZON_ZONE_ZC_NPCSPRITE_CHANGE_HPP
#define HORIZON_ZONE_ZC_NPCSPRITE_CHANGE_HPP
 ...
 *
 */ 
class ZC_NPCSPRITE_CHANGE : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_NPCSPRITE_CHANGE(std::shared_ptr<ZoneSocket> sock);
	~ZC_NPCSPRITE_CHANGE();
...
#endif /* HORIZON_ZONE_ZC_NPCSPRITE_CHANGE_HPP */

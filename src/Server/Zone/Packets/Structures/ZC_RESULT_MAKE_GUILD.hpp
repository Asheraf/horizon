...
#ifndef HORIZON_ZONE_ZC_RESULT_MAKE_GUILD_HPP
#define HORIZON_ZONE_ZC_RESULT_MAKE_GUILD_HPP
 ...
 *
 */ 
class ZC_RESULT_MAKE_GUILD : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_RESULT_MAKE_GUILD(std::shared_ptr<ZoneSocket> sock);
...
#endif /* HORIZON_ZONE_ZC_RESULT_MAKE_GUILD_HPP */

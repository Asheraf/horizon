...
function CZ_SETTING_WHISPER_PC.new(o)
	o = o or CZ_SETTING_WHISPER_PC
	setmetatable(o, self)
	self.__index = self
	return o
end

function CZ_SETTING_WHISPER_PC.deserialize(buf)

end

return CZ_SETTING_WHISPER_PC

...
#ifndef HORIZON_ZONE_RAGEXE_PACKET_ZC_ITEM_PICKUP_ACK_V7_HPP
#define HORIZON_ZONE_RAGEXE_PACKET_ZC_ITEM_PICKUP_ACK_V7_HPP
...
struct PACKET_ZC_ITEM_PICKUP_ACK_V7 : public PACKET_ZC_ITEM_PICKUP_ACK_V6
{
	...
	virtual PacketBuffer serialize(item_entry_data const &data, uint16_t amount, item_inventory_addition_notif_type result) override
	{
		...
		buf << (uint8_t) (data.info.is_favorite ? 1 : 0);
		buf << data.sprite_id;
		return buf;
	}
};
...
#endif /* HORIZON_ZONE_RAGEXE_PACKET_ZC_ITEM_PICKUP_ACK_V7_HPP */

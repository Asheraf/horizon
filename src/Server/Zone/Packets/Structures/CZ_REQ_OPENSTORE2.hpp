...
#ifndef HORIZON_ZONE_CZ_REQ_OPENSTORE2_HPP
#define HORIZON_ZONE_CZ_REQ_OPENSTORE2_HPP
...
/**
 * @brief Main object for the aegis packet: CZ_REQ_OPENSTORE2
 * Size : -1 @ 0
 *
 */ 
class CZ_REQ_OPENSTORE2 : public Base::NetworkPacket<ZoneSocket>
{
public:
	CZ_REQ_OPENSTORE2(std::shared_ptr<ZoneSocket> sock);
	~CZ_REQ_OPENSTORE2();
...
#endif /* HORIZON_ZONE_CZ_REQ_OPENSTORE2_HPP */

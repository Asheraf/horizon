...
local CZ_DISCONNECT_ALL_CHARACTER = {
	_id = pid,
	_length = 0,
	_buffer = nil
}
...
function CZ_DISCONNECT_ALL_CHARACTER.new(o)
	o = o or CZ_DISCONNECT_ALL_CHARACTER
	setmetatable(o, self)
	self.__index = self
	return o
end

function CZ_DISCONNECT_ALL_CHARACTER.serialize()

end

return CZ_DISCONNECT_ALL_CHARACTER

...
d:add(0x095c, 5, require('CZ_CHANGE_DIRECTION'))
d:add(0x094d, 5, require('CZ_COMMAND_MER'))
d:add(0x0895, 19, require('CZ_ENTER'))
d:add(0x0944, 4, require('CZ_GANGSI_RANK'))
d:add(0x0878, -1, require('CZ_ITEMLISTWIN_RES'))
d:add(0x088b, 6, require('CZ_ITEM_PICKUP'))
d:add(0x092d, 6, require('CZ_ITEM_THROW'))
d:add(0x0897, 8, require('CZ_JOIN_BATTLE_FIELD'))
...
d:add(0x08ab, 26, require('CZ_PARTY_JOIN_REQ'))

...
function ZC_MYGUILD_BASIC_INFO.new(o)
	o = o or ZC_MYGUILD_BASIC_INFO
	setmetatable(o, self)
	self.__index = self
	return o
end

function ZC_MYGUILD_BASIC_INFO.serialize()

end

return ZC_MYGUILD_BASIC_INFO

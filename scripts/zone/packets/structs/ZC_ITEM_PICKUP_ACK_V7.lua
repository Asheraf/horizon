...
function ZC_ITEM_PICKUP_ACK_V7.new(o)
	o = o or ZC_ITEM_PICKUP_ACK_V7
	setmetatable(o, self)
	self.__index = self
	return o
end

function ZC_ITEM_PICKUP_ACK_V7.serialize()

end

return ZC_ITEM_PICKUP_ACK_V7

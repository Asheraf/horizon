...
function ZC_NOTIFY_PLAYERMOVE.new(o)
	o = o or ZC_NOTIFY_PLAYERMOVE
	setmetatable(o, self)
	self.__index = self
	return o
end

function ZC_NOTIFY_PLAYERMOVE.serialize()

end

return ZC_NOTIFY_PLAYERMOVE

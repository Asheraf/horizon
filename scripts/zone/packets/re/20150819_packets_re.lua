...
d:add(0x091e, 36, require('CZ_ACK_STORE_PASSWORD'))
d:add(0x0865, 26, require('CZ_ADD_FRIENDS'))
d:add(0x0967, 5, require('CZ_CHANGE_DIRECTION'))
...
d:add(0x0281, 6, require('CZ_ITEM_PICKUP'))
d:add(0x0940, 6, require('CZ_ITEM_THROW'))
d:add(0x0862, 8, require('CZ_JOIN_BATTLE_FIELD'))
d:add(0x0919, 8, require('CZ_MOVE_ITEM_FROM_BODY_TO_STORE'))
d:add(0x085d, 8, require('CZ_MOVE_ITEM_FROM_STORE_TO_BODY'))
d:add(0x0871, 18, require('CZ_PARTY_BOOKING_REQ_REGISTER'))
d:add(0x0961, 26, require('CZ_PARTY_JOIN_REQ'))
...
d:add(0x022d, 10, require('CZ_USE_SKILL'))

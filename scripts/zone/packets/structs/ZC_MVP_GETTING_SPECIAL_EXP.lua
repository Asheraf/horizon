...
local ZC_MVP_GETTING_SPECIAL_EXP = {
	_id = pid,
	_length = 0,
	_buffer = nil
}
...
function ZC_MVP_GETTING_SPECIAL_EXP.new(o)
	o = o or ZC_MVP_GETTING_SPECIAL_EXP
	setmetatable(o, self)
	self.__index = self
	return o
end

function ZC_MVP_GETTING_SPECIAL_EXP.serialize()

end

return ZC_MVP_GETTING_SPECIAL_EXP

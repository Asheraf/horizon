...
d:add(0x0365, 36, require('CZ_MOVE_ITEM_FROM_STORE_TO_BODY2'))
d:add(0x0802, 5, require('CZ_PARTY_BOOKING_REQ_REGISTER'))
...
d:add(0x0817, 8, require('CZ_REQ_CLICK_TO_BUYING_STORE'))
...
d:add(0x083c, 7, require('CZ_SSILIST_ITEM_CLICK'))
...
d:add(0x00aa, 9, require('ZC_REQ_WEAR_EQUIP_ACK'))

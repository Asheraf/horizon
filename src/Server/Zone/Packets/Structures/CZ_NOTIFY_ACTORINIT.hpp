...
#ifndef HORIZON_ZONE_CZ_NOTIFY_ACTORINIT_HPP
#define HORIZON_ZONE_CZ_NOTIFY_ACTORINIT_HPP
...
/**
 * @brief Main object for the aegis packet: CZ_NOTIFY_ACTORINIT
 * Size : 2 @ 0
 *
 */ 
class CZ_NOTIFY_ACTORINIT : public Base::NetworkPacket<ZoneSocket>
{
public:
	CZ_NOTIFY_ACTORINIT(std::shared_ptr<ZoneSocket> sock);
	~CZ_NOTIFY_ACTORINIT();
...
#endif /* HORIZON_ZONE_CZ_NOTIFY_ACTORINIT_HPP */

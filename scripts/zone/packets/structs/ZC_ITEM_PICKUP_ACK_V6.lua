...
function ZC_ITEM_PICKUP_ACK_V6.new(o)
	o = o or ZC_ITEM_PICKUP_ACK_V6
	setmetatable(o, self)
	self.__index = self
	return o
end

function ZC_ITEM_PICKUP_ACK_V6.serialize()

end

return ZC_ITEM_PICKUP_ACK_V6

...
#ifndef HORIZON_ZONE_ZC_ALCHEMIST_POINT_HPP
#define HORIZON_ZONE_ZC_ALCHEMIST_POINT_HPP
 ...
 *
 */ 
class ZC_ALCHEMIST_POINT : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_ALCHEMIST_POINT(std::shared_ptr<ZoneSocket> sock);
	~ZC_ALCHEMIST_POINT();
...
#endif /* HORIZON_ZONE_ZC_ALCHEMIST_POINT_HPP */

...
function ZC_ACK_REQ_DISCONNECT.new(o)
	o = o or ZC_ACK_REQ_DISCONNECT
	setmetatable(o, self)
	self.__index = self
	return o
end

function ZC_ACK_REQ_DISCONNECT.serialize()

end

return ZC_ACK_REQ_DISCONNECT

...
#ifndef HORIZON_ZONE_ZC_PC_PURCHASE_RESULT_HPP
#define HORIZON_ZONE_ZC_PC_PURCHASE_RESULT_HPP
 ...
 *
 */ 
class ZC_PC_PURCHASE_RESULT : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_PC_PURCHASE_RESULT(std::shared_ptr<ZoneSocket> sock);
...
#endif /* HORIZON_ZONE_ZC_PC_PURCHASE_RESULT_HPP */

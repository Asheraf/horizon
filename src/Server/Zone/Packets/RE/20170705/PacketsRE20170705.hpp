...
#ifndef HORIZON_ZONE_RE_20170705_PACKETS_HPP
#define HORIZON_ZONE_RE_20170705_PACKETS_HPP
...
enum packets
{
	...
	CZ_ADD_FRIENDS = 0x0886,
	CZ_CHANGE_DIRECTION = 0x091a,
	CZ_COMMAND_MER = 0x094c,
	CZ_ENTER = 0x089a,
	CZ_GANGSI_RANK = 0x092f,
	CZ_ITEMLISTWIN_RES = 0x0930,
	CZ_ITEM_PICKUP = 0x0932,
	CZ_ITEM_THROW = 0x089d,
	CZ_JOIN_BATTLE_FIELD = 0x088d,
	CZ_MOVE_ITEM_FROM_BODY_TO_STORE = 0x0879,
	CZ_MOVE_ITEM_FROM_STORE_TO_BODY = 0x0934,
	CZ_PARTY_BOOKING_REQ_REGISTER = 0x02c4,
	CZ_PARTY_JOIN_REQ = 0x088e,
	CZ_REQNAME = 0x096a,
...
#endif /* HORIZON_ZONE_RE_20170705_PACKETS_HPP */

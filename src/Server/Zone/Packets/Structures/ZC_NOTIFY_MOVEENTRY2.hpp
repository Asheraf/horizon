...
#ifndef HORIZON_ZONE_ZC_NOTIFY_MOVEENTRY2_HPP
#define HORIZON_ZONE_ZC_NOTIFY_MOVEENTRY2_HPP
 ...
 *
 */ 
class ZC_NOTIFY_MOVEENTRY2 : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_NOTIFY_MOVEENTRY2(std::shared_ptr<ZoneSocket> sock);
...
#endif /* HORIZON_ZONE_ZC_NOTIFY_MOVEENTRY2_HPP */

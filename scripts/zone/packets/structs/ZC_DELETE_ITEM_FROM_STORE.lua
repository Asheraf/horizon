...
local ZC_DELETE_ITEM_FROM_STORE = {
	_id = pid,
	_length = 0,
	_buffer = nil
}
...
function ZC_DELETE_ITEM_FROM_STORE.new(o)
	o = o or ZC_DELETE_ITEM_FROM_STORE
	setmetatable(o, self)
	self.__index = self
	return o
end

function ZC_DELETE_ITEM_FROM_STORE.serialize()

end

return ZC_DELETE_ITEM_FROM_STORE

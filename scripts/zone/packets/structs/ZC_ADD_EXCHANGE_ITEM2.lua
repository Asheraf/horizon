...
elseif packet_version >= 20140108 then
	local pid = 0x080f
elseif packet_version >= 20100223 then
	local pid = 0x080f
elseif packet_version >= 0 then
	local pid = 0x080f
end

local ZC_ADD_EXCHANGE_ITEM2 = {
	_id = pid,
	_length = 0,
	_buffer = nil
}
...
function ZC_ADD_EXCHANGE_ITEM2.new(o)
	o = o or ZC_ADD_EXCHANGE_ITEM2
	setmetatable(o, self)
	self.__index = self
	return o
end

function ZC_ADD_EXCHANGE_ITEM2.serialize()

end

return ZC_ADD_EXCHANGE_ITEM2

...
#ifndef HORIZON_ZONE_CZ_SETTING_WHISPER_STATE_HPP
#define HORIZON_ZONE_CZ_SETTING_WHISPER_STATE_HPP
...
enum {
	...
	ID_CZ_SETTING_WHISPER_STATE = 0x00d0
...
/**
 * @brief Main object for the aegis packet: CZ_SETTING_WHISPER_STATE
 * Size : 3 @ 0
 *
 */ 
class CZ_SETTING_WHISPER_STATE : public Base::NetworkPacket<ZoneSocket>
{
public:
	CZ_SETTING_WHISPER_STATE(std::shared_ptr<ZoneSocket> sock);
...
#endif /* HORIZON_ZONE_CZ_SETTING_WHISPER_STATE_HPP */

...
#ifndef HORIZON_ZONE_CZ_COMMAND_PET_HPP
#define HORIZON_ZONE_CZ_COMMAND_PET_HPP
...
/**
 * @brief Main object for the aegis packet: CZ_COMMAND_PET
 * Size : 3 @ 0
 *
 */ 
class CZ_COMMAND_PET : public Base::NetworkPacket<ZoneSocket>
{
public:
	CZ_COMMAND_PET(std::shared_ptr<ZoneSocket> sock);
	~CZ_COMMAND_PET();
...
#endif /* HORIZON_ZONE_CZ_COMMAND_PET_HPP */

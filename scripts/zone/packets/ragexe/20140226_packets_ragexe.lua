...
d:add(0x0894, 6, require('CZ_ITEM_THROW'))
...
d:add(0x0941, 18, require('CZ_PARTY_BOOKING_REQ_REGISTER'))
d:add(0x0921, 26, require('CZ_PARTY_JOIN_REQ'))
...
d:add(0x0887, 12, require('CZ_SSILIST_ITEM_CLICK'))

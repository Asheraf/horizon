...
d:add(0x0923, 36, require('CZ_ACK_STORE_PASSWORD'))
d:add(0x088e, 26, require('CZ_ADD_FRIENDS'))
d:add(0x0869, 5, require('CZ_CHANGE_DIRECTION'))
d:add(0x0949, 5, require('CZ_COMMAND_MER'))
d:add(0x0815, 19, require('CZ_ENTER'))
d:add(0x093a, 4, require('CZ_GANGSI_RANK'))
d:add(0x085b, -1, require('CZ_ITEMLISTWIN_RES'))
...
d:add(0x0861, 26, require('CZ_PARTY_JOIN_REQ'))
...
d:add(0x0436, -1, require('CZ_REQ_OPEN_BUYING_STORE'))
...
d:add(0x0886, 10, require('CZ_USE_SKILL_TOGROUND'))
d:add(0x07ec, 90, require('CZ_USE_SKILL_TOGROUND_WITHTALKBOX'))

...
#ifndef HORIZON_ZONE_SHUFFLE_PACKET_LENGTH_TABLE_20100824
#define HORIZON_ZONE_SHUFFLE_PACKET_LENGTH_TABLE_20100824
...
#define ADD_PKT(i, j, k) _packet_length_table.insert(i, std::make_pair<uint16_t, NetworkPacket>(j, k))
		...
		ADD_PKT(0x0849, 12, ZC_SE_PC_BUY_CASHITEM_RESULT(sock));
#undef ADD_PKT
	}
...
#endif /* HORIZON_ZONE_SHUFFLE_PACKET_LENGTH_TABLE_20100824 */
...
function ZC_ADD_ITEM_TO_CART3.new(o)
	o = o or ZC_ADD_ITEM_TO_CART3
	setmetatable(o, self)
	self.__index = self
	return o
end

function ZC_ADD_ITEM_TO_CART3.serialize()

end

return ZC_ADD_ITEM_TO_CART3

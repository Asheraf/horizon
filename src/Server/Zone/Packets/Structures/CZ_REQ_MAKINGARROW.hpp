...
#ifndef HORIZON_ZONE_CZ_REQ_MAKINGARROW_HPP
#define HORIZON_ZONE_CZ_REQ_MAKINGARROW_HPP
...
/**
 * @brief Main object for the aegis packet: CZ_REQ_MAKINGARROW
 * Size : 4 @ 0
 *
 */ 
class CZ_REQ_MAKINGARROW : public Base::NetworkPacket<ZoneSocket>
{
public:
	CZ_REQ_MAKINGARROW(std::shared_ptr<ZoneSocket> sock);
	~CZ_REQ_MAKINGARROW();
...
#endif /* HORIZON_ZONE_CZ_REQ_MAKINGARROW_HPP */

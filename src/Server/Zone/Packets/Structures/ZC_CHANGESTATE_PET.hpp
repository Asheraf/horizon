...
#ifndef HORIZON_ZONE_ZC_CHANGESTATE_PET_HPP
#define HORIZON_ZONE_ZC_CHANGESTATE_PET_HPP
 ...
 *
 */ 
class ZC_CHANGESTATE_PET : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_CHANGESTATE_PET(std::shared_ptr<ZoneSocket> sock);
	~ZC_CHANGESTATE_PET();
...
#endif /* HORIZON_ZONE_ZC_CHANGESTATE_PET_HPP */

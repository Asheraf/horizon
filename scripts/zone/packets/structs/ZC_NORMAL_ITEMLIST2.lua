...
elseif packet_version >= 20080102 then
	local pid = 0x01ee
elseif packet_version >= 20031208 then
	local pid = 0x01ee
elseif packet_version >= 0 then
	local pid = 0x01ee
end

local ZC_NORMAL_ITEMLIST2 = {
	_id = pid,
	_length = 0,
	_buffer = nil
}
...
function ZC_NORMAL_ITEMLIST2.new(o)
	o = o or ZC_NORMAL_ITEMLIST2
	setmetatable(o, self)
	self.__index = self
	return o
end

function ZC_NORMAL_ITEMLIST2.serialize()

end

return ZC_NORMAL_ITEMLIST2

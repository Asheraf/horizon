...
d:add(0x0436, 36, require('CZ_ENTER2'))
...
d:add(0x02c4, -1, require('CZ_PARTY_JOIN_REQ'))
...
d:add(0x0819, 26, require('CZ_REQ_TRADE_BUYING_STORE'))
...
d:add(0x08c7, -1, require('ZC_SKILL_ENTRY3'))

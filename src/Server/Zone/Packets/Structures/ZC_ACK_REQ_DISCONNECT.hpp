...
#ifndef HORIZON_ZONE_ZC_ACK_REQ_DISCONNECT_HPP
#define HORIZON_ZONE_ZC_ACK_REQ_DISCONNECT_HPP
 ...
 *
 */ 
class ZC_ACK_REQ_DISCONNECT : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_ACK_REQ_DISCONNECT(std::shared_ptr<ZoneSocket> sock);
...
#endif /* HORIZON_ZONE_ZC_ACK_REQ_DISCONNECT_HPP */

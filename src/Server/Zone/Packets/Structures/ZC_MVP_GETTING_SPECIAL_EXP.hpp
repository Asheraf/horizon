...
#ifndef HORIZON_ZONE_ZC_MVP_GETTING_SPECIAL_EXP_HPP
#define HORIZON_ZONE_ZC_MVP_GETTING_SPECIAL_EXP_HPP
 ...
 *
 */ 
class ZC_MVP_GETTING_SPECIAL_EXP : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_MVP_GETTING_SPECIAL_EXP(std::shared_ptr<ZoneSocket> sock);
...
#endif /* HORIZON_ZONE_ZC_MVP_GETTING_SPECIAL_EXP_HPP */

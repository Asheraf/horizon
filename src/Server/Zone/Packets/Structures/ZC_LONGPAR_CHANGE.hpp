...
#ifndef HORIZON_ZONE_ZC_LONGPAR_CHANGE_HPP
#define HORIZON_ZONE_ZC_LONGPAR_CHANGE_HPP
 ...
 *
 */ 
class ZC_LONGPAR_CHANGE : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_LONGPAR_CHANGE(std::shared_ptr<ZoneSocket> sock);
	~ZC_LONGPAR_CHANGE();
...
#endif /* HORIZON_ZONE_ZC_LONGPAR_CHANGE_HPP */

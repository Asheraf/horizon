...
#ifndef HORIZON_ZONE_ZC_PC_PURCHASE_RESULT_FROMMC_HPP
#define HORIZON_ZONE_ZC_PC_PURCHASE_RESULT_FROMMC_HPP
 ...
 *
 */ 
class ZC_PC_PURCHASE_RESULT_FROMMC : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_PC_PURCHASE_RESULT_FROMMC(std::shared_ptr<ZoneSocket> sock);
...
#endif /* HORIZON_ZONE_ZC_PC_PURCHASE_RESULT_FROMMC_HPP */

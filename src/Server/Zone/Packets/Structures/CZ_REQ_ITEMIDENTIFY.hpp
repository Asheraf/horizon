...
#ifndef HORIZON_ZONE_CZ_REQ_ITEMIDENTIFY_HPP
#define HORIZON_ZONE_CZ_REQ_ITEMIDENTIFY_HPP
...
/**
 * @brief Main object for the aegis packet: CZ_REQ_ITEMIDENTIFY
 * Size : 4 @ 0
 *
 */ 
class CZ_REQ_ITEMIDENTIFY : public Base::NetworkPacket<ZoneSocket>
{
public:
	CZ_REQ_ITEMIDENTIFY(std::shared_ptr<ZoneSocket> sock);
	~CZ_REQ_ITEMIDENTIFY();
...
#endif /* HORIZON_ZONE_CZ_REQ_ITEMIDENTIFY_HPP */

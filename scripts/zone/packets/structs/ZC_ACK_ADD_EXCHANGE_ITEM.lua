...
local ZC_ACK_ADD_EXCHANGE_ITEM = {
	_id = pid,
	_length = 0,
	_buffer = nil
}
...
function ZC_ACK_ADD_EXCHANGE_ITEM.new(o)
	o = o or ZC_ACK_ADD_EXCHANGE_ITEM
	setmetatable(o, self)
	self.__index = self
	return o
end

function ZC_ACK_ADD_EXCHANGE_ITEM.serialize()

end

return ZC_ACK_ADD_EXCHANGE_ITEM

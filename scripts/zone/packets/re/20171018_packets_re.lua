...
d:add(0x0944, 36, require('CZ_ACK_STORE_PASSWORD'))
d:add(0x094a, 26, require('CZ_ADD_FRIENDS'))
d:add(0x08a6, 5, require('CZ_CHANGE_DIRECTION'))
d:add(0x087e, 5, require('CZ_COMMAND_MER'))
d:add(0x0363, 19, require('CZ_ENTER'))
d:add(0x086a, 4, require('CZ_GANGSI_RANK'))
d:add(0x0938, -1, require('CZ_ITEMLISTWIN_RES'))
d:add(0x0436, 6, require('CZ_ITEM_PICKUP'))

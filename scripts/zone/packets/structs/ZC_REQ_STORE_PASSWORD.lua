...
function ZC_REQ_STORE_PASSWORD.new(o)
	o = o or ZC_REQ_STORE_PASSWORD
	setmetatable(o, self)
	self.__index = self
	return o
end

function ZC_REQ_STORE_PASSWORD.serialize()

end

return ZC_REQ_STORE_PASSWORD

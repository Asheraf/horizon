...
#ifndef HORIZON_ZONE_CZ_REQUEST_TIME2_HPP
#define HORIZON_ZONE_CZ_REQUEST_TIME2_HPP
...
/**
 * @brief Main object for the aegis packet: CZ_REQUEST_TIME2
 * Size : 10 @ 20080701
 *
 */ 
class CZ_REQUEST_TIME2 : public Base::NetworkPacket<ZoneSocket>
{
public:
	CZ_REQUEST_TIME2(std::shared_ptr<ZoneSocket> sock);
	~CZ_REQUEST_TIME2();
...
#endif /* HORIZON_ZONE_CZ_REQUEST_TIME2_HPP */

...
elseif packet_version >= 20080102 then
	local pid = 0x01d5
elseif packet_version >= 20041213 then
	local pid = 0x01d5
...
function CZ_INPUT_EDITDLGSTR.new(o)
	o = o or CZ_INPUT_EDITDLGSTR
	setmetatable(o, self)
	self.__index = self
	return o
end

function CZ_INPUT_EDITDLGSTR.deserialize(buf)

end

return CZ_INPUT_EDITDLGSTR

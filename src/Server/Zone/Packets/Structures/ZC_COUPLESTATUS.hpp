...
#ifndef HORIZON_ZONE_ZC_COUPLESTATUS_HPP
#define HORIZON_ZONE_ZC_COUPLESTATUS_HPP
 ...
 *
 */ 
class ZC_COUPLESTATUS : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_COUPLESTATUS(std::shared_ptr<ZoneSocket> sock);
	~ZC_COUPLESTATUS();
...
#endif /* HORIZON_ZONE_ZC_COUPLESTATUS_HPP */

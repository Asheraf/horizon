...
#ifndef HORIZON_CHAR_HC_REQUEST_CHARACTER_PASSWORD_HPP
#define HORIZON_CHAR_HC_REQUEST_CHARACTER_PASSWORD_HPP
...
#endif /* HORIZON_CHAR_HC_REQUEST_CHARACTER_PASSWORD_HPP */

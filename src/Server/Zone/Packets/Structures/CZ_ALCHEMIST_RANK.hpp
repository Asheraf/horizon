...
#ifndef HORIZON_ZONE_CZ_ALCHEMIST_RANK_HPP
#define HORIZON_ZONE_CZ_ALCHEMIST_RANK_HPP
...
/**
 * @brief Main object for the aegis packet: CZ_ALCHEMIST_RANK
 * Size : 2 @ 0
 *
 */ 
class CZ_ALCHEMIST_RANK : public Base::NetworkPacket<ZoneSocket>
{
public:
	CZ_ALCHEMIST_RANK(std::shared_ptr<ZoneSocket> sock);
	~CZ_ALCHEMIST_RANK();
...
#endif /* HORIZON_ZONE_CZ_ALCHEMIST_RANK_HPP */

...
function ZC_ITEMIDENTIFY_LIST.new(o)
	o = o or ZC_ITEMIDENTIFY_LIST
	setmetatable(o, self)
	self.__index = self
	return o
end

function ZC_ITEMIDENTIFY_LIST.serialize()

end

return ZC_ITEMIDENTIFY_LIST

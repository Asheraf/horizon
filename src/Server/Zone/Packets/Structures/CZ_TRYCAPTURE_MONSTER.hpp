...
#ifndef HORIZON_ZONE_CZ_TRYCAPTURE_MONSTER_HPP
#define HORIZON_ZONE_CZ_TRYCAPTURE_MONSTER_HPP
...
enum {
	...
	ID_CZ_TRYCAPTURE_MONSTER = 0x019f
...
/**
 * @brief Main object for the aegis packet: CZ_TRYCAPTURE_MONSTER
 * Size : 6 @ 0
 *
 */ 
class CZ_TRYCAPTURE_MONSTER : public Base::NetworkPacket<ZoneSocket>
{
public:
	CZ_TRYCAPTURE_MONSTER(std::shared_ptr<ZoneSocket> sock);
...
#endif /* HORIZON_ZONE_CZ_TRYCAPTURE_MONSTER_HPP */

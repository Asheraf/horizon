...
d:add(0x093c, 26, require('CZ_ADD_FRIENDS'))
...
d:add(0x0899, -1, require('CZ_ITEMLISTWIN_RES'))
d:add(0x0811, 6, require('CZ_ITEM_PICKUP'))
d:add(0x0925, 6, require('CZ_ITEM_THROW'))
d:add(0x0950, 8, require('CZ_JOIN_BATTLE_FIELD'))
d:add(0x0885, 8, require('CZ_MOVE_ITEM_FROM_BODY_TO_STORE'))
d:add(0x085d, 8, require('CZ_MOVE_ITEM_FROM_STORE_TO_BODY'))
d:add(0x0883, 18, require('CZ_PARTY_BOOKING_REQ_REGISTER'))

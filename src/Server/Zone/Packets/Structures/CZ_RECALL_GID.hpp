...
#ifndef HORIZON_ZONE_CZ_RECALL_GID_HPP
#define HORIZON_ZONE_CZ_RECALL_GID_HPP
...
/**
 * @brief Main object for the aegis packet: CZ_RECALL_GID
 * Size : 26 @ 0
 *
 */ 
class CZ_RECALL_GID : public Base::NetworkPacket<ZoneSocket>
{
public:
	CZ_RECALL_GID(std::shared_ptr<ZoneSocket> sock);
	~CZ_RECALL_GID();
...
#endif /* HORIZON_ZONE_CZ_RECALL_GID_HPP */

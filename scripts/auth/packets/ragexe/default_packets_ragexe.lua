...
local default_packets = {
	[0x0ac4] = { ['length'] = -1, ['module'] = require('AC_ACCEPT_LOGIN') },
	[0x0276] = { ['length'] = -1, ['module'] = require('AC_ACCEPT_LOGIN2') },
	...
	[0x0ae3] = { ['length'] = -1, ['module'] = require('AC_LOGIN_OTP') },
	[0x01f1] = { ['length'] = -1, ['module'] = require('AC_NOTIFY_ERROR') },
	[0x0823] = { ['length'] = -1, ['module'] = require('AC_OTP_AUTH_ACK') },
	[0x0821] = { ['length'] = 2, ['module'] = require('AC_OTP_USER') },
	[0x08b2] = { ['length'] = -1, ['module'] = require('AC_REALNAME_AUTH') },
	[0x006a] = { ['length'] = 23, ['module'] = require('AC_REFUSE_LOGIN') },
	[0x083e] = { ['length'] = 26, ['module'] = require('AC_REFUSE_LOGIN2') },
	[0x09a5] = { ['length'] = 7, ['module'] = require('AC_REFUSE_LOGIN3') },
	[0x0b02] = { ['length'] = 26, ['module'] = require('AC_REFUSE_LOGIN4') },
	...
	[0x09a2] = { ['length'] = 6, ['module'] = require('AC_REQ_MOBILE_OTP') },
	[0x098b] = { ['length'] = 2, ['module'] = require('AC_REQ_NEW_USER') },
	[0x08e4] = { ['length'] = 6, ['module'] = require('AC_SHUTDOWN_INFO') },
	[0x0986] = { ['length'] = 10, ['module'] = require('AC_SHUTDOWN_NOTIFY') },
	...
	[0x09a3] = { ['length'] = -1, ['module'] = require('CA_ACK_MOBILE_OTP') },
	[0x098c] = { ['length'] = 4, ['module'] = require('CA_ACK_NEW_USER') },
	...
	[0x08cc] = { ['length'] = 109, ['module'] = require('CA_LOGIN5') },
	[0x0987] = { ['length'] = -1, ['module'] = require('CA_LOGIN6') },
	[0x02b0] = { ['length'] = 85, ['module'] = require('CA_LOGIN_HAN') },
	[0x0acf] = { ['length'] = 68, ['module'] = require('CA_LOGIN_OTP') },
	[0x0277] = { ['length'] = 84, ['module'] = require('CA_LOGIN_PCBANG') },
	[0x0822] = { ['length'] = 9, ['module'] = require('CA_OTP_AUTH_REQ') },
	[0x0ad0] = { ['length'] = 11, ['module'] = require('CA_OTP_CODE') },
	...
	[0x0825] = { ['length'] = -1, ['module'] = require('CA_SSO_LOGIN_REQ') },
}

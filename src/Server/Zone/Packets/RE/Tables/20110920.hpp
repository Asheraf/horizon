...
#ifndef HORIZON_ZONE_SHUFFLE_PACKET_LENGTH_TABLE_20110920
#define HORIZON_ZONE_SHUFFLE_PACKET_LENGTH_TABLE_20110920
...
#define ADD_PKT(i, j, k) _packet_length_table.insert(i, std::make_pair<uint16_t, NetworkPacket>(j, k))
		...
		ADD_PKT(0x0360, 19, CZ_REQUEST_TIME2(sock));
		ADD_PKT(0x0815, 4, CZ_REQ_CLOSE_BUYING_STORE(sock));
...
#endif /* HORIZON_ZONE_SHUFFLE_PACKET_LENGTH_TABLE_20110920 */
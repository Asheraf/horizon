...
#ifndef HORIZON_ZONE_CZ_REQUEST_MOVETOOWNER_HPP
#define HORIZON_ZONE_CZ_REQUEST_MOVETOOWNER_HPP
...
enum {
	...
	ID_CZ_REQUEST_MOVETOOWNER = 0x0234
...
/**
 * @brief Main object for the aegis packet: CZ_REQUEST_MOVETOOWNER
 * Size : 6 @ 0
 *
 */ 
class CZ_REQUEST_MOVETOOWNER : public Base::NetworkPacket<ZoneSocket>
{
public:
	CZ_REQUEST_MOVETOOWNER(std::shared_ptr<ZoneSocket> sock);
...
#endif /* HORIZON_ZONE_CZ_REQUEST_MOVETOOWNER_HPP */

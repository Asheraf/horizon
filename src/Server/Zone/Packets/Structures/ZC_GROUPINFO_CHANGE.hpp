...
#ifndef HORIZON_ZONE_ZC_GROUPINFO_CHANGE_HPP
#define HORIZON_ZONE_ZC_GROUPINFO_CHANGE_HPP
 ...
 *
 */ 
class ZC_GROUPINFO_CHANGE : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_GROUPINFO_CHANGE(std::shared_ptr<ZoneSocket> sock);
	~ZC_GROUPINFO_CHANGE();
...
#endif /* HORIZON_ZONE_ZC_GROUPINFO_CHANGE_HPP */

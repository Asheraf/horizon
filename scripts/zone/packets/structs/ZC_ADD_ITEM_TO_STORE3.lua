...
function ZC_ADD_ITEM_TO_STORE3.new(o)
	o = o or ZC_ADD_ITEM_TO_STORE3
	setmetatable(o, self)
	self.__index = self
	return o
end

function ZC_ADD_ITEM_TO_STORE3.serialize()

end

return ZC_ADD_ITEM_TO_STORE3

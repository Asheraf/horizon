...
#ifndef HORIZON_ZONE_ZC_NOTIFY_MAPPROPERTY2_HPP
#define HORIZON_ZONE_ZC_NOTIFY_MAPPROPERTY2_HPP
 ...
 *
 */ 
class ZC_NOTIFY_MAPPROPERTY2 : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_NOTIFY_MAPPROPERTY2(std::shared_ptr<ZoneSocket> sock);
...
#endif /* HORIZON_ZONE_ZC_NOTIFY_MAPPROPERTY2_HPP */

...
if packet_version >= 20140521 then
	local pid = 0x0a07
...
local ZC_ACK_REMOVE_RODEX_ITEM = {
	_id = pid,
	_length = 0,
	_buffer = nil
}
...
function ZC_ACK_REMOVE_RODEX_ITEM.new(o)
	o = o or ZC_ACK_REMOVE_RODEX_ITEM
	setmetatable(o, self)
	self.__index = self
	return o
end

function ZC_ACK_REMOVE_RODEX_ITEM.serialize()

end

return ZC_ACK_REMOVE_RODEX_ITEM

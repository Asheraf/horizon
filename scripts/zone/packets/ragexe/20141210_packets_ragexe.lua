...
d:add(0x0963, 36, require('CZ_ACK_STORE_PASSWORD'))
d:add(0x0961, 26, require('CZ_ADD_FRIENDS'))
d:add(0x07e4, 5, require('CZ_CHANGE_DIRECTION'))
d:add(0x0436, 5, require('CZ_COMMAND_MER'))
d:add(0x0954, 19, require('CZ_ENTER'))
d:add(0x0947, 4, require('CZ_GANGSI_RANK'))
d:add(0x08ac, -1, require('CZ_ITEMLISTWIN_RES'))
d:add(0x087b, 6, require('CZ_ITEM_PICKUP'))
d:add(0x0958, 6, require('CZ_ITEM_THROW'))
d:add(0x0927, 8, require('CZ_JOIN_BATTLE_FIELD'))
d:add(0x0967, 8, require('CZ_MOVE_ITEM_FROM_BODY_TO_STORE'))
d:add(0x0955, 8, require('CZ_MOVE_ITEM_FROM_STORE_TO_BODY'))
d:add(0x092b, 18, require('CZ_PARTY_BOOKING_REQ_REGISTER'))
...
d:add(0x0885, -1, require('CZ_REQ_TRADE_BUYING_STORE'))

...
function CZ_REQ_CHANGE_MEMBERPOS.new(o)
	o = o or CZ_REQ_CHANGE_MEMBERPOS
	setmetatable(o, self)
	self.__index = self
	return o
end

function CZ_REQ_CHANGE_MEMBERPOS.deserialize(buf)

end

return CZ_REQ_CHANGE_MEMBERPOS

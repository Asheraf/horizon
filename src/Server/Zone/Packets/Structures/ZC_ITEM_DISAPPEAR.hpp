...
#ifndef HORIZON_ZONE_ZC_ITEM_DISAPPEAR_HPP
#define HORIZON_ZONE_ZC_ITEM_DISAPPEAR_HPP
 ...
 *
 */ 
class ZC_ITEM_DISAPPEAR : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_ITEM_DISAPPEAR(std::shared_ptr<ZoneSocket> sock);
	~ZC_ITEM_DISAPPEAR();
...
#endif /* HORIZON_ZONE_ZC_ITEM_DISAPPEAR_HPP */

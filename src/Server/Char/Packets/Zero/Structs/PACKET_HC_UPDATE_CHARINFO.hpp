...
#ifndef HORIZON_CHAR_ZERO_PACKET_HC_UPDATE_CHARINFO_HPP
#define HORIZON_CHAR_ZERO_PACKET_HC_UPDATE_CHARINFO_HPP
...
#endif /* HORIZON_CHAR_ZERO_PACKET_HC_UPDATE_CHARINFO_HPP */

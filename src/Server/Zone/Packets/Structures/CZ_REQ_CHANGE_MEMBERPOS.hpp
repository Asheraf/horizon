...
#ifndef HORIZON_ZONE_CZ_REQ_CHANGE_MEMBERPOS_HPP
#define HORIZON_ZONE_CZ_REQ_CHANGE_MEMBERPOS_HPP
...
enum {
	...
	ID_CZ_REQ_CHANGE_MEMBERPOS = 0x0155
...
/**
 * @brief Main object for the aegis packet: CZ_REQ_CHANGE_MEMBERPOS
 * Size : -1 @ 0
 *
 */ 
class CZ_REQ_CHANGE_MEMBERPOS : public Base::NetworkPacket<ZoneSocket>
{
public:
	CZ_REQ_CHANGE_MEMBERPOS(std::shared_ptr<ZoneSocket> sock);
...
#endif /* HORIZON_ZONE_CZ_REQ_CHANGE_MEMBERPOS_HPP */

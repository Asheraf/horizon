...
#ifndef HORIZON_ZONE_ZC_NOTIFY_NEWENTRY4_HPP
#define HORIZON_ZONE_ZC_NOTIFY_NEWENTRY4_HPP
 ...
 *
 */ 
class ZC_NOTIFY_NEWENTRY4 : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_NOTIFY_NEWENTRY4(std::shared_ptr<ZoneSocket> sock);
	~ZC_NOTIFY_NEWENTRY4();
...
#endif /* HORIZON_ZONE_ZC_NOTIFY_NEWENTRY4_HPP */

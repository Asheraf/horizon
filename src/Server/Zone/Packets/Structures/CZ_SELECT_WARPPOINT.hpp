...
#ifndef HORIZON_ZONE_CZ_SELECT_WARPPOINT_HPP
#define HORIZON_ZONE_CZ_SELECT_WARPPOINT_HPP
...
/**
 * @brief Main object for the aegis packet: CZ_SELECT_WARPPOINT
 * Size : 20 @ 0
 *
 */ 
class CZ_SELECT_WARPPOINT : public Base::NetworkPacket<ZoneSocket>
{
public:
	CZ_SELECT_WARPPOINT(std::shared_ptr<ZoneSocket> sock);
	~CZ_SELECT_WARPPOINT();
...
#endif /* HORIZON_ZONE_CZ_SELECT_WARPPOINT_HPP */

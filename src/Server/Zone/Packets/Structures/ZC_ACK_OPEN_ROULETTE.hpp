...
#ifndef HORIZON_ZONE_ZC_ACK_OPEN_ROULETTE_HPP
#define HORIZON_ZONE_ZC_ACK_OPEN_ROULETTE_HPP
 ...
 *
 */ 
class ZC_ACK_OPEN_ROULETTE : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_ACK_OPEN_ROULETTE(std::shared_ptr<ZoneSocket> sock);
...
#endif /* HORIZON_ZONE_ZC_ACK_OPEN_ROULETTE_HPP */

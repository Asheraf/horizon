...
#ifndef HORIZON_ZONE_CZ_REQUEST_CHAT_PARTY_HPP
#define HORIZON_ZONE_CZ_REQUEST_CHAT_PARTY_HPP
...
enum {
	...
	ID_CZ_REQUEST_CHAT_PARTY = 0x0108
...
/**
 * @brief Main object for the aegis packet: CZ_REQUEST_CHAT_PARTY
 * Size : -1 @ 0
 *
 */ 
class CZ_REQUEST_CHAT_PARTY : public Base::NetworkPacket<ZoneSocket>
{
public:
	CZ_REQUEST_CHAT_PARTY(std::shared_ptr<ZoneSocket> sock);
...
#endif /* HORIZON_ZONE_CZ_REQUEST_CHAT_PARTY_HPP */

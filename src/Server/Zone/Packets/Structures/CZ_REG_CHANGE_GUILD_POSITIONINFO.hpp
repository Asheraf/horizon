...
#ifndef HORIZON_ZONE_CZ_REG_CHANGE_GUILD_POSITIONINFO_HPP
#define HORIZON_ZONE_CZ_REG_CHANGE_GUILD_POSITIONINFO_HPP
...
enum {
	...
	ID_CZ_REG_CHANGE_GUILD_POSITIONINFO = 0x0161
...
/**
 * @brief Main object for the aegis packet: CZ_REG_CHANGE_GUILD_POSITIONINFO
 * Size : -1 @ 0
 *
 */ 
class CZ_REG_CHANGE_GUILD_POSITIONINFO : public Base::NetworkPacket<ZoneSocket>
{
public:
	CZ_REG_CHANGE_GUILD_POSITIONINFO(std::shared_ptr<ZoneSocket> sock);
...
#endif /* HORIZON_ZONE_CZ_REG_CHANGE_GUILD_POSITIONINFO_HPP */

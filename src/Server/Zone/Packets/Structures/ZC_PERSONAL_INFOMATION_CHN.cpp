...
#include "ZC_PERSONAL_INFOMATION_CHN.hpp"
#include "Server/Zone/Socket/ZoneSocket.hpp"

using namespace Horizon::Zone::Packet;

ZC_PERSONAL_INFOMATION_CHN::ZC_PERSONAL_INFOMATION_CHN(std::shared_ptr<ZoneSocket> sock)
: NetworkPacket(ID_ZC_PERSONAL_INFOMATION_CHN, sock) { }

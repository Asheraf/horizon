...
if packet_version >= 20120307 then
	local pid = 0x08e2
...
function ZC_NAVIGATION_ACTIVE.new(o)
	o = o or ZC_NAVIGATION_ACTIVE
	setmetatable(o, self)
	self.__index = self
	return o
end

function ZC_NAVIGATION_ACTIVE.serialize()

end

return ZC_NAVIGATION_ACTIVE

...
#ifndef HORIZON_ZONE_ZC_GAME_GUARD_HPP
#define HORIZON_ZONE_ZC_GAME_GUARD_HPP
 ...
 *
 */ 
class ZC_GAME_GUARD : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_GAME_GUARD(std::shared_ptr<ZoneSocket> sock);
	~ZC_GAME_GUARD();
...
#endif /* HORIZON_ZONE_ZC_GAME_GUARD_HPP */

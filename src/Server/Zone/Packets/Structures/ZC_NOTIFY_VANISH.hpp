...
#ifndef HORIZON_ZONE_ZC_NOTIFY_VANISH_HPP
#define HORIZON_ZONE_ZC_NOTIFY_VANISH_HPP
 ...
 *
 */ 
class ZC_NOTIFY_VANISH : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_NOTIFY_VANISH(std::shared_ptr<ZoneSocket> sock);
	~ZC_NOTIFY_VANISH();
...
#endif /* HORIZON_ZONE_ZC_NOTIFY_VANISH_HPP */

...
#ifndef HORIZON_ZONE_ZC_STATUS_CHANGE_HPP
#define HORIZON_ZONE_ZC_STATUS_CHANGE_HPP
 ...
 *
 */ 
class ZC_STATUS_CHANGE : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_STATUS_CHANGE(std::shared_ptr<ZoneSocket> sock);
	~ZC_STATUS_CHANGE();
...
#endif /* HORIZON_ZONE_ZC_STATUS_CHANGE_HPP */

...
d:add(0x0202, 36, require('CZ_ACK_STORE_PASSWORD'))
d:add(0x0928, 26, require('CZ_ADD_FRIENDS'))
d:add(0x089e, 5, require('CZ_CHANGE_DIRECTION'))
d:add(0x0811, 5, require('CZ_COMMAND_MER'))
d:add(0x091f, 19, require('CZ_ENTER'))
d:add(0x0950, 4, require('CZ_GANGSI_RANK'))
d:add(0x0363, -1, require('CZ_ITEMLISTWIN_RES'))
d:add(0x0918, 6, require('CZ_ITEM_PICKUP'))
d:add(0x0362, 6, require('CZ_ITEM_THROW'))
d:add(0x0943, 8, require('CZ_JOIN_BATTLE_FIELD'))
d:add(0x0866, 8, require('CZ_MOVE_ITEM_FROM_BODY_TO_STORE'))
d:add(0x0889, 8, require('CZ_MOVE_ITEM_FROM_STORE_TO_BODY'))
d:add(0x0892, 18, require('CZ_PARTY_BOOKING_REQ_REGISTER'))
d:add(0x08ad, 26, require('CZ_PARTY_JOIN_REQ'))
...
d:add(0x022d, -1, require('CZ_REQ_TRADE_BUYING_STORE'))

...
#ifndef HORIZON_ZONE_ZC_SPIRITS2_HPP
#define HORIZON_ZONE_ZC_SPIRITS2_HPP
 ...
 *
 */ 
class ZC_SPIRITS2 : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_SPIRITS2(std::shared_ptr<ZoneSocket> sock);
	~ZC_SPIRITS2();
...
#endif /* HORIZON_ZONE_ZC_SPIRITS2_HPP */

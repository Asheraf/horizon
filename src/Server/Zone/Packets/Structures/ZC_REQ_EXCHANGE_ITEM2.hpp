...
#ifndef HORIZON_ZONE_ZC_REQ_EXCHANGE_ITEM2_HPP
#define HORIZON_ZONE_ZC_REQ_EXCHANGE_ITEM2_HPP
 ...
 *
 */ 
class ZC_REQ_EXCHANGE_ITEM2 : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_REQ_EXCHANGE_ITEM2(std::shared_ptr<ZoneSocket> sock);
...
#endif /* HORIZON_ZONE_ZC_REQ_EXCHANGE_ITEM2_HPP */

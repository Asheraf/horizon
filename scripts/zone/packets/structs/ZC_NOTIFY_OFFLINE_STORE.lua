...
function ZC_NOTIFY_OFFLINE_STORE.new(o)
	o = o or ZC_NOTIFY_OFFLINE_STORE
	setmetatable(o, self)
	self.__index = self
	return o
end

function ZC_NOTIFY_OFFLINE_STORE.serialize()

end

return ZC_NOTIFY_OFFLINE_STORE

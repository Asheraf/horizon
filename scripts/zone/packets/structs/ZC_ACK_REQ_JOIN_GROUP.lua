...
function ZC_ACK_REQ_JOIN_GROUP.new(o)
	o = o or ZC_ACK_REQ_JOIN_GROUP
	setmetatable(o, self)
	self.__index = self
	return o
end

function ZC_ACK_REQ_JOIN_GROUP.serialize()

end

return ZC_ACK_REQ_JOIN_GROUP

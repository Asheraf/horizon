...
#ifndef HORIZON_ZONE_CZ_DORIDORI_HPP
#define HORIZON_ZONE_CZ_DORIDORI_HPP
...
/**
 * @brief Main object for the aegis packet: CZ_DORIDORI
 * Size : 2 @ 0
 *
 */ 
class CZ_DORIDORI : public Base::NetworkPacket<ZoneSocket>
{
public:
	CZ_DORIDORI(std::shared_ptr<ZoneSocket> sock);
	~CZ_DORIDORI();
...
#endif /* HORIZON_ZONE_CZ_DORIDORI_HPP */

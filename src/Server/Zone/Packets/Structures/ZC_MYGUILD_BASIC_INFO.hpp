...
#ifndef HORIZON_ZONE_ZC_MYGUILD_BASIC_INFO_HPP
#define HORIZON_ZONE_ZC_MYGUILD_BASIC_INFO_HPP
 ...
 *
 */ 
class ZC_MYGUILD_BASIC_INFO : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_MYGUILD_BASIC_INFO(std::shared_ptr<ZoneSocket> sock);
...
#endif /* HORIZON_ZONE_ZC_MYGUILD_BASIC_INFO_HPP */

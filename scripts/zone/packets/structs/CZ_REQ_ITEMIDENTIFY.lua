...
function CZ_REQ_ITEMIDENTIFY.new(o)
	o = o or CZ_REQ_ITEMIDENTIFY
	setmetatable(o, self)
	self.__index = self
	return o
end

function CZ_REQ_ITEMIDENTIFY.deserialize(buf)

end

return CZ_REQ_ITEMIDENTIFY

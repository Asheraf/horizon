...
#ifndef HORIZON_ZONE_ZC_PAR_CHANGE_HPP
#define HORIZON_ZONE_ZC_PAR_CHANGE_HPP
 ...
 *
 */ 
class ZC_PAR_CHANGE : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_PAR_CHANGE(std::shared_ptr<ZoneSocket> sock);
	~ZC_PAR_CHANGE();
...
#endif /* HORIZON_ZONE_ZC_PAR_CHANGE_HPP */

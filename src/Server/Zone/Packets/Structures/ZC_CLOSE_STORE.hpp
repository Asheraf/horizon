...
#ifndef HORIZON_ZONE_ZC_CLOSE_STORE_HPP
#define HORIZON_ZONE_ZC_CLOSE_STORE_HPP
 ...
 *
 */ 
class ZC_CLOSE_STORE : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_CLOSE_STORE(std::shared_ptr<ZoneSocket> sock);
	~ZC_CLOSE_STORE();
...
#endif /* HORIZON_ZONE_ZC_CLOSE_STORE_HPP */

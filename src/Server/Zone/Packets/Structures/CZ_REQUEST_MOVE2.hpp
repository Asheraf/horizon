...
#ifndef HORIZON_ZONE_CZ_REQUEST_MOVE2_HPP
#define HORIZON_ZONE_CZ_REQUEST_MOVE2_HPP
...
/**
 * @brief Main object for the aegis packet: CZ_REQUEST_MOVE2
 * Size : -1 @ 20080528
 *
 */ 
class CZ_REQUEST_MOVE2 : public Base::NetworkPacket<ZoneSocket>
{
public:
	CZ_REQUEST_MOVE2(std::shared_ptr<ZoneSocket> sock);
	~CZ_REQUEST_MOVE2();
...
#endif /* HORIZON_ZONE_CZ_REQUEST_MOVE2_HPP */

...
#ifndef HORIZON_ZONE_CZ_CHANGE_EFFECTSTATE_HPP
#define HORIZON_ZONE_CZ_CHANGE_EFFECTSTATE_HPP
...
enum {
	...
	ID_CZ_CHANGE_EFFECTSTATE = 0x019d
...
/**
 * @brief Main object for the aegis packet: CZ_CHANGE_EFFECTSTATE
 * Size : 6 @ 0
 *
 */ 
class CZ_CHANGE_EFFECTSTATE : public Base::NetworkPacket<ZoneSocket>
{
public:
	CZ_CHANGE_EFFECTSTATE(std::shared_ptr<ZoneSocket> sock);
...
#endif /* HORIZON_ZONE_CZ_CHANGE_EFFECTSTATE_HPP */

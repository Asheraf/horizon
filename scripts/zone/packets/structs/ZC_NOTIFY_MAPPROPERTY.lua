...
function ZC_NOTIFY_MAPPROPERTY.new(o)
	o = o or ZC_NOTIFY_MAPPROPERTY
	setmetatable(o, self)
	self.__index = self
	return o
end

function ZC_NOTIFY_MAPPROPERTY.serialize()

end

return ZC_NOTIFY_MAPPROPERTY

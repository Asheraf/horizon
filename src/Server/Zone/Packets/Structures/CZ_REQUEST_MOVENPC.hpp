...
#ifndef HORIZON_ZONE_CZ_REQUEST_MOVENPC_HPP
#define HORIZON_ZONE_CZ_REQUEST_MOVENPC_HPP
...
/**
 * @brief Main object for the aegis packet: CZ_REQUEST_MOVENPC
 * Size : 9 @ 0
 *
 */ 
class CZ_REQUEST_MOVENPC : public Base::NetworkPacket<ZoneSocket>
{
public:
	CZ_REQUEST_MOVENPC(std::shared_ptr<ZoneSocket> sock);
	~CZ_REQUEST_MOVENPC();
...
#endif /* HORIZON_ZONE_CZ_REQUEST_MOVENPC_HPP */

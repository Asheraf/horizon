...
#ifndef HORIZON_ZONE_CZ_REMOVE_AID_HPP
#define HORIZON_ZONE_CZ_REMOVE_AID_HPP
...
/**
 * @brief Main object for the aegis packet: CZ_REMOVE_AID
 * Size : 26 @ 0
 *
 */ 
class CZ_REMOVE_AID : public Base::NetworkPacket<ZoneSocket>
{
public:
	CZ_REMOVE_AID(std::shared_ptr<ZoneSocket> sock);
	~CZ_REMOVE_AID();
...
#endif /* HORIZON_ZONE_CZ_REMOVE_AID_HPP */

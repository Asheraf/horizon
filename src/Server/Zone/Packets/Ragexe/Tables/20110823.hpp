...
#ifndef HORIZON_ZONE_SHUFFLE_PACKET_LENGTH_TABLE_20110823
#define HORIZON_ZONE_SHUFFLE_PACKET_LENGTH_TABLE_20110823
...
#define ADD_PKT(i, j, k) _packet_length_table.insert(i, std::make_pair<uint16_t, NetworkPacket>(j, k))
		...
		ADD_PKT(0x0362, 10, CZ_ITEM_PICKUP2(sock));
		ADD_PKT(0x0363, 2, CZ_ITEM_THROW2(sock));
		ADD_PKT(0x07ec, 36, CZ_JOIN_BATTLE_FIELD(sock));
		...
		ADD_PKT(0x0811, 10, CZ_REQ_OPEN_BUYING_STORE(sock));
...
#endif /* HORIZON_ZONE_SHUFFLE_PACKET_LENGTH_TABLE_20110823 */
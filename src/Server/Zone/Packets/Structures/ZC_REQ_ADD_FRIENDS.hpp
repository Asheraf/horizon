...
#ifndef HORIZON_ZONE_ZC_REQ_ADD_FRIENDS_HPP
#define HORIZON_ZONE_ZC_REQ_ADD_FRIENDS_HPP
 ...
 *
 */ 
class ZC_REQ_ADD_FRIENDS : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_REQ_ADD_FRIENDS(std::shared_ptr<ZoneSocket> sock);
	~ZC_REQ_ADD_FRIENDS();
...
#endif /* HORIZON_ZONE_ZC_REQ_ADD_FRIENDS_HPP */

...
#ifndef HORIZON_ZONE_ZC_MEMBER_EXIT_HPP
#define HORIZON_ZONE_ZC_MEMBER_EXIT_HPP
 ...
 *
 */ 
class ZC_MEMBER_EXIT : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_MEMBER_EXIT(std::shared_ptr<ZoneSocket> sock);
	~ZC_MEMBER_EXIT();
...
#endif /* HORIZON_ZONE_ZC_MEMBER_EXIT_HPP */

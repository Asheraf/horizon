...
#ifndef HORIZON_ZONE_ZC_USE_ITEM_ACK_HPP
#define HORIZON_ZONE_ZC_USE_ITEM_ACK_HPP
 ...
 *
 */ 
class ZC_USE_ITEM_ACK : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_USE_ITEM_ACK(std::shared_ptr<ZoneSocket> sock);
	~ZC_USE_ITEM_ACK();
...
#endif /* HORIZON_ZONE_ZC_USE_ITEM_ACK_HPP */

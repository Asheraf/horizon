...
if packet_version >= 20180328 then
	local pid = 0x0206
...
elseif packet_version >= 20080102 then
	local pid = 0x0206
elseif packet_version >= 20040705 then
	local pid = 0x0206
elseif packet_version >= 20040628 then
	local pid = 0x0206
elseif packet_version >= 0 then
	local pid = 0x0206
end

local ZC_FRIENDS_STATE = {
	_id = pid,
	_length = 0,
	_buffer = nil
}
...
function ZC_FRIENDS_STATE.new(o)
	o = o or ZC_FRIENDS_STATE
	setmetatable(o, self)
	self.__index = self
	return o
end

function ZC_FRIENDS_STATE.serialize()

end

return ZC_FRIENDS_STATE

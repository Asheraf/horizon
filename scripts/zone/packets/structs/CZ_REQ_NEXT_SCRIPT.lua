...
function CZ_REQ_NEXT_SCRIPT.new(o)
	o = o or CZ_REQ_NEXT_SCRIPT
	setmetatable(o, self)
	self.__index = self
	return o
end

function CZ_REQ_NEXT_SCRIPT.deserialize(buf)

end

return CZ_REQ_NEXT_SCRIPT

...
#ifndef HORIZON_ZONE_SHUFFLE_PACKET_LENGTH_TABLE_20120702
#define HORIZON_ZONE_SHUFFLE_PACKET_LENGTH_TABLE_20120702
...
#define ADD_PKT(i, j, k) _packet_length_table.insert(i, std::make_pair<uint16_t, NetworkPacket>(j, k))
		...
		ADD_PKT(0x0802, -1, CZ_PARTY_BOOKING_REQ_REGISTER(sock));
		...
		ADD_PKT(0x0989, 6, ZC_ACK_CLAN_LEAVE(sock));
		ADD_PKT(0x098a, -1, ZC_CLANINFO(sock));
		ADD_PKT(0x0988, 2, ZC_NOTIFY_CLAN_CONNECTINFO(sock));
#undef ADD_PKT
	}
...
#endif /* HORIZON_ZONE_SHUFFLE_PACKET_LENGTH_TABLE_20120702 */
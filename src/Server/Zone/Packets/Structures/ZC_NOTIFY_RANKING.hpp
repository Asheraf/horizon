...
#ifndef HORIZON_ZONE_ZC_NOTIFY_RANKING_HPP
#define HORIZON_ZONE_ZC_NOTIFY_RANKING_HPP
 ...
 *
 */ 
class ZC_NOTIFY_RANKING : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_NOTIFY_RANKING(std::shared_ptr<ZoneSocket> sock);
	~ZC_NOTIFY_RANKING();
...
#endif /* HORIZON_ZONE_ZC_NOTIFY_RANKING_HPP */

...
#ifndef HORIZON_ZONE_SHUFFLE_PACKET_LENGTH_TABLE_20120207
#define HORIZON_ZONE_SHUFFLE_PACKET_LENGTH_TABLE_20120207
...
#define ADD_PKT(i, j, k) _packet_length_table.insert(i, std::make_pair<uint16_t, NetworkPacket>(j, k))
		...
		ADD_PKT(0x096b, 3, ZC_PRNPC_STATE(sock));
#undef ADD_PKT
	}
...
#endif /* HORIZON_ZONE_SHUFFLE_PACKET_LENGTH_TABLE_20120207 */
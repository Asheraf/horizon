...
#ifndef HORIZON_ZONE_CZ_MOVE_ITEM_FROM_STORE_TO_BODY2_HPP
#define HORIZON_ZONE_CZ_MOVE_ITEM_FROM_STORE_TO_BODY2_HPP
...
enum {
	...
	ID_CZ_MOVE_ITEM_FROM_STORE_TO_BODY2 = 0x0365
...
/**
 * @brief Main object for the aegis packet: CZ_MOVE_ITEM_FROM_STORE_TO_BODY2
 * Size : 18 @ 20080701
 *
 */ 
class CZ_MOVE_ITEM_FROM_STORE_TO_BODY2 : public Base::NetworkPacket<ZoneSocket>
{
public:
	CZ_MOVE_ITEM_FROM_STORE_TO_BODY2(std::shared_ptr<ZoneSocket> sock);
...
#endif /* HORIZON_ZONE_CZ_MOVE_ITEM_FROM_STORE_TO_BODY2_HPP */

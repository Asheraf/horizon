...
d:add(0x086d, 36, require('CZ_ACK_STORE_PASSWORD'))
...
d:add(0x0969, 4, require('CZ_GANGSI_RANK'))
d:add(0x095b, -1, require('CZ_ITEMLISTWIN_RES'))
d:add(0x0958, 6, require('CZ_ITEM_PICKUP'))
d:add(0x087d, 6, require('CZ_ITEM_THROW'))
d:add(0x0890, 8, require('CZ_JOIN_BATTLE_FIELD'))
d:add(0x095c, 8, require('CZ_MOVE_ITEM_FROM_BODY_TO_STORE'))
d:add(0x0876, 8, require('CZ_MOVE_ITEM_FROM_STORE_TO_BODY'))
d:add(0x095a, 18, require('CZ_PARTY_BOOKING_REQ_REGISTER'))

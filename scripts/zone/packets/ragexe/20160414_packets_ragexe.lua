...
d:add(0x0945, 26, require('CZ_ADD_FRIENDS'))
d:add(0x0922, 5, require('CZ_CHANGE_DIRECTION'))
d:add(0x0934, 5, require('CZ_COMMAND_MER'))
d:add(0x0862, 19, require('CZ_ENTER'))
d:add(0x0918, 4, require('CZ_GANGSI_RANK'))
d:add(0x0362, -1, require('CZ_ITEMLISTWIN_RES'))
d:add(0x0363, 6, require('CZ_ITEM_PICKUP'))
d:add(0x0931, 6, require('CZ_ITEM_THROW'))
d:add(0x087a, 8, require('CZ_JOIN_BATTLE_FIELD'))
d:add(0x0953, 8, require('CZ_MOVE_ITEM_FROM_BODY_TO_STORE'))
d:add(0x0885, 8, require('CZ_MOVE_ITEM_FROM_STORE_TO_BODY'))
d:add(0x0880, 18, require('CZ_PARTY_BOOKING_REQ_REGISTER'))

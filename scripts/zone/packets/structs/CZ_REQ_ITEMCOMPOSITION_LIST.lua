...
local CZ_REQ_ITEMCOMPOSITION_LIST = {
	_id = pid,
	_length = 0,
	_buffer = nil
}
...
function CZ_REQ_ITEMCOMPOSITION_LIST.new(o)
	o = o or CZ_REQ_ITEMCOMPOSITION_LIST
	setmetatable(o, self)
	self.__index = self
	return o
end

function CZ_REQ_ITEMCOMPOSITION_LIST.deserialize(buf)

end

return CZ_REQ_ITEMCOMPOSITION_LIST

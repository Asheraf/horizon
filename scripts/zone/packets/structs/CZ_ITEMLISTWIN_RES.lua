...
elseif packet_version >= 20100105 then
	local pid = 0x07e4
elseif packet_version >= 20090818 then
	local pid = 0x07e4
elseif packet_version >= 0 then
	local pid = 0x07e4
end

local CZ_ITEMLISTWIN_RES = {
	_id = pid,
	_length = 0,
	_buffer = nil
}
...
function CZ_ITEMLISTWIN_RES.new(o)
	o = o or CZ_ITEMLISTWIN_RES
	setmetatable(o, self)
	self.__index = self
	return o
end

function CZ_ITEMLISTWIN_RES.deserialize(buf)

end

return CZ_ITEMLISTWIN_RES

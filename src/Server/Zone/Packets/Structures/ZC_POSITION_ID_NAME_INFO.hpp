...
#ifndef HORIZON_ZONE_ZC_POSITION_ID_NAME_INFO_HPP
#define HORIZON_ZONE_ZC_POSITION_ID_NAME_INFO_HPP
 ...
 *
 */ 
class ZC_POSITION_ID_NAME_INFO : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_POSITION_ID_NAME_INFO(std::shared_ptr<ZoneSocket> sock);
...
#endif /* HORIZON_ZONE_ZC_POSITION_ID_NAME_INFO_HPP */

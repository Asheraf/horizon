...
#ifndef HORIZON_ZONE_ZC_SAY_CoreLog_HPP
#define HORIZON_ZONE_ZC_SAY_CoreLog_HPP
...
/**
 * @brief Main object for the aegis packet: ZC_SAY_CoreLog
 * Size : -1 @ 0
 *
 */ 
class ZC_SAY_CoreLog : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_SAY_CoreLog(std::shared_ptr<ZoneSocket> sock);
	~ZC_SAY_CoreLog();
...
#endif /* HORIZON_ZONE_ZC_SAY_CoreLog_HPP */

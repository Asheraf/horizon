...
#ifndef HORIZON_ZONE_ZC_CONGRATULATION_HPP
#define HORIZON_ZONE_ZC_CONGRATULATION_HPP
 ...
 *
 */ 
class ZC_CONGRATULATION : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_CONGRATULATION(std::shared_ptr<ZoneSocket> sock);
	~ZC_CONGRATULATION();
...
#endif /* HORIZON_ZONE_ZC_CONGRATULATION_HPP */

...
#ifndef HORIZON_ZONE_CZ_JOIN_GROUP_HPP
#define HORIZON_ZONE_CZ_JOIN_GROUP_HPP
...
/**
 * @brief Main object for the aegis packet: CZ_JOIN_GROUP
 * Size : 10 @ 0
 *
 */ 
class CZ_JOIN_GROUP : public Base::NetworkPacket<ZoneSocket>
{
public:
	CZ_JOIN_GROUP(std::shared_ptr<ZoneSocket> sock);
	~CZ_JOIN_GROUP();
...
#endif /* HORIZON_ZONE_CZ_JOIN_GROUP_HPP */

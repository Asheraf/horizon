...
#ifndef HORIZON_ZONE_ZC_DELETE_ITEM_FROM_STORE_HPP
#define HORIZON_ZONE_ZC_DELETE_ITEM_FROM_STORE_HPP
 ...
 *
 */ 
class ZC_DELETE_ITEM_FROM_STORE : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_DELETE_ITEM_FROM_STORE(std::shared_ptr<ZoneSocket> sock);
...
#endif /* HORIZON_ZONE_ZC_DELETE_ITEM_FROM_STORE_HPP */

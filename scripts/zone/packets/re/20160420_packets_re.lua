...
d:add(0x0872, 5, require('CZ_CHANGE_DIRECTION'))
d:add(0x0819, 5, require('CZ_COMMAND_MER'))
d:add(0x0888, 19, require('CZ_ENTER'))
d:add(0x0870, 4, require('CZ_GANGSI_RANK'))
d:add(0x094e, -1, require('CZ_ITEMLISTWIN_RES'))
d:add(0x0864, 6, require('CZ_ITEM_PICKUP'))
d:add(0x0884, 6, require('CZ_ITEM_THROW'))
d:add(0x095c, 8, require('CZ_JOIN_BATTLE_FIELD'))
d:add(0x0874, 8, require('CZ_MOVE_ITEM_FROM_BODY_TO_STORE'))
d:add(0x088b, 8, require('CZ_MOVE_ITEM_FROM_STORE_TO_BODY'))
d:add(0x092f, 18, require('CZ_PARTY_BOOKING_REQ_REGISTER'))
d:add(0x035f, 26, require('CZ_PARTY_JOIN_REQ'))
...
d:add(0x022d, -1, require('CZ_SEARCH_STORE_INFO'))

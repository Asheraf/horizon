...
#ifndef HORIZON_ZONE_ZC_ACK_CASH_BARGAIN_SALE_ITEM_INFO_HPP
#define HORIZON_ZONE_ZC_ACK_CASH_BARGAIN_SALE_ITEM_INFO_HPP
 ...
 *
 */ 
class ZC_ACK_CASH_BARGAIN_SALE_ITEM_INFO : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_ACK_CASH_BARGAIN_SALE_ITEM_INFO(std::shared_ptr<ZoneSocket> sock);
...
#endif /* HORIZON_ZONE_ZC_ACK_CASH_BARGAIN_SALE_ITEM_INFO_HPP */

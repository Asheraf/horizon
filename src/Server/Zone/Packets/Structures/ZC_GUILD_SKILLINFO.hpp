...
#ifndef HORIZON_ZONE_ZC_GUILD_SKILLINFO_HPP
#define HORIZON_ZONE_ZC_GUILD_SKILLINFO_HPP
 ...
 *
 */ 
class ZC_GUILD_SKILLINFO : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_GUILD_SKILLINFO(std::shared_ptr<ZoneSocket> sock);
	~ZC_GUILD_SKILLINFO();
...
#endif /* HORIZON_ZONE_ZC_GUILD_SKILLINFO_HPP */

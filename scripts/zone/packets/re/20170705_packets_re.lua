...
d:add(0x0886, 26, require('CZ_ADD_FRIENDS'))
d:add(0x091a, 5, require('CZ_CHANGE_DIRECTION'))
d:add(0x094c, 5, require('CZ_COMMAND_MER'))
d:add(0x089a, 19, require('CZ_ENTER'))
d:add(0x092f, 4, require('CZ_GANGSI_RANK'))
d:add(0x0930, -1, require('CZ_ITEMLISTWIN_RES'))
d:add(0x0932, 6, require('CZ_ITEM_PICKUP'))
...
d:add(0x0934, 8, require('CZ_MOVE_ITEM_FROM_STORE_TO_BODY'))

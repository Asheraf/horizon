...
function CZ_ACK_REQ_ADD_FRIENDS.new(o)
	o = o or CZ_ACK_REQ_ADD_FRIENDS
	setmetatable(o, self)
	self.__index = self
	return o
end

function CZ_ACK_REQ_ADD_FRIENDS.serialize()

end

return CZ_ACK_REQ_ADD_FRIENDS

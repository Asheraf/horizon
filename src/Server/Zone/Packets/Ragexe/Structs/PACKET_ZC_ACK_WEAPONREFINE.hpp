...
#ifndef HORIZON_ZONE_RAGEXE_PACKET_ZC_ACK_WEAPONREFINE_HPP
#define HORIZON_ZONE_RAGEXE_PACKET_ZC_ACK_WEAPONREFINE_HPP
...
#endif /* HORIZON_ZONE_RAGEXE_PACKET_ZC_ACK_WEAPONREFINE_HPP */

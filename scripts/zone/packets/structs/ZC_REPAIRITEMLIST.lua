...
elseif packet_version >= 20080102 then
	local pid = 0x01fc
elseif packet_version >= 20040420 then
	local pid = 0x01fc
elseif packet_version >= 0 then
	local pid = 0x01fc
end

local ZC_REPAIRITEMLIST = {
	_id = pid,
	_length = 0,
	_buffer = nil
}
...
function ZC_REPAIRITEMLIST.new(o)
	o = o or ZC_REPAIRITEMLIST
	setmetatable(o, self)
	self.__index = self
	return o
end

function ZC_REPAIRITEMLIST.serialize()

end

return ZC_REPAIRITEMLIST

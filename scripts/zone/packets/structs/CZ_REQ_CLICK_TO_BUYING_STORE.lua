...
local CZ_REQ_CLICK_TO_BUYING_STORE = {
	_id = pid,
	_length = 0,
	_buffer = nil
}
...
function CZ_REQ_CLICK_TO_BUYING_STORE.new(o)
	o = o or CZ_REQ_CLICK_TO_BUYING_STORE
	setmetatable(o, self)
	self.__index = self
	return o
end

function CZ_REQ_CLICK_TO_BUYING_STORE.deserialize(buf)

end

return CZ_REQ_CLICK_TO_BUYING_STORE

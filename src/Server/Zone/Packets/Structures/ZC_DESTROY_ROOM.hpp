...
#ifndef HORIZON_ZONE_ZC_DESTROY_ROOM_HPP
#define HORIZON_ZONE_ZC_DESTROY_ROOM_HPP
 ...
 *
 */ 
class ZC_DESTROY_ROOM : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_DESTROY_ROOM(std::shared_ptr<ZoneSocket> sock);
	~ZC_DESTROY_ROOM();
...
#endif /* HORIZON_ZONE_ZC_DESTROY_ROOM_HPP */

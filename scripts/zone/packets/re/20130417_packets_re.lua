...
d:add(0x0875, 36, require('CZ_ACK_STORE_PASSWORD'))
d:add(0x0811, 26, require('CZ_ADD_FRIENDS'))
d:add(0x0929, 5, require('CZ_CHANGE_DIRECTION'))
d:add(0x0962, 5, require('CZ_COMMAND_MER'))
d:add(0x086b, 19, require('CZ_ENTER'))
d:add(0x096a, 4, require('CZ_GANGSI_RANK'))
...
d:add(0x0969, 6, require('CZ_REQNAME'))

...
#ifndef HORIZON_ZONE_ZC_USER_COUNT_HPP
#define HORIZON_ZONE_ZC_USER_COUNT_HPP
 ...
 *
 */ 
class ZC_USER_COUNT : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_USER_COUNT(std::shared_ptr<ZoneSocket> sock);
	~ZC_USER_COUNT();
...
#endif /* HORIZON_ZONE_ZC_USER_COUNT_HPP */

...
if packet_version >= 20171206 then
	local pid = 0x0ae4
...
elseif packet_version >= 20080102 then
	local pid = 0x0104
elseif packet_version >= 20031117 then
	local pid = 0x0104
elseif packet_version >= 20031110 then
	local pid = 0x0104
elseif packet_version >= 20031029 then
	local pid = 0x0104
elseif packet_version >= 20031028 then
	local pid = 0x0104
elseif packet_version >= 0 then
	local pid = 0x0104
end

local ZC_ADD_MEMBER_TO_GROUP = {
	_id = pid,
	_length = 0,
	_buffer = nil
}
...
function ZC_ADD_MEMBER_TO_GROUP.new(o)
	o = o or ZC_ADD_MEMBER_TO_GROUP
	setmetatable(o, self)
	self.__index = self
	return o
end

function ZC_ADD_MEMBER_TO_GROUP.serialize()

end

return ZC_ADD_MEMBER_TO_GROUP

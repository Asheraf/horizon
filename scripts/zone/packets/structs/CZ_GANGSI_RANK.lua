...
elseif packet_version >= 20100105 then
	local pid = 0x0281
elseif packet_version >= 20060918 then
	local pid = 0x0281
...
function CZ_GANGSI_RANK.new(o)
	o = o or CZ_GANGSI_RANK
	setmetatable(o, self)
	self.__index = self
	return o
end

function CZ_GANGSI_RANK.deserialize(buf)

end

return CZ_GANGSI_RANK

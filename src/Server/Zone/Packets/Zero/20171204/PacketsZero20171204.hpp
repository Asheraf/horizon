...
#ifndef HORIZON_ZONE_ZERO_20171204_PACKETS_HPP
#define HORIZON_ZONE_ZERO_20171204_PACKETS_HPP
...
enum packets
{
	CZ_ACK_STORE_PASSWORD = 0x0896,
	CZ_ADD_FRIENDS = 0x091b,
	CZ_CHANGE_DIRECTION = 0x0887,
	CZ_CHANGE_DIRECTION2 = 0x0361,
	CZ_COMMAND_MER = 0x0924,
	CZ_ENTER = 0x086f,
	CZ_GANGSI_RANK = 0x0892,
	CZ_ITEMLISTWIN_RES = 0x087d,
	CZ_ITEM_PICKUP = 0x0281,
	CZ_ITEM_THROW = 0x0960,
	CZ_JOIN_BATTLE_FIELD = 0x085b,
	CZ_MOVE_ITEM_FROM_BODY_TO_STORE = 0x0937,
	CZ_MOVE_ITEM_FROM_STORE_TO_BODY = 0x0917,
	CZ_PARTY_BOOKING_REQ_REGISTER = 0x0921,
	CZ_PARTY_JOIN_REQ = 0x08aa,
	CZ_REQNAME = 0x096a,
...
#endif /* HORIZON_ZONE_ZERO_20171204_PACKETS_HPP */

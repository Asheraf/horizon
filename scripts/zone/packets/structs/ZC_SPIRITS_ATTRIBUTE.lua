...
function ZC_SPIRITS_ATTRIBUTE.new(o)
	o = o or ZC_SPIRITS_ATTRIBUTE
	setmetatable(o, self)
	self.__index = self
	return o
end

function ZC_SPIRITS_ATTRIBUTE.serialize()

end

return ZC_SPIRITS_ATTRIBUTE

...
#ifndef HORIZON_ZONE_ZC_GUILD_INFO2_HPP
#define HORIZON_ZONE_ZC_GUILD_INFO2_HPP
 ...
 *
 */ 
class ZC_GUILD_INFO2 : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_GUILD_INFO2(std::shared_ptr<ZoneSocket> sock);
	~ZC_GUILD_INFO2();
...
#endif /* HORIZON_ZONE_ZC_GUILD_INFO2_HPP */

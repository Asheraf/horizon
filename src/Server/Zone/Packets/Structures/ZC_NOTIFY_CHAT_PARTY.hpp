...
#ifndef HORIZON_ZONE_ZC_NOTIFY_CHAT_PARTY_HPP
#define HORIZON_ZONE_ZC_NOTIFY_CHAT_PARTY_HPP
 ...
 *
 */ 
class ZC_NOTIFY_CHAT_PARTY : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_NOTIFY_CHAT_PARTY(std::shared_ptr<ZoneSocket> sock);
...
#endif /* HORIZON_ZONE_ZC_NOTIFY_CHAT_PARTY_HPP */

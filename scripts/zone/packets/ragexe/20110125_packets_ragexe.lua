...
d:add(0x0364, 12, require('CZ_MOVE_ITEM_FROM_BODY_TO_STORE2'))
d:add(0x0802, 7, require('CZ_PARTY_BOOKING_REQ_REGISTER'))
d:add(0x02c4, 2, require('CZ_PARTY_JOIN_REQ'))
d:add(0x0368, 6, require('CZ_REQNAME2'))
d:add(0x0369, 18, require('CZ_REQNAME_BYGID2'))
...
d:add(0x08b5, 6, require('CZ_TRYCOLLECTION'))
...
d:add(0x08b4, 2, require('ZC_START_COLLECTION'))
d:add(0x08b6, 3, require('ZC_TRYCOLLECTION'))

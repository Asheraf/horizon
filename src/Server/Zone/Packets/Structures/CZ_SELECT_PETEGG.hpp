...
#ifndef HORIZON_ZONE_CZ_SELECT_PETEGG_HPP
#define HORIZON_ZONE_CZ_SELECT_PETEGG_HPP
...
/**
 * @brief Main object for the aegis packet: CZ_SELECT_PETEGG
 * Size : 4 @ 0
 *
 */ 
class CZ_SELECT_PETEGG : public Base::NetworkPacket<ZoneSocket>
{
public:
	CZ_SELECT_PETEGG(std::shared_ptr<ZoneSocket> sock);
	~CZ_SELECT_PETEGG();
...
#endif /* HORIZON_ZONE_CZ_SELECT_PETEGG_HPP */

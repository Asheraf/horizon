...
function ZC_ADD_ITEM_TO_STORE2.new(o)
	o = o or ZC_ADD_ITEM_TO_STORE2
	setmetatable(o, self)
	self.__index = self
	return o
end

function ZC_ADD_ITEM_TO_STORE2.serialize()

end

return ZC_ADD_ITEM_TO_STORE2

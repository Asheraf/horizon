...
#ifndef HORIZON_ZONE_ZC_ITEMCOMPOSITION_LIST_HPP
#define HORIZON_ZONE_ZC_ITEMCOMPOSITION_LIST_HPP
 ...
 *
 */ 
class ZC_ITEMCOMPOSITION_LIST : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_ITEMCOMPOSITION_LIST(std::shared_ptr<ZoneSocket> sock);
...
#endif /* HORIZON_ZONE_ZC_ITEMCOMPOSITION_LIST_HPP */

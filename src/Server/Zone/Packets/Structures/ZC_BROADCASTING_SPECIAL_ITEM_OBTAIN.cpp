...
#include "ZC_BROADCASTING_SPECIAL_ITEM_OBTAIN.hpp"
#include "Server/Zone/Socket/ZoneSocket.hpp"

using namespace Horizon::Zone::Packet;

ZC_BROADCASTING_SPECIAL_ITEM_OBTAIN::ZC_BROADCASTING_SPECIAL_ITEM_OBTAIN(std::shared_ptr<ZoneSocket> sock)
: NetworkPacket(ID_ZC_BROADCASTING_SPECIAL_ITEM_OBTAIN, sock) { }

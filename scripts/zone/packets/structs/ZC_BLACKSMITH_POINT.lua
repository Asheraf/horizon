...
elseif packet_version >= 20080102 then
	local pid = 0x021b
elseif packet_version >= 20041108 then
	local pid = 0x021b
elseif packet_version >= 0 then
	local pid = 0x021b
end

local ZC_BLACKSMITH_POINT = {
	_id = pid,
	_length = 0,
	_buffer = nil
}
...
function ZC_BLACKSMITH_POINT.new(o)
	o = o or ZC_BLACKSMITH_POINT
	setmetatable(o, self)
	self.__index = self
	return o
end

function ZC_BLACKSMITH_POINT.serialize()

end

return ZC_BLACKSMITH_POINT

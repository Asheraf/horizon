...
#ifndef HORIZON_ZONE_CZ_BROADCAST_HPP
#define HORIZON_ZONE_CZ_BROADCAST_HPP
...
/**
 * @brief Main object for the aegis packet: CZ_BROADCAST
 * Size : -1 @ 0
 *
 */ 
class CZ_BROADCAST : public Base::NetworkPacket<ZoneSocket>
{
public:
	CZ_BROADCAST(std::shared_ptr<ZoneSocket> sock);
	~CZ_BROADCAST();
...
#endif /* HORIZON_ZONE_CZ_BROADCAST_HPP */

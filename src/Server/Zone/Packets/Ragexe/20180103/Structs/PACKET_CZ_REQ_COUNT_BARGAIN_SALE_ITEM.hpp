...
struct PACKET_CZ_REQ_COUNT_BARGAIN_SALE_ITEM : public Horizon::Zone::Ragexe::PACKET_CZ_REQ_COUNT_BARGAIN_SALE_ITEM
{
	...
	{
		return Ragexe::PACKET_CZ_REQ_COUNT_BARGAIN_SALE_ITEM::serialize();
	}

	virtual void deserialize(PacketBuffer &buf) override
	{
		Ragexe::PACKET_CZ_REQ_COUNT_BARGAIN_SALE_ITEM::deserialize(buf);
	}

	virtual Ragexe::PACKET_CZ_REQ_COUNT_BARGAIN_SALE_ITEM & operator << (PacketBuffer &right) override
	{
		deserialize(right);
		return *this;
	}

...
#ifndef HORIZON_ZONE_ZC_ACK_EXCHANGE_ITEM2_HPP
#define HORIZON_ZONE_ZC_ACK_EXCHANGE_ITEM2_HPP
 ...
 *
 */ 
class ZC_ACK_EXCHANGE_ITEM2 : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_ACK_EXCHANGE_ITEM2(std::shared_ptr<ZoneSocket> sock);
...
#endif /* HORIZON_ZONE_ZC_ACK_EXCHANGE_ITEM2_HPP */

...
#ifndef HORIZON_ZONE_CZ_EXIT_ROOM_HPP
#define HORIZON_ZONE_CZ_EXIT_ROOM_HPP
...
/**
 * @brief Main object for the aegis packet: CZ_EXIT_ROOM
 * Size : 2 @ 0
 *
 */ 
class CZ_EXIT_ROOM : public Base::NetworkPacket<ZoneSocket>
{
public:
	CZ_EXIT_ROOM(std::shared_ptr<ZoneSocket> sock);
	~CZ_EXIT_ROOM();
...
#endif /* HORIZON_ZONE_CZ_EXIT_ROOM_HPP */

...
function CZ_CHANGE_EFFECTSTATE.new(o)
	o = o or CZ_CHANGE_EFFECTSTATE
	setmetatable(o, self)
	self.__index = self
	return o
end

function CZ_CHANGE_EFFECTSTATE.deserialize(buf)

end

return CZ_CHANGE_EFFECTSTATE

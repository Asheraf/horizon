...
function CZ_USE_SKILL_TOGROUND.new(o)
	o = o or CZ_USE_SKILL_TOGROUND
	setmetatable(o, self)
	self.__index = self
	return o
end

function CZ_USE_SKILL_TOGROUND.deserialize(buf)

end

return CZ_USE_SKILL_TOGROUND

...
function ZC_NOTIFY_MOVEENTRY4.new(o)
	o = o or ZC_NOTIFY_MOVEENTRY4
	setmetatable(o, self)
	self.__index = self
	return o
end

function ZC_NOTIFY_MOVEENTRY4.serialize()

end

return ZC_NOTIFY_MOVEENTRY4

...
#ifndef HORIZON_ZONE_ZC_ADD_ITEM_TO_CART_HPP
#define HORIZON_ZONE_ZC_ADD_ITEM_TO_CART_HPP
 ...
 *
 */ 
class ZC_ADD_ITEM_TO_CART : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_ADD_ITEM_TO_CART(std::shared_ptr<ZoneSocket> sock);
	~ZC_ADD_ITEM_TO_CART();
...
#endif /* HORIZON_ZONE_ZC_ADD_ITEM_TO_CART_HPP */

...
#ifndef HORIZON_ZONE_CZ_MOVE_ITEM_FROM_BODY_TO_CART_HPP
#define HORIZON_ZONE_CZ_MOVE_ITEM_FROM_BODY_TO_CART_HPP
...
enum {
	...
	ID_CZ_MOVE_ITEM_FROM_BODY_TO_CART = 0x0126
...
/**
 * @brief Main object for the aegis packet: CZ_MOVE_ITEM_FROM_BODY_TO_CART
 * Size : 8 @ 0
 *
 */ 
class CZ_MOVE_ITEM_FROM_BODY_TO_CART : public Base::NetworkPacket<ZoneSocket>
{
public:
	CZ_MOVE_ITEM_FROM_BODY_TO_CART(std::shared_ptr<ZoneSocket> sock);
...
#endif /* HORIZON_ZONE_CZ_MOVE_ITEM_FROM_BODY_TO_CART_HPP */

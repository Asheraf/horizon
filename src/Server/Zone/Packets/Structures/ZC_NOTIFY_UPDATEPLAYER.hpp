...
#ifndef HORIZON_ZONE_ZC_NOTIFY_UPDATEPLAYER_HPP
#define HORIZON_ZONE_ZC_NOTIFY_UPDATEPLAYER_HPP
 ...
 *
 */ 
class ZC_NOTIFY_UPDATEPLAYER : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_NOTIFY_UPDATEPLAYER(std::shared_ptr<ZoneSocket> sock);
...
#endif /* HORIZON_ZONE_ZC_NOTIFY_UPDATEPLAYER_HPP */

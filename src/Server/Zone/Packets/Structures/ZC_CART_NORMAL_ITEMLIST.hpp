...
#ifndef HORIZON_ZONE_ZC_CART_NORMAL_ITEMLIST_HPP
#define HORIZON_ZONE_ZC_CART_NORMAL_ITEMLIST_HPP
 ...
 *
 */ 
class ZC_CART_NORMAL_ITEMLIST : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_CART_NORMAL_ITEMLIST(std::shared_ptr<ZoneSocket> sock);
...
#endif /* HORIZON_ZONE_ZC_CART_NORMAL_ITEMLIST_HPP */

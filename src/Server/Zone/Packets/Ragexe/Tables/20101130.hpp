...
#ifndef HORIZON_ZONE_SHUFFLE_PACKET_LENGTH_TABLE_20101130
#define HORIZON_ZONE_SHUFFLE_PACKET_LENGTH_TABLE_20101130
...
#define ADD_PKT(i, j, k) _packet_length_table.insert(i, std::make_pair<uint16_t, NetworkPacket>(j, k))
		...
		ADD_PKT(0x0369, 90, CZ_REQNAME_BYGID2(sock));
...
#endif /* HORIZON_ZONE_SHUFFLE_PACKET_LENGTH_TABLE_20101130 */
...
if packet_version >= 20090311 then
	local pid = 0x0235
...
function ZC_HOSKILLINFO_LIST.new(o)
	o = o or ZC_HOSKILLINFO_LIST
	setmetatable(o, self)
	self.__index = self
	return o
end

function ZC_HOSKILLINFO_LIST.serialize()

end

return ZC_HOSKILLINFO_LIST

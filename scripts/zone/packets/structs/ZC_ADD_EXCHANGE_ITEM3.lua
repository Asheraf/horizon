...
function ZC_ADD_EXCHANGE_ITEM3.new(o)
	o = o or ZC_ADD_EXCHANGE_ITEM3
	setmetatable(o, self)
	self.__index = self
	return o
end

function ZC_ADD_EXCHANGE_ITEM3.serialize()

end

return ZC_ADD_EXCHANGE_ITEM3

...
#ifndef HORIZON_ZONE_ZC_STATUS_HPP
#define HORIZON_ZONE_ZC_STATUS_HPP
 ...
 *
 */ 
class ZC_STATUS : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_STATUS(std::shared_ptr<ZoneSocket> sock);
	~ZC_STATUS();
...
#endif /* HORIZON_ZONE_ZC_STATUS_HPP */

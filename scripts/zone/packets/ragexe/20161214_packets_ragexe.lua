...
d:add(0x0862, 26, require('CZ_ADD_FRIENDS'))
d:add(0x093d, 5, require('CZ_CHANGE_DIRECTION'))
d:add(0x0360, 5, require('CZ_COMMAND_MER'))
d:add(0x0369, 19, require('CZ_ENTER'))
d:add(0x0819, 4, require('CZ_GANGSI_RANK'))
d:add(0x085a, -1, require('CZ_ITEMLISTWIN_RES'))
d:add(0x092e, 6, require('CZ_ITEM_PICKUP'))
d:add(0x0887, 6, require('CZ_ITEM_THROW'))
d:add(0x0895, 8, require('CZ_JOIN_BATTLE_FIELD'))
d:add(0x0364, 8, require('CZ_MOVE_ITEM_FROM_BODY_TO_STORE'))
d:add(0x02c4, 8, require('CZ_MOVE_ITEM_FROM_STORE_TO_BODY'))
d:add(0x08a6, 18, require('CZ_PARTY_BOOKING_REQ_REGISTER'))
...
d:add(0x022d, 6, require('CZ_REQ_CLICK_TO_BUYING_STORE'))

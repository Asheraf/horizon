...
public:
	 ...
	 */
	const std::shared_ptr<SessionType> &getSession() const { return _session; }
...
private:
	std::shared_ptr<SessionType> _session;   ///< Shared pointer to the instantiated session object.

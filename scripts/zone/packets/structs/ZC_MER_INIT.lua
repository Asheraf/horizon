...
if packet_version >= 20071127 then
	local pid = 0x029b
elseif packet_version >= 20071106 then
	local pid = 0x029b
elseif packet_version >= 20070122 then
	local pid = 0x029b
elseif packet_version >= 20070102 then
	local pid = 0x029b
elseif packet_version >= 20061226 then
	local pid = 0x029b
...
function ZC_MER_INIT.serialize()

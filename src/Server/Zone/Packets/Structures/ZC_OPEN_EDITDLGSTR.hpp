...
#ifndef HORIZON_ZONE_ZC_OPEN_EDITDLGSTR_HPP
#define HORIZON_ZONE_ZC_OPEN_EDITDLGSTR_HPP
 ...
 *
 */ 
class ZC_OPEN_EDITDLGSTR : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_OPEN_EDITDLGSTR(std::shared_ptr<ZoneSocket> sock);
	~ZC_OPEN_EDITDLGSTR();
...
#endif /* HORIZON_ZONE_ZC_OPEN_EDITDLGSTR_HPP */

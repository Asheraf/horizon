...
#ifndef HORIZON_ZONE_CZ_REQ_ENTER_ROOM_HPP
#define HORIZON_ZONE_CZ_REQ_ENTER_ROOM_HPP
...
/**
 * @brief Main object for the aegis packet: CZ_REQ_ENTER_ROOM
 * Size : 14 @ 0
 *
 */ 
class CZ_REQ_ENTER_ROOM : public Base::NetworkPacket<ZoneSocket>
{
public:
	CZ_REQ_ENTER_ROOM(std::shared_ptr<ZoneSocket> sock);
	~CZ_REQ_ENTER_ROOM();
...
#endif /* HORIZON_ZONE_CZ_REQ_ENTER_ROOM_HPP */

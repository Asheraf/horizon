...
#ifndef HORIZON_CHAR_HC_ACK_CHANGE_CHARACTER_SLOT_HPP
#define HORIZON_CHAR_HC_ACK_CHANGE_CHARACTER_SLOT_HPP
...
#endif /* HORIZON_CHAR_HC_ACK_CHANGE_CHARACTER_SLOT_HPP */

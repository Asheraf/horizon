...
#ifndef HORIZON_ZONE_ZC_REQ_JOIN_GROUP_HPP
#define HORIZON_ZONE_ZC_REQ_JOIN_GROUP_HPP
 ...
 *
 */ 
class ZC_REQ_JOIN_GROUP : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_REQ_JOIN_GROUP(std::shared_ptr<ZoneSocket> sock);
	~ZC_REQ_JOIN_GROUP();
...
#endif /* HORIZON_ZONE_ZC_REQ_JOIN_GROUP_HPP */

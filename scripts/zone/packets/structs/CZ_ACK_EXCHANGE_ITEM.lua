...
function CZ_ACK_EXCHANGE_ITEM.new(o)
	o = o or CZ_ACK_EXCHANGE_ITEM
	setmetatable(o, self)
	self.__index = self
	return o
end

function CZ_ACK_EXCHANGE_ITEM.serialize()

end

return CZ_ACK_EXCHANGE_ITEM

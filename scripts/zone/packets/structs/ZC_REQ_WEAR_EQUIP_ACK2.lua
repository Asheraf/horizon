...
function ZC_REQ_WEAR_EQUIP_ACK2.new(o)
	o = o or ZC_REQ_WEAR_EQUIP_ACK2
	setmetatable(o, self)
	self.__index = self
	return o
end

function ZC_REQ_WEAR_EQUIP_ACK2.serialize()

end

return ZC_REQ_WEAR_EQUIP_ACK2

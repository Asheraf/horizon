...
#ifndef HORIZON_ZONE_ZC_ITEM_PICKUP_ACK_V7_HPP
#define HORIZON_ZONE_ZC_ITEM_PICKUP_ACK_V7_HPP
 ...
 *
 */ 
class ZC_ITEM_PICKUP_ACK_V7 : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_ITEM_PICKUP_ACK_V7(std::shared_ptr<ZoneSocket> sock);
...
#endif /* HORIZON_ZONE_ZC_ITEM_PICKUP_ACK_V7_HPP */

...
#ifndef HORIZON_ZONE_ZC_ACK_REQNAME_HPP
#define HORIZON_ZONE_ZC_ACK_REQNAME_HPP
 ...
 *
 */ 
class ZC_ACK_REQNAME : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_ACK_REQNAME(std::shared_ptr<ZoneSocket> sock);
	~ZC_ACK_REQNAME();
...
#endif /* HORIZON_ZONE_ZC_ACK_REQNAME_HPP */

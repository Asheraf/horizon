...
local CZ_CONCLUDE_EXCHANGE_ITEM = {
	_id = pid,
	_length = 0,
	_buffer = nil
}
...
function CZ_CONCLUDE_EXCHANGE_ITEM.new(o)
	o = o or CZ_CONCLUDE_EXCHANGE_ITEM
	setmetatable(o, self)
	self.__index = self
	return o
end

function CZ_CONCLUDE_EXCHANGE_ITEM.deserialize(buf)

end

return CZ_CONCLUDE_EXCHANGE_ITEM

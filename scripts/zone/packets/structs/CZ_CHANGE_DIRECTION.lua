...
function CZ_CHANGE_DIRECTION.new(o)
	o = o or CZ_CHANGE_DIRECTION
	setmetatable(o, self)
	self.__index = self
	return o
end

function CZ_CHANGE_DIRECTION.deserialize(buf)

end

return CZ_CHANGE_DIRECTION

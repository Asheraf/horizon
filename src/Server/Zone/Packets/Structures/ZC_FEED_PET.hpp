...
#ifndef HORIZON_ZONE_ZC_FEED_PET_HPP
#define HORIZON_ZONE_ZC_FEED_PET_HPP
 ...
 *
 */ 
class ZC_FEED_PET : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_FEED_PET(std::shared_ptr<ZoneSocket> sock);
	~ZC_FEED_PET();
...
#endif /* HORIZON_ZONE_ZC_FEED_PET_HPP */

...
#ifndef HORIZON_ZONE_CZ_CREATE_CHATROOM_HPP
#define HORIZON_ZONE_CZ_CREATE_CHATROOM_HPP
...
/**
 * @brief Main object for the aegis packet: CZ_CREATE_CHATROOM
 * Size : -1 @ 0
 *
 */ 
class CZ_CREATE_CHATROOM : public Base::NetworkPacket<ZoneSocket>
{
public:
	CZ_CREATE_CHATROOM(std::shared_ptr<ZoneSocket> sock);
	~CZ_CREATE_CHATROOM();
...
#endif /* HORIZON_ZONE_CZ_CREATE_CHATROOM_HPP */

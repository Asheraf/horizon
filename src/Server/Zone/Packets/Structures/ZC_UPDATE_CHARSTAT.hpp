...
#ifndef HORIZON_ZONE_ZC_UPDATE_CHARSTAT_HPP
#define HORIZON_ZONE_ZC_UPDATE_CHARSTAT_HPP
 ...
 *
 */ 
class ZC_UPDATE_CHARSTAT : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_UPDATE_CHARSTAT(std::shared_ptr<ZoneSocket> sock);
	~ZC_UPDATE_CHARSTAT();
...
#endif /* HORIZON_ZONE_ZC_UPDATE_CHARSTAT_HPP */

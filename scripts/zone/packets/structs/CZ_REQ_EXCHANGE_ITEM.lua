...
function CZ_REQ_EXCHANGE_ITEM.new(o)
	o = o or CZ_REQ_EXCHANGE_ITEM
	setmetatable(o, self)
	self.__index = self
	return o
end

function CZ_REQ_EXCHANGE_ITEM.deserialize(buf)

end

return CZ_REQ_EXCHANGE_ITEM

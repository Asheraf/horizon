...
#ifndef HORIZON_ZONE_ZC_PROPERTY_PET_HPP
#define HORIZON_ZONE_ZC_PROPERTY_PET_HPP
 ...
 *
 */ 
class ZC_PROPERTY_PET : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_PROPERTY_PET(std::shared_ptr<ZoneSocket> sock);
	~ZC_PROPERTY_PET();
...
#endif /* HORIZON_ZONE_ZC_PROPERTY_PET_HPP */

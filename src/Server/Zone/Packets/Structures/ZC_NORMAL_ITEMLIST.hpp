...
#ifndef HORIZON_ZONE_ZC_NORMAL_ITEMLIST_HPP
#define HORIZON_ZONE_ZC_NORMAL_ITEMLIST_HPP
 ...
 *
 */ 
class ZC_NORMAL_ITEMLIST : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_NORMAL_ITEMLIST(std::shared_ptr<ZoneSocket> sock);
	~ZC_NORMAL_ITEMLIST();
...
#endif /* HORIZON_ZONE_ZC_NORMAL_ITEMLIST_HPP */

...
#ifndef HORIZON_ZONE_ZC_HOSKILLINFO_UPDATE_HPP
#define HORIZON_ZONE_ZC_HOSKILLINFO_UPDATE_HPP
 ...
 *
 */ 
class ZC_HOSKILLINFO_UPDATE : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_HOSKILLINFO_UPDATE(std::shared_ptr<ZoneSocket> sock);
...
#endif /* HORIZON_ZONE_ZC_HOSKILLINFO_UPDATE_HPP */

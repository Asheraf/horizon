...
function ZC_SETTING_WHISPER_PC.new(o)
	o = o or ZC_SETTING_WHISPER_PC
	setmetatable(o, self)
	self.__index = self
	return o
end

function ZC_SETTING_WHISPER_PC.serialize()

end

return ZC_SETTING_WHISPER_PC

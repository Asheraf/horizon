...
local ZC_NOTIFY_POSITION_TO_GROUPM = {
	_id = pid,
	_length = 0,
	_buffer = nil
}
...
function ZC_NOTIFY_POSITION_TO_GROUPM.new(o)
	o = o or ZC_NOTIFY_POSITION_TO_GROUPM
	setmetatable(o, self)
	self.__index = self
	return o
end

function ZC_NOTIFY_POSITION_TO_GROUPM.serialize()

end

return ZC_NOTIFY_POSITION_TO_GROUPM

...
function CZ_SSILIST_ITEM_CLICK.new(o)
	o = o or CZ_SSILIST_ITEM_CLICK
	setmetatable(o, self)
	self.__index = self
	return o
end

function CZ_SSILIST_ITEM_CLICK.deserialize(buf)

end

return CZ_SSILIST_ITEM_CLICK

...
d:add(0x08a8, 26, require('CZ_ADD_FRIENDS'))
d:add(0x0896, 5, require('CZ_CHANGE_DIRECTION'))
d:add(0x0367, 5, require('CZ_COMMAND_MER'))
d:add(0x0860, 19, require('CZ_ENTER'))
d:add(0x0876, 4, require('CZ_GANGSI_RANK'))
d:add(0x0882, -1, require('CZ_ITEMLISTWIN_RES'))
d:add(0x0930, 6, require('CZ_ITEM_PICKUP'))
d:add(0x085f, 6, require('CZ_ITEM_THROW'))
d:add(0x0960, 8, require('CZ_JOIN_BATTLE_FIELD'))
d:add(0x092b, 8, require('CZ_MOVE_ITEM_FROM_BODY_TO_STORE'))
d:add(0x0935, 8, require('CZ_MOVE_ITEM_FROM_STORE_TO_BODY'))
d:add(0x089e, 18, require('CZ_PARTY_BOOKING_REQ_REGISTER'))
d:add(0x088c, 26, require('CZ_PARTY_JOIN_REQ'))

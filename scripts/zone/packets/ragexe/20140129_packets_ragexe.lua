...
d:add(0x092c, 36, require('CZ_ACK_STORE_PASSWORD'))
...
d:add(0x083c, 4, require('CZ_GANGSI_RANK'))
d:add(0x0924, -1, require('CZ_ITEMLISTWIN_RES'))
d:add(0x0885, 6, require('CZ_ITEM_PICKUP'))
d:add(0x0367, 6, require('CZ_ITEM_THROW'))
d:add(0x0361, 8, require('CZ_JOIN_BATTLE_FIELD'))
d:add(0x094d, 8, require('CZ_MOVE_ITEM_FROM_BODY_TO_STORE'))
d:add(0x0889, 8, require('CZ_MOVE_ITEM_FROM_STORE_TO_BODY'))
d:add(0x0921, 18, require('CZ_PARTY_BOOKING_REQ_REGISTER'))

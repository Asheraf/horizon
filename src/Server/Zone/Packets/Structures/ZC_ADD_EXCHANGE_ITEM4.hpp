...
#ifndef HORIZON_ZONE_ZC_ADD_EXCHANGE_ITEM4_HPP
#define HORIZON_ZONE_ZC_ADD_EXCHANGE_ITEM4_HPP
 ...
 *
 */ 
class ZC_ADD_EXCHANGE_ITEM4 : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_ADD_EXCHANGE_ITEM4(std::shared_ptr<ZoneSocket> sock);
...
#endif /* HORIZON_ZONE_ZC_ADD_EXCHANGE_ITEM4_HPP */

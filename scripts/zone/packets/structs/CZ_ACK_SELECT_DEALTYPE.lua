...
function CZ_ACK_SELECT_DEALTYPE.new(o)
	o = o or CZ_ACK_SELECT_DEALTYPE
	setmetatable(o, self)
	self.__index = self
	return o
end

function CZ_ACK_SELECT_DEALTYPE.serialize()

end

return CZ_ACK_SELECT_DEALTYPE

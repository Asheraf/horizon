...
function CZ_REQ_WHISPER_LIST.new(o)
	o = o or CZ_REQ_WHISPER_LIST
	setmetatable(o, self)
	self.__index = self
	return o
end

function CZ_REQ_WHISPER_LIST.deserialize(buf)

end

return CZ_REQ_WHISPER_LIST

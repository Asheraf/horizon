...
d:add(0x0438, 36, require('CZ_ACK_STORE_PASSWORD'))
d:add(0x091a, 26, require('CZ_ADD_FRIENDS'))
d:add(0x08ad, 5, require('CZ_CHANGE_DIRECTION'))
d:add(0x0899, 5, require('CZ_COMMAND_MER'))
d:add(0x093b, 19, require('CZ_ENTER'))
...
d:add(0x092b, 8, require('CZ_JOIN_BATTLE_FIELD'))
d:add(0x0878, 8, require('CZ_MOVE_ITEM_FROM_BODY_TO_STORE'))
d:add(0x08aa, 8, require('CZ_MOVE_ITEM_FROM_STORE_TO_BODY'))
d:add(0x0955, 18, require('CZ_PARTY_BOOKING_REQ_REGISTER'))
d:add(0x0896, 26, require('CZ_PARTY_JOIN_REQ'))

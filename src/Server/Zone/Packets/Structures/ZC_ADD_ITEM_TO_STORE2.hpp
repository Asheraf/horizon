...
#ifndef HORIZON_ZONE_ZC_ADD_ITEM_TO_STORE2_HPP
#define HORIZON_ZONE_ZC_ADD_ITEM_TO_STORE2_HPP
 ...
 *
 */ 
class ZC_ADD_ITEM_TO_STORE2 : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_ADD_ITEM_TO_STORE2(std::shared_ptr<ZoneSocket> sock);
...
#endif /* HORIZON_ZONE_ZC_ADD_ITEM_TO_STORE2_HPP */

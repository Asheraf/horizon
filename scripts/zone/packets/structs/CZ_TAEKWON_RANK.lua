...
elseif packet_version >= 20080102 then
	local pid = 0x0225
elseif packet_version >= 20050328 then
	local pid = 0x0225
elseif packet_version >= 0 then
	local pid = 0x0225
end

local CZ_TAEKWON_RANK = {
	_id = pid,
	_length = 0,
	_buffer = nil
}
...
function CZ_TAEKWON_RANK.new(o)
	o = o or CZ_TAEKWON_RANK
	setmetatable(o, self)
	self.__index = self
	return o
end

function CZ_TAEKWON_RANK.deserialize(buf)

end

return CZ_TAEKWON_RANK

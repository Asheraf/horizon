...
#ifndef HORIZON_ZONE_SHUFFLE_PACKET_LENGTH_TABLE_20120604
#define HORIZON_ZONE_SHUFFLE_PACKET_LENGTH_TABLE_20120604
...
#define ADD_PKT(i, j, k) _packet_length_table.insert(i, std::make_pair<uint16_t, NetworkPacket>(j, k))
		...
		ADD_PKT(0x07e4, 10, CZ_ITEMLISTWIN_RES(sock));
		...
		ADD_PKT(0x0811, 12, CZ_REQ_OPEN_BUYING_STORE(sock));
		...
		ADD_PKT(0x0438, 19, CZ_USE_SKILL2(sock));
...
#endif /* HORIZON_ZONE_SHUFFLE_PACKET_LENGTH_TABLE_20120604 */
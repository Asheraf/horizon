...
#ifndef HORIZON_ZONE_ZC_ALCHEMIST_RANK_HPP
#define HORIZON_ZONE_ZC_ALCHEMIST_RANK_HPP
 ...
 *
 */ 
class ZC_ALCHEMIST_RANK : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_ALCHEMIST_RANK(std::shared_ptr<ZoneSocket> sock);
	~ZC_ALCHEMIST_RANK();
...
#endif /* HORIZON_ZONE_ZC_ALCHEMIST_RANK_HPP */

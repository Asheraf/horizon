...
#ifndef HORIZON_ZONE_ZC_KILLER_RANK_HPP
#define HORIZON_ZONE_ZC_KILLER_RANK_HPP
 ...
 *
 */ 
class ZC_KILLER_RANK : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_KILLER_RANK(std::shared_ptr<ZoneSocket> sock);
	~ZC_KILLER_RANK();
...
#endif /* HORIZON_ZONE_ZC_KILLER_RANK_HPP */

...
d:add(0x07ec, 90, require('CZ_JOIN_BATTLE_FIELD'))
...
d:add(0x083c, 8, require('CZ_SSILIST_ITEM_CLICK'))
d:add(0x0438, 2, require('CZ_USE_SKILL2'))
d:add(0x0366, 2, require('CZ_USE_SKILL_TOGROUND2'))
d:add(0x090e, 2, require('ZC_ENTRY_QUEUE_INIT'))
d:add(0x090d, -1, require('ZC_PREMIUM_CAMPAIGN_INFO'))

...
d:add(0x0967, 19, require('CZ_ENTER'))
d:add(0x0802, 4, require('CZ_GANGSI_RANK'))
d:add(0x085d, -1, require('CZ_ITEMLISTWIN_RES'))
d:add(0x094a, 6, require('CZ_ITEM_PICKUP'))
d:add(0x0862, 6, require('CZ_ITEM_THROW'))
d:add(0x0958, 8, require('CZ_JOIN_BATTLE_FIELD'))
...
d:add(0x0815, 26, require('CZ_PARTY_JOIN_REQ'))
...
d:add(0x02c4, -1, require('CZ_REQ_OPEN_BUYING_STORE'))

...
#ifndef HORIZON_ZONE_CZ_GUILD_NOTICE_HPP
#define HORIZON_ZONE_CZ_GUILD_NOTICE_HPP
...
/**
 * @brief Main object for the aegis packet: CZ_GUILD_NOTICE
 * Size : 186 @ 0
 *
 */ 
class CZ_GUILD_NOTICE : public Base::NetworkPacket<ZoneSocket>
{
public:
	CZ_GUILD_NOTICE(std::shared_ptr<ZoneSocket> sock);
	~CZ_GUILD_NOTICE();
...
#endif /* HORIZON_ZONE_CZ_GUILD_NOTICE_HPP */

...
#ifndef HORIZON_ZONE_SHUFFLE_PACKET_LENGTH_TABLE_20110405
#define HORIZON_ZONE_SHUFFLE_PACKET_LENGTH_TABLE_20110405
...
#define ADD_PKT(i, j, k) _packet_length_table.insert(i, std::make_pair<uint16_t, NetworkPacket>(j, k))
		...
		ADD_PKT(0x0365, 26, CZ_MOVE_ITEM_FROM_STORE_TO_BODY2(sock));
		...
		ADD_PKT(0x0437, 36, CZ_REQUEST_ACT2(sock));
		...
		ADD_PKT(0x0838, -1, CZ_SEARCH_STORE_INFO_NEXT_PAGE(sock));
...
#endif /* HORIZON_ZONE_SHUFFLE_PACKET_LENGTH_TABLE_20110405 */
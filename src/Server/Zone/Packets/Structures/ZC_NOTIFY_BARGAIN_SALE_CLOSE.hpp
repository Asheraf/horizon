...
#ifndef HORIZON_ZONE_ZC_NOTIFY_BARGAIN_SALE_CLOSE_HPP
#define HORIZON_ZONE_ZC_NOTIFY_BARGAIN_SALE_CLOSE_HPP
 ...
 *
 */ 
class ZC_NOTIFY_BARGAIN_SALE_CLOSE : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_NOTIFY_BARGAIN_SALE_CLOSE(std::shared_ptr<ZoneSocket> sock);
...
#endif /* HORIZON_ZONE_ZC_NOTIFY_BARGAIN_SALE_CLOSE_HPP */

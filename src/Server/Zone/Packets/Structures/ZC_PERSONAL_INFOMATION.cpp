...
#include "ZC_PERSONAL_INFOMATION.hpp"
#include "Server/Zone/Socket/ZoneSocket.hpp"

using namespace Horizon::Zone::Packet;

ZC_PERSONAL_INFOMATION::ZC_PERSONAL_INFOMATION(std::shared_ptr<ZoneSocket> sock)
: NetworkPacket(ID_ZC_PERSONAL_INFOMATION, sock) { }

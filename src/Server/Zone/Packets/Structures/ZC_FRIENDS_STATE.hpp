...
#ifndef HORIZON_ZONE_ZC_FRIENDS_STATE_HPP
#define HORIZON_ZONE_ZC_FRIENDS_STATE_HPP
 ...
 *
 */ 
class ZC_FRIENDS_STATE : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_FRIENDS_STATE(std::shared_ptr<ZoneSocket> sock);
	~ZC_FRIENDS_STATE();
...
#endif /* HORIZON_ZONE_ZC_FRIENDS_STATE_HPP */

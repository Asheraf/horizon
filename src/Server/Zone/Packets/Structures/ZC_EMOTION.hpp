...
#ifndef HORIZON_ZONE_ZC_EMOTION_HPP
#define HORIZON_ZONE_ZC_EMOTION_HPP
 ...
 *
 */ 
class ZC_EMOTION : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_EMOTION(std::shared_ptr<ZoneSocket> sock);
	~ZC_EMOTION();
...
#endif /* HORIZON_ZONE_ZC_EMOTION_HPP */

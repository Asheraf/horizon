...
#ifndef HORIZON_ZONE_ZC_HOSKILLINFO_LIST_HPP
#define HORIZON_ZONE_ZC_HOSKILLINFO_LIST_HPP
 ...
 *
 */ 
class ZC_HOSKILLINFO_LIST : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_HOSKILLINFO_LIST(std::shared_ptr<ZoneSocket> sock);
	~ZC_HOSKILLINFO_LIST();
...
#endif /* HORIZON_ZONE_ZC_HOSKILLINFO_LIST_HPP */

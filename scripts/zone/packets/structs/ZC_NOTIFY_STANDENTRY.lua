...
function ZC_NOTIFY_STANDENTRY.new(o)
	o = o or ZC_NOTIFY_STANDENTRY
	setmetatable(o, self)
	self.__index = self
	return o
end

function ZC_NOTIFY_STANDENTRY.serialize()

end

return ZC_NOTIFY_STANDENTRY

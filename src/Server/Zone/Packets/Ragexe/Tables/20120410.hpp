...
#ifndef HORIZON_ZONE_SHUFFLE_PACKET_LENGTH_TABLE_20120410
#define HORIZON_ZONE_SHUFFLE_PACKET_LENGTH_TABLE_20120410
...
#define ADD_PKT(i, j, k) _packet_length_table.insert(i, std::make_pair<uint16_t, NetworkPacket>(j, k))
		...
		ADD_PKT(0x091c, 26, ZC_PARTY_RECRUIT_CANCEL_VOLUNTEER_TO_PM(sock));
#undef ADD_PKT
	}
...
#endif /* HORIZON_ZONE_SHUFFLE_PACKET_LENGTH_TABLE_20120410 */
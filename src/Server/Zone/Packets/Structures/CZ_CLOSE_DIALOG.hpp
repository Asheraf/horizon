...
#ifndef HORIZON_ZONE_CZ_CLOSE_CoreLog_HPP
#define HORIZON_ZONE_CZ_CLOSE_CoreLog_HPP
...
/**
 * @brief Main object for the aegis packet: CZ_CLOSE_CoreLog
 * Size : 6 @ 0
 *
 */ 
class CZ_CLOSE_CoreLog : public Base::NetworkPacket<ZoneSocket>
{
public:
	CZ_CLOSE_CoreLog(std::shared_ptr<ZoneSocket> sock);
	~CZ_CLOSE_CoreLog();
...
#endif /* HORIZON_ZONE_CZ_CLOSE_CoreLog_HPP */

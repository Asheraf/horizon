...
#ifndef HORIZON_ZONE_ZC_ITEM_PICKUP_ACK_HPP
#define HORIZON_ZONE_ZC_ITEM_PICKUP_ACK_HPP
 ...
 *
 */ 
class ZC_ITEM_PICKUP_ACK : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_ITEM_PICKUP_ACK(std::shared_ptr<ZoneSocket> sock);
	~ZC_ITEM_PICKUP_ACK();
...
#endif /* HORIZON_ZONE_ZC_ITEM_PICKUP_ACK_HPP */

...
function ZC_NOTIFY_STANDENTRY4.new(o)
	o = o or ZC_NOTIFY_STANDENTRY4
	setmetatable(o, self)
	self.__index = self
	return o
end

function ZC_NOTIFY_STANDENTRY4.serialize()

end

return ZC_NOTIFY_STANDENTRY4

...
#ifndef HORIZON_ZONE_CZ_CANCEL_LOCKON_HPP
#define HORIZON_ZONE_CZ_CANCEL_LOCKON_HPP
...
/**
 * @brief Main object for the aegis packet: CZ_CANCEL_LOCKON
 * Size : 2 @ 0
 *
 */ 
class CZ_CANCEL_LOCKON : public Base::NetworkPacket<ZoneSocket>
{
public:
	CZ_CANCEL_LOCKON(std::shared_ptr<ZoneSocket> sock);
	~CZ_CANCEL_LOCKON();
...
#endif /* HORIZON_ZONE_CZ_CANCEL_LOCKON_HPP */

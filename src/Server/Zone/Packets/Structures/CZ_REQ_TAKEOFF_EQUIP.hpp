...
#ifndef HORIZON_ZONE_CZ_REQ_TAKEOFF_EQUIP_HPP
#define HORIZON_ZONE_CZ_REQ_TAKEOFF_EQUIP_HPP
...
enum {
	...
	ID_CZ_REQ_TAKEOFF_EQUIP = 0x00ab
...
/**
 * @brief Main object for the aegis packet: CZ_REQ_TAKEOFF_EQUIP
 * Size : 4 @ 0
 *
 */ 
class CZ_REQ_TAKEOFF_EQUIP : public Base::NetworkPacket<ZoneSocket>
{
public:
	CZ_REQ_TAKEOFF_EQUIP(std::shared_ptr<ZoneSocket> sock);
...
#endif /* HORIZON_ZONE_CZ_REQ_TAKEOFF_EQUIP_HPP */

...
#ifndef HORIZON_ZONE_ZC_PC_CASH_POINT_ITEMLIST_HPP
#define HORIZON_ZONE_ZC_PC_CASH_POINT_ITEMLIST_HPP
 ...
 *
 */ 
class ZC_PC_CASH_POINT_ITEMLIST : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_PC_CASH_POINT_ITEMLIST(std::shared_ptr<ZoneSocket> sock);
...
#endif /* HORIZON_ZONE_ZC_PC_CASH_POINT_ITEMLIST_HPP */

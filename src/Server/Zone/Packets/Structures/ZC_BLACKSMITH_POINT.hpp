...
#ifndef HORIZON_ZONE_ZC_BLACKSMITH_POINT_HPP
#define HORIZON_ZONE_ZC_BLACKSMITH_POINT_HPP
 ...
 *
 */ 
class ZC_BLACKSMITH_POINT : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_BLACKSMITH_POINT(std::shared_ptr<ZoneSocket> sock);
	~ZC_BLACKSMITH_POINT();
...
#endif /* HORIZON_ZONE_ZC_BLACKSMITH_POINT_HPP */

...
#ifndef HORIZON_ZONE_CZ_CONTACTNPC_HPP
#define HORIZON_ZONE_CZ_CONTACTNPC_HPP
...
/**
 * @brief Main object for the aegis packet: CZ_CONTACTNPC
 * Size : 7 @ 0
 *
 */ 
class CZ_CONTACTNPC : public Base::NetworkPacket<ZoneSocket>
{
public:
	CZ_CONTACTNPC(std::shared_ptr<ZoneSocket> sock);
	~CZ_CONTACTNPC();
...
#endif /* HORIZON_ZONE_CZ_CONTACTNPC_HPP */

...
function ZC_ACK_REQMAKINGITEM.new(o)
	o = o or ZC_ACK_REQMAKINGITEM
	setmetatable(o, self)
	self.__index = self
	return o
end

function ZC_ACK_REQMAKINGITEM.serialize()

end

return ZC_ACK_REQMAKINGITEM

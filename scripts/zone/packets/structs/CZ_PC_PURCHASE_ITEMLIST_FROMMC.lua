...
local CZ_PC_PURCHASE_ITEMLIST_FROMMC = {
	_id = pid,
	_length = 0,
	_buffer = nil
}
...
function CZ_PC_PURCHASE_ITEMLIST_FROMMC.new(o)
	o = o or CZ_PC_PURCHASE_ITEMLIST_FROMMC
	setmetatable(o, self)
	self.__index = self
	return o
end

function CZ_PC_PURCHASE_ITEMLIST_FROMMC.deserialize(buf)

end

return CZ_PC_PURCHASE_ITEMLIST_FROMMC

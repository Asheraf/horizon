...
local ZC_ACK_CASH_BARGAIN_SALE_ITEM_INFO = {
	_id = pid,
	_length = 0,
	_buffer = nil
}
...
function ZC_ACK_CASH_BARGAIN_SALE_ITEM_INFO.new(o)
	o = o or ZC_ACK_CASH_BARGAIN_SALE_ITEM_INFO
	setmetatable(o, self)
	self.__index = self
	return o
end

function ZC_ACK_CASH_BARGAIN_SALE_ITEM_INFO.serialize()

end

return ZC_ACK_CASH_BARGAIN_SALE_ITEM_INFO

...
#ifndef HORIZON_ZONE_ZC_ADD_ITEM_TO_CART2_HPP
#define HORIZON_ZONE_ZC_ADD_ITEM_TO_CART2_HPP
 ...
 *
 */ 
class ZC_ADD_ITEM_TO_CART2 : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_ADD_ITEM_TO_CART2(std::shared_ptr<ZoneSocket> sock);
...
#endif /* HORIZON_ZONE_ZC_ADD_ITEM_TO_CART2_HPP */

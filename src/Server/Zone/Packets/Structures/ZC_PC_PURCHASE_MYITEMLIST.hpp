...
#ifndef HORIZON_ZONE_ZC_PC_PURCHASE_MYITEMLIST_HPP
#define HORIZON_ZONE_ZC_PC_PURCHASE_MYITEMLIST_HPP
 ...
 *
 */ 
class ZC_PC_PURCHASE_MYITEMLIST : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_PC_PURCHASE_MYITEMLIST(std::shared_ptr<ZoneSocket> sock);
...
#endif /* HORIZON_ZONE_ZC_PC_PURCHASE_MYITEMLIST_HPP */

...
#ifndef HORIZON_ZONE_ZC_WHISPER_HPP
#define HORIZON_ZONE_ZC_WHISPER_HPP
 ...
 *
 */ 
class ZC_WHISPER : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_WHISPER(std::shared_ptr<ZoneSocket> sock);
	~ZC_WHISPER();
...
#endif /* HORIZON_ZONE_ZC_WHISPER_HPP */

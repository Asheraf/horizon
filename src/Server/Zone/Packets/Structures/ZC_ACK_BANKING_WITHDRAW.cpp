...
#include "ZC_ACK_BANKING_WITHDRAW.hpp"
#include "Server/Zone/Socket/ZoneSocket.hpp"

using namespace Horizon::Zone::Packet;

ZC_ACK_BANKING_WITHDRAW::ZC_ACK_BANKING_WITHDRAW(std::shared_ptr<ZoneSocket> sock)
: NetworkPacket(ID_ZC_ACK_BANKING_WITHDRAW, sock) { }

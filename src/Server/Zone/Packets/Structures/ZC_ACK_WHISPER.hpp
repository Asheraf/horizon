...
#ifndef HORIZON_ZONE_ZC_ACK_WHISPER_HPP
#define HORIZON_ZONE_ZC_ACK_WHISPER_HPP
 ...
 *
 */ 
class ZC_ACK_WHISPER : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_ACK_WHISPER(std::shared_ptr<ZoneSocket> sock);
	~ZC_ACK_WHISPER();
...
#endif /* HORIZON_ZONE_ZC_ACK_WHISPER_HPP */

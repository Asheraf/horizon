...
#ifndef HORIZON_ZONE_ZC_NOTIFY_STANDENTRY3_HPP
#define HORIZON_ZONE_ZC_NOTIFY_STANDENTRY3_HPP
 ...
 *
 */ 
class ZC_NOTIFY_STANDENTRY3 : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_NOTIFY_STANDENTRY3(std::shared_ptr<ZoneSocket> sock);
...
#endif /* HORIZON_ZONE_ZC_NOTIFY_STANDENTRY3_HPP */

...
function CZ_START_USE_SKILL.new(o)
	o = o or CZ_START_USE_SKILL
	setmetatable(o, self)
	self.__index = self
	return o
end

function CZ_START_USE_SKILL.deserialize(buf)

end

return CZ_START_USE_SKILL

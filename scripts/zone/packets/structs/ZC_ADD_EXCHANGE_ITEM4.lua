...
function ZC_ADD_EXCHANGE_ITEM4.new(o)
	o = o or ZC_ADD_EXCHANGE_ITEM4
	setmetatable(o, self)
	self.__index = self
	return o
end

function ZC_ADD_EXCHANGE_ITEM4.serialize()

end

return ZC_ADD_EXCHANGE_ITEM4

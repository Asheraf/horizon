...
local ZC_DELETEITEM_FROM_MCSTORE = {
	_id = pid,
	_length = 0,
	_buffer = nil
}
...
function ZC_DELETEITEM_FROM_MCSTORE.new(o)
	o = o or ZC_DELETEITEM_FROM_MCSTORE
	setmetatable(o, self)
	self.__index = self
	return o
end

function ZC_DELETEITEM_FROM_MCSTORE.serialize()

end

return ZC_DELETEITEM_FROM_MCSTORE

...
#ifndef HORIZON_ZONE_RAGEXE_PACKET_ZC_CASH_TIME_COUNTER_HPP
#define HORIZON_ZONE_RAGEXE_PACKET_ZC_CASH_TIME_COUNTER_HPP
...
#endif /* HORIZON_ZONE_RAGEXE_PACKET_ZC_CASH_TIME_COUNTER_HPP */

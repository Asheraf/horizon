...
function ZC_MAIL_REQ_GET_LIST.new(o)
	o = o or ZC_MAIL_REQ_GET_LIST
	setmetatable(o, self)
	self.__index = self
	return o
end

function ZC_MAIL_REQ_GET_LIST.serialize()

end

return ZC_MAIL_REQ_GET_LIST

...
#ifndef HORIZON_ZONE_CZ_STATUS_CHANGE_HPP
#define HORIZON_ZONE_CZ_STATUS_CHANGE_HPP
...
/**
 * @brief Main object for the aegis packet: CZ_STATUS_CHANGE
 * Size : 5 @ 0
 *
 */ 
class CZ_STATUS_CHANGE : public Base::NetworkPacket<ZoneSocket>
{
public:
	CZ_STATUS_CHANGE(std::shared_ptr<ZoneSocket> sock);
	~CZ_STATUS_CHANGE();
...
#endif /* HORIZON_ZONE_CZ_STATUS_CHANGE_HPP */

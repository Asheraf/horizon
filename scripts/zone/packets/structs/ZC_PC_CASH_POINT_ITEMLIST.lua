...
local ZC_PC_CASH_POINT_ITEMLIST = {
	_id = pid,
	_length = 0,
	_buffer = nil
}
...
function ZC_PC_CASH_POINT_ITEMLIST.new(o)
	o = o or ZC_PC_CASH_POINT_ITEMLIST
	setmetatable(o, self)
	self.__index = self
	return o
end

function ZC_PC_CASH_POINT_ITEMLIST.serialize()

end

return ZC_PC_CASH_POINT_ITEMLIST

...
#ifndef HORIZON_ZONE_ZERO_PACKET_ZC_EQUIPWIN_OTHER_HPP
#define HORIZON_ZONE_ZERO_PACKET_ZC_EQUIPWIN_OTHER_HPP
...
#endif /* HORIZON_ZONE_ZERO_PACKET_ZC_EQUIPWIN_OTHER_HPP */

...
#ifndef HORIZON_ZONE_ZC_REQ_ALLY_GUILD_HPP
#define HORIZON_ZONE_ZC_REQ_ALLY_GUILD_HPP
 ...
 *
 */ 
class ZC_REQ_ALLY_GUILD : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_REQ_ALLY_GUILD(std::shared_ptr<ZoneSocket> sock);
	~ZC_REQ_ALLY_GUILD();
...
#endif /* HORIZON_ZONE_ZC_REQ_ALLY_GUILD_HPP */

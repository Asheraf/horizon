...
local ZC_ACK_REMEMBER_WARPPOINT = {
	_id = pid,
	_length = 0,
	_buffer = nil
}
...
function ZC_ACK_REMEMBER_WARPPOINT.new(o)
	o = o or ZC_ACK_REMEMBER_WARPPOINT
	setmetatable(o, self)
	self.__index = self
	return o
end

function ZC_ACK_REMEMBER_WARPPOINT.serialize()

end

return ZC_ACK_REMEMBER_WARPPOINT

...
#ifndef HORIZON_ZONE_ZC_ACK_REQ_JOIN_GUILD_HPP
#define HORIZON_ZONE_ZC_ACK_REQ_JOIN_GUILD_HPP
 ...
 *
 */ 
class ZC_ACK_REQ_JOIN_GUILD : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_ACK_REQ_JOIN_GUILD(std::shared_ptr<ZoneSocket> sock);
...
#endif /* HORIZON_ZONE_ZC_ACK_REQ_JOIN_GUILD_HPP */

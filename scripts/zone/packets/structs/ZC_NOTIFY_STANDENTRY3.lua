...
function ZC_NOTIFY_STANDENTRY3.new(o)
	o = o or ZC_NOTIFY_STANDENTRY3
	setmetatable(o, self)
	self.__index = self
	return o
end

function ZC_NOTIFY_STANDENTRY3.serialize()

end

return ZC_NOTIFY_STANDENTRY3

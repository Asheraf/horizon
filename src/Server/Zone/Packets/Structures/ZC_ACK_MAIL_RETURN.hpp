...
#ifndef HORIZON_ZONE_ZC_ACK_MAIL_RETURN_HPP
#define HORIZON_ZONE_ZC_ACK_MAIL_RETURN_HPP
 ...
 *
 */ 
class ZC_ACK_MAIL_RETURN : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_ACK_MAIL_RETURN(std::shared_ptr<ZoneSocket> sock);
	~ZC_ACK_MAIL_RETURN();
...
#endif /* HORIZON_ZONE_ZC_ACK_MAIL_RETURN_HPP */

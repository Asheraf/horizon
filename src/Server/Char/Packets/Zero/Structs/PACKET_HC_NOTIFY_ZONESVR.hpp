...
#ifndef HORIZON_CHAR_ZERO_PACKET_HC_NOTIFY_ZONESVR_HPP
#define HORIZON_CHAR_ZERO_PACKET_HC_NOTIFY_ZONESVR_HPP
...
#endif /* HORIZON_CHAR_ZERO_PACKET_HC_NOTIFY_ZONESVR_HPP */

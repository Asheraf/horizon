...
#ifndef HORIZON_ZONE_ZC_DISAPPEAR_ENTRY_HPP
#define HORIZON_ZONE_ZC_DISAPPEAR_ENTRY_HPP
 ...
 *
 */ 
class ZC_DISAPPEAR_ENTRY : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_DISAPPEAR_ENTRY(std::shared_ptr<ZoneSocket> sock);
	~ZC_DISAPPEAR_ENTRY();
...
#endif /* HORIZON_ZONE_ZC_DISAPPEAR_ENTRY_HPP */

...
d:add(0x023b, 19, require('CZ_ACK_STORE_PASSWORD'))
...
d:add(0x0365, 12, require('CZ_MOVE_ITEM_FROM_STORE_TO_BODY2'))
d:add(0x0369, 2, require('CZ_REQNAME_BYGID2'))
d:add(0x035f, -1, require('CZ_REQUEST_MOVE2'))
d:add(0x090a, 26, require('CZ_REQ_ENTRY_QUEUE_RANKING'))
d:add(0x0819, 18, require('CZ_REQ_TRADE_BUYING_STORE'))
d:add(0x0835, 10, require('CZ_SEARCH_STORE_INFO'))
d:add(0x0366, 2, require('CZ_USE_SKILL_TOGROUND2'))
d:add(0x0367, 2, require('CZ_USE_SKILL_TOGROUND_WITHTALKBOX2'))
d:add(0x090b, 30, require('ZC_PARTY_RECRUIT_ADD_FILTERLINGLIST'))
d:add(0x090c, 30, require('ZC_PARTY_RECRUIT_SUB_FILTERLINGLIST'))

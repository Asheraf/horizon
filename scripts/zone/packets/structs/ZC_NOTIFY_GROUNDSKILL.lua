...
function ZC_NOTIFY_GROUNDSKILL.new(o)
	o = o or ZC_NOTIFY_GROUNDSKILL
	setmetatable(o, self)
	self.__index = self
	return o
end

function ZC_NOTIFY_GROUNDSKILL.serialize()

end

return ZC_NOTIFY_GROUNDSKILL

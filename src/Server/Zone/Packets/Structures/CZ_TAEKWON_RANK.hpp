...
#ifndef HORIZON_ZONE_CZ_TAEKWON_RANK_HPP
#define HORIZON_ZONE_CZ_TAEKWON_RANK_HPP
...
/**
 * @brief Main object for the aegis packet: CZ_TAEKWON_RANK
 * Size : 2 @ 0
 *
 */ 
class CZ_TAEKWON_RANK : public Base::NetworkPacket<ZoneSocket>
{
public:
	CZ_TAEKWON_RANK(std::shared_ptr<ZoneSocket> sock);
	~CZ_TAEKWON_RANK();
...
#endif /* HORIZON_ZONE_CZ_TAEKWON_RANK_HPP */

...
#ifndef HORIZON_ZONE_CZ_SHIFT_HPP
#define HORIZON_ZONE_CZ_SHIFT_HPP
...
/**
 * @brief Main object for the aegis packet: CZ_SHIFT
 * Size : 26 @ 0
 *
 */ 
class CZ_SHIFT : public Base::NetworkPacket<ZoneSocket>
{
public:
	CZ_SHIFT(std::shared_ptr<ZoneSocket> sock);
	~CZ_SHIFT();
...
#endif /* HORIZON_ZONE_CZ_SHIFT_HPP */

...
#ifndef HORIZON_ZONE_ZC_ACCEPT_ENTER_HPP
#define HORIZON_ZONE_ZC_ACCEPT_ENTER_HPP
 ...
 *
 */ 
class ZC_ACCEPT_ENTER : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_ACCEPT_ENTER(std::shared_ptr<ZoneSocket> sock);
	~ZC_ACCEPT_ENTER();
...
#endif /* HORIZON_ZONE_ZC_ACCEPT_ENTER_HPP */

...
function CZ_REQ_LEAVE_GROUP.new(o)
	o = o or CZ_REQ_LEAVE_GROUP
	setmetatable(o, self)
	self.__index = self
	return o
end

function CZ_REQ_LEAVE_GROUP.deserialize(buf)

end

return CZ_REQ_LEAVE_GROUP

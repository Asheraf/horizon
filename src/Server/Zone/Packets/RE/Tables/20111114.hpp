...
#ifndef HORIZON_ZONE_SHUFFLE_PACKET_LENGTH_TABLE_20111114
#define HORIZON_ZONE_SHUFFLE_PACKET_LENGTH_TABLE_20111114
...
#define ADD_PKT(i, j, k) _packet_length_table.insert(i, std::make_pair<uint16_t, NetworkPacket>(j, k))
		...
		ADD_PKT(0x0363, 18, CZ_ITEM_THROW2(sock));
		ADD_PKT(0x07ec, 2, CZ_JOIN_BATTLE_FIELD(sock));
		ADD_PKT(0x0364, 36, CZ_MOVE_ITEM_FROM_BODY_TO_STORE2(sock));
...
#endif /* HORIZON_ZONE_SHUFFLE_PACKET_LENGTH_TABLE_20111114 */
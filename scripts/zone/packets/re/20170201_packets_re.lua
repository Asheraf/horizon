...
d:add(0x0886, 36, require('CZ_ACK_STORE_PASSWORD'))
d:add(0x0919, 26, require('CZ_ADD_FRIENDS'))
d:add(0x085e, 5, require('CZ_CHANGE_DIRECTION'))
d:add(0x0938, 5, require('CZ_COMMAND_MER'))
d:add(0x094c, 19, require('CZ_ENTER'))
...
d:add(0x08a4, 8, require('CZ_JOIN_BATTLE_FIELD'))

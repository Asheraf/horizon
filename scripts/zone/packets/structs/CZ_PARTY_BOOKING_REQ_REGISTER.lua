...
local CZ_PARTY_BOOKING_REQ_REGISTER = {
	_id = pid,
	_length = 0,
	_buffer = nil
}
...
function CZ_PARTY_BOOKING_REQ_REGISTER.new(o)
	o = o or CZ_PARTY_BOOKING_REQ_REGISTER
	setmetatable(o, self)
	self.__index = self
	return o
end

function CZ_PARTY_BOOKING_REQ_REGISTER.deserialize(buf)

end

return CZ_PARTY_BOOKING_REQ_REGISTER

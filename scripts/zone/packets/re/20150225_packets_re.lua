...
d:add(0x0955, 5, require('CZ_CHANGE_DIRECTION'))
d:add(0x094f, 5, require('CZ_COMMAND_MER'))
...
d:add(0x0948, 6, require('CZ_ITEM_THROW'))
...
d:add(0x0867, 18, require('CZ_PARTY_BOOKING_REQ_REGISTER'))
d:add(0x0360, 26, require('CZ_PARTY_JOIN_REQ'))
d:add(0x0436, 6, require('CZ_REQNAME'))
...
d:add(0x02c4, 6, require('CZ_REQ_CLICK_TO_BUYING_STORE'))
...
d:add(0x0940, -1, require('CZ_SEARCH_STORE_INFO'))

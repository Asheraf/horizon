...
#ifndef HORIZON_ZONE_ZC_IRMAIL_SEND_RES_HPP
#define HORIZON_ZONE_ZC_IRMAIL_SEND_RES_HPP
 ...
 *
 */ 
class ZC_IRMAIL_SEND_RES : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_IRMAIL_SEND_RES(std::shared_ptr<ZoneSocket> sock);
	~ZC_IRMAIL_SEND_RES();
...
#endif /* HORIZON_ZONE_ZC_IRMAIL_SEND_RES_HPP */

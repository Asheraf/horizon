...
function ZC_EQUIPMENT_ITEMLIST.new(o)
	o = o or ZC_EQUIPMENT_ITEMLIST
	setmetatable(o, self)
	self.__index = self
	return o
end

function ZC_EQUIPMENT_ITEMLIST.serialize()

end

return ZC_EQUIPMENT_ITEMLIST

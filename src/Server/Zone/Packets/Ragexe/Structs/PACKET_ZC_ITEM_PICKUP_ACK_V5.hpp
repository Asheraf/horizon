...
namespace Ragexe
{
struct PACKET_ZC_ITEM_PICKUP_ACK_V5 : public PACKET_ZC_ITEM_PICKUP_ACK3
{
	PACKET_ZC_ITEM_PICKUP_ACK_V5(uint16_t packet_id = ZC_ITEM_PICKUP_ACK_V5) : PACKET_ZC_ITEM_PICKUP_ACK3(packet_id) { }

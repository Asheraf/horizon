...
d:add(0x0921, 36, require('CZ_ACK_STORE_PASSWORD'))
d:add(0x094c, 26, require('CZ_ADD_FRIENDS'))
d:add(0x0817, 5, require('CZ_CHANGE_DIRECTION'))
...
d:add(0x0361, 2, require('CZ_REQ_CLOSE_BUYING_STORE'))

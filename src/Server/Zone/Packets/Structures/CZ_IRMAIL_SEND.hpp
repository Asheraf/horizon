...
#ifndef HORIZON_ZONE_CZ_IRMAIL_SEND_HPP
#define HORIZON_ZONE_CZ_IRMAIL_SEND_HPP
...
/**
 * @brief Main object for the aegis packet: CZ_IRMAIL_SEND
 * Size : -1 @ 20080701
 *
 */ 
class CZ_IRMAIL_SEND : public Base::NetworkPacket<ZoneSocket>
{
public:
	CZ_IRMAIL_SEND(std::shared_ptr<ZoneSocket> sock);
	~CZ_IRMAIL_SEND();
...
#endif /* HORIZON_ZONE_CZ_IRMAIL_SEND_HPP */

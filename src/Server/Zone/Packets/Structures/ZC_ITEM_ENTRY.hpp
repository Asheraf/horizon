...
#ifndef HORIZON_ZONE_ZC_ITEM_ENTRY_HPP
#define HORIZON_ZONE_ZC_ITEM_ENTRY_HPP
 ...
 *
 */ 
class ZC_ITEM_ENTRY : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_ITEM_ENTRY(std::shared_ptr<ZoneSocket> sock);
	~ZC_ITEM_ENTRY();
...
#endif /* HORIZON_ZONE_ZC_ITEM_ENTRY_HPP */

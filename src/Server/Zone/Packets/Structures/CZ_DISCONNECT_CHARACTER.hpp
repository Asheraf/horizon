...
#ifndef HORIZON_ZONE_CZ_DISCONNECT_CHARACTER_HPP
#define HORIZON_ZONE_CZ_DISCONNECT_CHARACTER_HPP
...
enum {
	...
	ID_CZ_DISCONNECT_CHARACTER = 0x00cc
...
/**
 * @brief Main object for the aegis packet: CZ_DISCONNECT_CHARACTER
 * Size : 6 @ 0
 *
 */ 
class CZ_DISCONNECT_CHARACTER : public Base::NetworkPacket<ZoneSocket>
{
public:
	CZ_DISCONNECT_CHARACTER(std::shared_ptr<ZoneSocket> sock);
...
#endif /* HORIZON_ZONE_CZ_DISCONNECT_CHARACTER_HPP */

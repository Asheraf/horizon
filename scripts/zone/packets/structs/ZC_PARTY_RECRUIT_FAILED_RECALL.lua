...
local ZC_PARTY_RECRUIT_FAILED_RECALL = {
	_id = pid,
	_length = 0,
	_buffer = nil
}
...
function ZC_PARTY_RECRUIT_FAILED_RECALL.new(o)
	o = o or ZC_PARTY_RECRUIT_FAILED_RECALL
	setmetatable(o, self)
	self.__index = self
	return o
end

function ZC_PARTY_RECRUIT_FAILED_RECALL.serialize()

end

return ZC_PARTY_RECRUIT_FAILED_RECALL

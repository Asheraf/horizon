...
function CZ_REQUEST_MOVENPC.new(o)
	o = o or CZ_REQUEST_MOVENPC
	setmetatable(o, self)
	self.__index = self
	return o
end

function CZ_REQUEST_MOVENPC.deserialize(buf)

end

return CZ_REQUEST_MOVENPC

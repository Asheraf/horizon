...
#ifndef HORIZON_CHAR_PACKETS_PACKETHANDLERFACTORY_HPP
#define HORIZON_CHAR_PACKETS_PACKETHANDLERFACTORY_HPP
...
public:
	 ...
	 */
	static std::shared_ptr<PacketHandler> create_packet_handler(std::shared_ptr<CharSocket> socket, client_types client_type, uint32_t packet_ver);
};
}
}
#endif /* HORIZON_CHAR_PACKETS_PACKETHANDLERFACTORY_HPP*/

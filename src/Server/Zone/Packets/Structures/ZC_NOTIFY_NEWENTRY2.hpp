...
#ifndef HORIZON_ZONE_ZC_NOTIFY_NEWENTRY2_HPP
#define HORIZON_ZONE_ZC_NOTIFY_NEWENTRY2_HPP
 ...
 *
 */ 
class ZC_NOTIFY_NEWENTRY2 : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_NOTIFY_NEWENTRY2(std::shared_ptr<ZoneSocket> sock);
	~ZC_NOTIFY_NEWENTRY2();
...
#endif /* HORIZON_ZONE_ZC_NOTIFY_NEWENTRY2_HPP */

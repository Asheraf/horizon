...
#ifndef HORIZON_ZONE_ZC_GROUP_LIST_HPP
#define HORIZON_ZONE_ZC_GROUP_LIST_HPP
 ...
 *
 */ 
class ZC_GROUP_LIST : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_GROUP_LIST(std::shared_ptr<ZoneSocket> sock);
	~ZC_GROUP_LIST();
...
#endif /* HORIZON_ZONE_ZC_GROUP_LIST_HPP */

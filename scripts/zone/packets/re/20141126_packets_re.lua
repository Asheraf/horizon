...
d:add(0x086e, 19, require('CZ_ENTER'))
...
d:add(0x0367, 8, require('CZ_JOIN_BATTLE_FIELD'))
d:add(0x095f, 8, require('CZ_MOVE_ITEM_FROM_BODY_TO_STORE'))
d:add(0x0871, 8, require('CZ_MOVE_ITEM_FROM_STORE_TO_BODY'))
d:add(0x0819, 18, require('CZ_PARTY_BOOKING_REQ_REGISTER'))
...
d:add(0x0802, -1, require('CZ_SEARCH_STORE_INFO'))

...
#ifndef HORIZON_ZONE_CZ_ACK_REQ_ADD_FRIENDS_HPP
#define HORIZON_ZONE_CZ_ACK_REQ_ADD_FRIENDS_HPP
...
enum {
	...
	ID_CZ_ACK_REQ_ADD_FRIENDS = 0x0208
...
/**
 * @brief Main object for the aegis packet: CZ_ACK_REQ_ADD_FRIENDS
 * Size : 14 @ 0
 *
 */ 
class CZ_ACK_REQ_ADD_FRIENDS : public Base::NetworkPacket<ZoneSocket>
{
public:
	CZ_ACK_REQ_ADD_FRIENDS(std::shared_ptr<ZoneSocket> sock);
...
#endif /* HORIZON_ZONE_CZ_ACK_REQ_ADD_FRIENDS_HPP */

...
#ifndef HORIZON_ZONE_CZ_CHOPOKGI_HPP
#define HORIZON_ZONE_CZ_CHOPOKGI_HPP
 ...
 *
 */ 
class CZ_CHOPOKGI : public Base::NetworkPacket<ZoneSocket>
{
public:
	CZ_CHOPOKGI(std::shared_ptr<ZoneSocket> sock);
	~CZ_CHOPOKGI();
...
#endif /* HORIZON_ZONE_CZ_CHOPOKGI_HPP */

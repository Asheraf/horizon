...
elseif packet_version >= 20100608 then
	local pid = 0x0838
elseif packet_version >= 20100601 then
	local pid = 0x0838
elseif packet_version >= 0 then
	local pid = 0x0838
end

local CZ_SEARCH_STORE_INFO_NEXT_PAGE = {
	_id = pid,
	_length = 0,
	_buffer = nil
}
...
function CZ_SEARCH_STORE_INFO_NEXT_PAGE.new(o)
	o = o or CZ_SEARCH_STORE_INFO_NEXT_PAGE
	setmetatable(o, self)
	self.__index = self
	return o
end

function CZ_SEARCH_STORE_INFO_NEXT_PAGE.deserialize(buf)

end

return CZ_SEARCH_STORE_INFO_NEXT_PAGE

...
function CZ_REFINE_ITEM_REQUEST.new(o)
	o = o or CZ_REFINE_ITEM_REQUEST
	setmetatable(o, self)
	self.__index = self
	return o
end

function CZ_REFINE_ITEM_REQUEST.deserialize(buf)

end

return CZ_REFINE_ITEM_REQUEST

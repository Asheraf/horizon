...
#ifndef HORIZON_ZONE_CZ_REQ_WEAR_EQUIP_HPP
#define HORIZON_ZONE_CZ_REQ_WEAR_EQUIP_HPP
...
/**
 * @brief Main object for the aegis packet: CZ_REQ_WEAR_EQUIP
 * Size : 6 @ 0
 *
 */ 
class CZ_REQ_WEAR_EQUIP : public Base::NetworkPacket<ZoneSocket>
{
public:
	CZ_REQ_WEAR_EQUIP(std::shared_ptr<ZoneSocket> sock);
	~CZ_REQ_WEAR_EQUIP();
...
#endif /* HORIZON_ZONE_CZ_REQ_WEAR_EQUIP_HPP */

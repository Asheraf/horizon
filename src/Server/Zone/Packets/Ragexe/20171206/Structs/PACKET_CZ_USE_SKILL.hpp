...
{
struct PACKET_CZ_USE_SKILL : public Horizon::Zone::Ragexe20171129::PACKET_CZ_USE_SKILL
{
	PACKET_CZ_USE_SKILL(uint16_t packet_id = CZ_USE_SKILL) : Horizon::Zone::Ragexe20171129::PACKET_CZ_USE_SKILL(packet_id) { }

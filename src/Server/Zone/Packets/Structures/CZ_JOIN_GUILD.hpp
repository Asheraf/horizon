...
#ifndef HORIZON_ZONE_CZ_JOIN_GUILD_HPP
#define HORIZON_ZONE_CZ_JOIN_GUILD_HPP
...
/**
 * @brief Main object for the aegis packet: CZ_JOIN_GUILD
 * Size : 10 @ 0
 *
 */ 
class CZ_JOIN_GUILD : public Base::NetworkPacket<ZoneSocket>
{
public:
	CZ_JOIN_GUILD(std::shared_ptr<ZoneSocket> sock);
	~CZ_JOIN_GUILD();
...
#endif /* HORIZON_ZONE_CZ_JOIN_GUILD_HPP */

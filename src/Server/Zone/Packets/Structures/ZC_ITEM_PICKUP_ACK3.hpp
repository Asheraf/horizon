...
#ifndef HORIZON_ZONE_ZC_ITEM_PICKUP_ACK3_HPP
#define HORIZON_ZONE_ZC_ITEM_PICKUP_ACK3_HPP
 ...
 *
 */ 
class ZC_ITEM_PICKUP_ACK3 : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_ITEM_PICKUP_ACK3(std::shared_ptr<ZoneSocket> sock);
	~ZC_ITEM_PICKUP_ACK3();
...
#endif /* HORIZON_ZONE_ZC_ITEM_PICKUP_ACK3_HPP */

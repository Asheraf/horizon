...
#ifndef HORIZON_ZONE_ZC_MAKINGARROW_LIST_HPP
#define HORIZON_ZONE_ZC_MAKINGARROW_LIST_HPP
 ...
 *
 */ 
class ZC_MAKINGARROW_LIST : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_MAKINGARROW_LIST(std::shared_ptr<ZoneSocket> sock);
	~ZC_MAKINGARROW_LIST();
...
#endif /* HORIZON_ZONE_ZC_MAKINGARROW_LIST_HPP */

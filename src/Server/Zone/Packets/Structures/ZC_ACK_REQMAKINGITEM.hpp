...
#ifndef HORIZON_ZONE_ZC_ACK_REQMAKINGITEM_HPP
#define HORIZON_ZONE_ZC_ACK_REQMAKINGITEM_HPP
 ...
 *
 */ 
class ZC_ACK_REQMAKINGITEM : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_ACK_REQMAKINGITEM(std::shared_ptr<ZoneSocket> sock);
...
#endif /* HORIZON_ZONE_ZC_ACK_REQMAKINGITEM_HPP */

...
#ifndef HORIZON_ZONE_SHUFFLE_PACKET_LENGTH_TABLE_20120221
#define HORIZON_ZONE_SHUFFLE_PACKET_LENGTH_TABLE_20120221
...
#define ADD_PKT(i, j, k) _packet_length_table.insert(i, std::make_pair<uint16_t, NetworkPacket>(j, k))
		...
		ADD_PKT(0x096e, 6, CZ_REQ_MERGE_ITEM(sock));
		...
		ADD_PKT(0x0977, 15, ZC_HP_INFO(sock));
...
#endif /* HORIZON_ZONE_SHUFFLE_PACKET_LENGTH_TABLE_20120221 */
...
#ifndef HORIZON_ZONE_ZC_PETEGG_LIST_HPP
#define HORIZON_ZONE_ZC_PETEGG_LIST_HPP
 ...
 *
 */ 
class ZC_PETEGG_LIST : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_PETEGG_LIST(std::shared_ptr<ZoneSocket> sock);
	~ZC_PETEGG_LIST();
...
#endif /* HORIZON_ZONE_ZC_PETEGG_LIST_HPP */

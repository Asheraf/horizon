...
d:add(0x086b, 5, require('CZ_CHANGE_DIRECTION'))
d:add(0x0886, 5, require('CZ_COMMAND_MER'))
...
d:add(0x0869, 8, require('CZ_MOVE_ITEM_FROM_STORE_TO_BODY'))
...
d:add(0x0362, 6, require('CZ_REQ_CLICK_TO_BUYING_STORE'))

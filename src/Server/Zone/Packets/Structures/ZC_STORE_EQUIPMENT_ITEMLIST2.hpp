...
#ifndef HORIZON_ZONE_ZC_STORE_EQUIPMENT_ITEMLIST2_HPP
#define HORIZON_ZONE_ZC_STORE_EQUIPMENT_ITEMLIST2_HPP
 ...
 *
 */ 
class ZC_STORE_EQUIPMENT_ITEMLIST2 : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_STORE_EQUIPMENT_ITEMLIST2(std::shared_ptr<ZoneSocket> sock);
...
#endif /* HORIZON_ZONE_ZC_STORE_EQUIPMENT_ITEMLIST2_HPP */

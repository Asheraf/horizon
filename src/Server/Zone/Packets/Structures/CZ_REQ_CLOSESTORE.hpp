...
#ifndef HORIZON_ZONE_CZ_REQ_CLOSESTORE_HPP
#define HORIZON_ZONE_CZ_REQ_CLOSESTORE_HPP
...
/**
 * @brief Main object for the aegis packet: CZ_REQ_CLOSESTORE
 * Size : 2 @ 0
 *
 */ 
class CZ_REQ_CLOSESTORE : public Base::NetworkPacket<ZoneSocket>
{
public:
	CZ_REQ_CLOSESTORE(std::shared_ptr<ZoneSocket> sock);
	~CZ_REQ_CLOSESTORE();
...
#endif /* HORIZON_ZONE_CZ_REQ_CLOSESTORE_HPP */

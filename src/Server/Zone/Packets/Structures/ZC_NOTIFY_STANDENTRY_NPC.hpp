...
#ifndef HORIZON_ZONE_ZC_NOTIFY_STANDENTRY_NPC_HPP
#define HORIZON_ZONE_ZC_NOTIFY_STANDENTRY_NPC_HPP
 ...
 *
 */ 
class ZC_NOTIFY_STANDENTRY_NPC : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_NOTIFY_STANDENTRY_NPC(std::shared_ptr<ZoneSocket> sock);
...
#endif /* HORIZON_ZONE_ZC_NOTIFY_STANDENTRY_NPC_HPP */

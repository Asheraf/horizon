...
#ifndef HORIZON_ZONE_CZ_WHISPER_HPP
#define HORIZON_ZONE_CZ_WHISPER_HPP
...
/**
 * @brief Main object for the aegis packet: CZ_WHISPER
 * Size : -1 @ 0
 *
 */ 
class CZ_WHISPER : public Base::NetworkPacket<ZoneSocket>
{
public:
	CZ_WHISPER(std::shared_ptr<ZoneSocket> sock);
	~CZ_WHISPER();
...
#endif /* HORIZON_ZONE_CZ_WHISPER_HPP */

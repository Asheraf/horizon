...
function CZ_REQ_ITEMCOMPOSITION.new(o)
	o = o or CZ_REQ_ITEMCOMPOSITION
	setmetatable(o, self)
	self.__index = self
	return o
end

function CZ_REQ_ITEMCOMPOSITION.deserialize(buf)

end

return CZ_REQ_ITEMCOMPOSITION

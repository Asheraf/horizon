...
d:add(0x0896, 36, require('CZ_ACK_STORE_PASSWORD'))
d:add(0x091b, 26, require('CZ_ADD_FRIENDS'))
d:add(0x0887, 5, require('CZ_CHANGE_DIRECTION'))
d:add(0x0924, 5, require('CZ_COMMAND_MER'))
d:add(0x086f, 19, require('CZ_ENTER'))
d:add(0x0892, 4, require('CZ_GANGSI_RANK'))
...
d:add(0x0937, 8, require('CZ_MOVE_ITEM_FROM_BODY_TO_STORE'))

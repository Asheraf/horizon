...
#ifndef HORIZON_ZONE_ZC_ITEMIDENTIFY_LIST_HPP
#define HORIZON_ZONE_ZC_ITEMIDENTIFY_LIST_HPP
 ...
 *
 */ 
class ZC_ITEMIDENTIFY_LIST : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_ITEMIDENTIFY_LIST(std::shared_ptr<ZoneSocket> sock);
...
#endif /* HORIZON_ZONE_ZC_ITEMIDENTIFY_LIST_HPP */

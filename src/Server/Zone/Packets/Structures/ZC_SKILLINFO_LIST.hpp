...
#ifndef HORIZON_ZONE_ZC_SKILLINFO_LIST_HPP
#define HORIZON_ZONE_ZC_SKILLINFO_LIST_HPP
 ...
 *
 */ 
class ZC_SKILLINFO_LIST : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_SKILLINFO_LIST(std::shared_ptr<ZoneSocket> sock);
	~ZC_SKILLINFO_LIST();
...
#endif /* HORIZON_ZONE_ZC_SKILLINFO_LIST_HPP */

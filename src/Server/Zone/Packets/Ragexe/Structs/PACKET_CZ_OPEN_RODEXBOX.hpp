...
#ifndef HORIZON_ZONE_RAGEXE_PACKET_CZ_OPEN_RODEXBOX_HPP
#define HORIZON_ZONE_RAGEXE_PACKET_CZ_OPEN_RODEXBOX_HPP
...
#endif /* HORIZON_ZONE_RAGEXE_PACKET_CZ_OPEN_RODEXBOX_HPP */

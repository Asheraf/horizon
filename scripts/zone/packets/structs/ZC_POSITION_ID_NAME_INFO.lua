...
local ZC_POSITION_ID_NAME_INFO = {
	_id = pid,
	_length = 0,
	_buffer = nil
}
...
function ZC_POSITION_ID_NAME_INFO.new(o)
	o = o or ZC_POSITION_ID_NAME_INFO
	setmetatable(o, self)
	self.__index = self
	return o
end

function ZC_POSITION_ID_NAME_INFO.serialize()

end

return ZC_POSITION_ID_NAME_INFO

...
function CZ_CHANGE_CHATROOM.new(o)
	o = o or CZ_CHANGE_CHATROOM
	setmetatable(o, self)
	self.__index = self
	return o
end

function CZ_CHANGE_CHATROOM.deserialize(buf)

end

return CZ_CHANGE_CHATROOM

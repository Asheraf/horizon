...
function ZC_NOTIFY_HP_TO_GROUPM.new(o)
	o = o or ZC_NOTIFY_HP_TO_GROUPM
	setmetatable(o, self)
	self.__index = self
	return o
end

function ZC_NOTIFY_HP_TO_GROUPM.serialize()

end

return ZC_NOTIFY_HP_TO_GROUPM

...
#ifndef HORIZON_ZONE_CZ_MOVE_ITEM_FROM_CART_TO_BODY_HPP
#define HORIZON_ZONE_CZ_MOVE_ITEM_FROM_CART_TO_BODY_HPP
...
enum {
	...
	ID_CZ_MOVE_ITEM_FROM_CART_TO_BODY = 0x0127
...
/**
 * @brief Main object for the aegis packet: CZ_MOVE_ITEM_FROM_CART_TO_BODY
 * Size : 8 @ 0
 *
 */ 
class CZ_MOVE_ITEM_FROM_CART_TO_BODY : public Base::NetworkPacket<ZoneSocket>
{
public:
	CZ_MOVE_ITEM_FROM_CART_TO_BODY(std::shared_ptr<ZoneSocket> sock);
...
#endif /* HORIZON_ZONE_CZ_MOVE_ITEM_FROM_CART_TO_BODY_HPP */

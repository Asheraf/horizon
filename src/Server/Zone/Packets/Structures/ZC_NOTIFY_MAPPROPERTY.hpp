...
#ifndef HORIZON_ZONE_ZC_NOTIFY_MAPPROPERTY_HPP
#define HORIZON_ZONE_ZC_NOTIFY_MAPPROPERTY_HPP
 ...
 *
 */ 
class ZC_NOTIFY_MAPPROPERTY : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_NOTIFY_MAPPROPERTY(std::shared_ptr<ZoneSocket> sock);
...
#endif /* HORIZON_ZONE_ZC_NOTIFY_MAPPROPERTY_HPP */

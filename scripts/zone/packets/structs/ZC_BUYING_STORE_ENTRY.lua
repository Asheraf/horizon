...
function ZC_BUYING_STORE_ENTRY.new(o)
	o = o or ZC_BUYING_STORE_ENTRY
	setmetatable(o, self)
	self.__index = self
	return o
end

function ZC_BUYING_STORE_ENTRY.serialize()

end

return ZC_BUYING_STORE_ENTRY

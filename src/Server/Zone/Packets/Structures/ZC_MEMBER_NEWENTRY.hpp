...
#ifndef HORIZON_ZONE_ZC_MEMBER_NEWENTRY_HPP
#define HORIZON_ZONE_ZC_MEMBER_NEWENTRY_HPP
 ...
 *
 */ 
class ZC_MEMBER_NEWENTRY : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_MEMBER_NEWENTRY(std::shared_ptr<ZoneSocket> sock);
	~ZC_MEMBER_NEWENTRY();
...
#endif /* HORIZON_ZONE_ZC_MEMBER_NEWENTRY_HPP */

...
#ifndef HORIZON_ZONE_ZC_STATUS_CHANGE_ACK_HPP
#define HORIZON_ZONE_ZC_STATUS_CHANGE_ACK_HPP
 ...
 *
 */ 
class ZC_STATUS_CHANGE_ACK : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_STATUS_CHANGE_ACK(std::shared_ptr<ZoneSocket> sock);
...
#endif /* HORIZON_ZONE_ZC_STATUS_CHANGE_ACK_HPP */

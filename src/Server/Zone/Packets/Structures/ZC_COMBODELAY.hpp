...
#ifndef HORIZON_ZONE_ZC_COMBODELAY_HPP
#define HORIZON_ZONE_ZC_COMBODELAY_HPP
 ...
 *
 */ 
class ZC_COMBODELAY : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_COMBODELAY(std::shared_ptr<ZoneSocket> sock);
	~ZC_COMBODELAY();
...
#endif /* HORIZON_ZONE_ZC_COMBODELAY_HPP */

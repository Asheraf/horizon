...
#ifndef HORIZON_ZONE_CZ_REQNAME2_HPP
#define HORIZON_ZONE_CZ_REQNAME2_HPP
...
/**
 * @brief Main object for the aegis packet: CZ_REQNAME2
 * Size : -1 @ 20080528
 *
 */ 
class CZ_REQNAME2 : public Base::NetworkPacket<ZoneSocket>
{
public:
	CZ_REQNAME2(std::shared_ptr<ZoneSocket> sock);
	~CZ_REQNAME2();
...
#endif /* HORIZON_ZONE_CZ_REQNAME2_HPP */

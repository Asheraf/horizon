...
#ifndef HORIZON_ZONE_ZC_RESTART_ACK_HPP
#define HORIZON_ZONE_ZC_RESTART_ACK_HPP
 ...
 *
 */ 
class ZC_RESTART_ACK : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_RESTART_ACK(std::shared_ptr<ZoneSocket> sock);
	~ZC_RESTART_ACK();
...
#endif /* HORIZON_ZONE_ZC_RESTART_ACK_HPP */

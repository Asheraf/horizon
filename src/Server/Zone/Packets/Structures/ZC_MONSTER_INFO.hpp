...
#ifndef HORIZON_ZONE_ZC_MONSTER_INFO_HPP
#define HORIZON_ZONE_ZC_MONSTER_INFO_HPP
 ...
 *
 */ 
class ZC_MONSTER_INFO : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_MONSTER_INFO(std::shared_ptr<ZoneSocket> sock);
	~ZC_MONSTER_INFO();
...
#endif /* HORIZON_ZONE_ZC_MONSTER_INFO_HPP */

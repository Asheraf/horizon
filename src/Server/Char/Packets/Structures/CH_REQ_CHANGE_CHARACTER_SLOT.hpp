...
#ifndef HORIZON_CHAR_CH_REQ_CHANGE_CHARACTER_SLOT_HPP
#define HORIZON_CHAR_CH_REQ_CHANGE_CHARACTER_SLOT_HPP
...
#endif /* HORIZON_CHAR_CH_REQ_CHANGE_CHARACTER_SLOT_HPP */

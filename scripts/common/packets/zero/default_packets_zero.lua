...
local default_packets = {
	...
	[0x09c5] = { ['length'] = 1042, ['module'] = require('CS_LOGIN_QUERY') },
	...
	[0x09c6] = { ['length'] = -1, ['module'] = require('SC_LOGIN_ANSWER') },
	[0x09e0] = { ['length'] = -1, ['module'] = require('SC_LOGIN_ANSWER_WITH_ID') },
	[0x09c7] = { ['length'] = 18, ['module'] = require('SC_LOGIN_ERROR') },
	[0x0081] = { ['length'] = 3, ['module'] = require('SC_NOTIFY_BAN') },
	[0x09c9] = { ['length'] = -1, ['module'] = require('SC_SOCT') },
}

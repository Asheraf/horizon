...
#ifndef HORIZON_ZONE_ZERO_20171123_PACKETS_HPP
#define HORIZON_ZONE_ZERO_20171123_PACKETS_HPP
...
enum packets
{
	...
	CZ_ENTER = 0x0860,
	CZ_GANGSI_RANK = 0x0876,
	CZ_ITEMLISTWIN_RES = 0x0882,
	CZ_ITEM_PICKUP = 0x0930,
	CZ_ITEM_PICKUP2 = 0x0362,
	CZ_ITEM_THROW = 0x085f,
	CZ_ITEM_THROW2 = 0x0363,
	CZ_JOIN_BATTLE_FIELD = 0x0960,
	CZ_MOVE_ITEM_FROM_BODY_TO_STORE = 0x092b,
	CZ_MOVE_ITEM_FROM_STORE_TO_BODY = 0x0935,
	CZ_PARTY_BOOKING_REQ_REGISTER = 0x089e,
	CZ_PARTY_JOIN_REQ = 0x088c,
	CZ_REQNAME = 0x096a,
...
#endif /* HORIZON_ZONE_ZERO_20171123_PACKETS_HPP */

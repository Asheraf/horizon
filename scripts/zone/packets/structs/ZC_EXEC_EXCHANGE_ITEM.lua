...
function ZC_EXEC_EXCHANGE_ITEM.new(o)
	o = o or ZC_EXEC_EXCHANGE_ITEM
	setmetatable(o, self)
	self.__index = self
	return o
end

function ZC_EXEC_EXCHANGE_ITEM.serialize()

end

return ZC_EXEC_EXCHANGE_ITEM

...
#ifndef HORIZON_ZONE_CZ_REQ_LEAVE_GROUP_HPP
#define HORIZON_ZONE_CZ_REQ_LEAVE_GROUP_HPP
...
/**
 * @brief Main object for the aegis packet: CZ_REQ_LEAVE_GROUP
 * Size : 2 @ 0
 *
 */ 
class CZ_REQ_LEAVE_GROUP : public Base::NetworkPacket<ZoneSocket>
{
public:
	CZ_REQ_LEAVE_GROUP(std::shared_ptr<ZoneSocket> sock);
	~CZ_REQ_LEAVE_GROUP();
...
#endif /* HORIZON_ZONE_CZ_REQ_LEAVE_GROUP_HPP */

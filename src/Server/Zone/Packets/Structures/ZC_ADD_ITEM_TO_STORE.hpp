...
#ifndef HORIZON_ZONE_ZC_ADD_ITEM_TO_STORE_HPP
#define HORIZON_ZONE_ZC_ADD_ITEM_TO_STORE_HPP
 ...
 *
 */ 
class ZC_ADD_ITEM_TO_STORE : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_ADD_ITEM_TO_STORE(std::shared_ptr<ZoneSocket> sock);
...
#endif /* HORIZON_ZONE_ZC_ADD_ITEM_TO_STORE_HPP */

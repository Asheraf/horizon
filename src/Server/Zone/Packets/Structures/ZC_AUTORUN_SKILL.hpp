...
#ifndef HORIZON_ZONE_ZC_AUTORUN_SKILL_HPP
#define HORIZON_ZONE_ZC_AUTORUN_SKILL_HPP
 ...
 *
 */ 
class ZC_AUTORUN_SKILL : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_AUTORUN_SKILL(std::shared_ptr<ZoneSocket> sock);
	~ZC_AUTORUN_SKILL();
...
#endif /* HORIZON_ZONE_ZC_AUTORUN_SKILL_HPP */

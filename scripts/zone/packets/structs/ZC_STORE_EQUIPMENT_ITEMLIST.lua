...
local ZC_STORE_EQUIPMENT_ITEMLIST = {
	_id = pid,
	_length = 0,
	_buffer = nil
}
...
function ZC_STORE_EQUIPMENT_ITEMLIST.new(o)
	o = o or ZC_STORE_EQUIPMENT_ITEMLIST
	setmetatable(o, self)
	self.__index = self
	return o
end

function ZC_STORE_EQUIPMENT_ITEMLIST.serialize()

end

return ZC_STORE_EQUIPMENT_ITEMLIST

...
local ZC_PARTY_RECRUIT_VOLUNTEER_INFO = {
	_id = pid,
	_length = 0,
	_buffer = nil
}
...
function ZC_PARTY_RECRUIT_VOLUNTEER_INFO.new(o)
	o = o or ZC_PARTY_RECRUIT_VOLUNTEER_INFO
	setmetatable(o, self)
	self.__index = self
	return o
end

function ZC_PARTY_RECRUIT_VOLUNTEER_INFO.serialize()

end

return ZC_PARTY_RECRUIT_VOLUNTEER_INFO

...
function ZC_ACK_ADD_ITEM_RODEX.new(o)
	o = o or ZC_ACK_ADD_ITEM_RODEX
	setmetatable(o, self)
	self.__index = self
	return o
end

function ZC_ACK_ADD_ITEM_RODEX.serialize()

end

return ZC_ACK_ADD_ITEM_RODEX

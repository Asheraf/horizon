...
d:add(0x0928, -1, require('CZ_ITEMLISTWIN_RES'))
...
d:add(0x093b, 8, require('CZ_MOVE_ITEM_FROM_STORE_TO_BODY'))
d:add(0x092d, 18, require('CZ_PARTY_BOOKING_REQ_REGISTER'))
d:add(0x0943, 26, require('CZ_PARTY_JOIN_REQ'))
...
d:add(0x0363, 10, require('CZ_USE_SKILL_TOGROUND'))

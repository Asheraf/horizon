...
#ifndef HORIZON_ZONE_CZ_CANCEL_EXCHANGE_ITEM_HPP
#define HORIZON_ZONE_CZ_CANCEL_EXCHANGE_ITEM_HPP
...
enum {
	...
	ID_CZ_CANCEL_EXCHANGE_ITEM = 0x00ed
...
/**
 * @brief Main object for the aegis packet: CZ_CANCEL_EXCHANGE_ITEM
 * Size : 2 @ 0
 *
 */ 
class CZ_CANCEL_EXCHANGE_ITEM : public Base::NetworkPacket<ZoneSocket>
{
public:
	CZ_CANCEL_EXCHANGE_ITEM(std::shared_ptr<ZoneSocket> sock);
...
#endif /* HORIZON_ZONE_CZ_CANCEL_EXCHANGE_ITEM_HPP */

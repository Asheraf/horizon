...
#ifndef HORIZON_ZONE_ZC_STOPMOVE_HPP
#define HORIZON_ZONE_ZC_STOPMOVE_HPP
 ...
 *
 */ 
class ZC_STOPMOVE : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_STOPMOVE(std::shared_ptr<ZoneSocket> sock);
	~ZC_STOPMOVE();
...
#endif /* HORIZON_ZONE_ZC_STOPMOVE_HPP */

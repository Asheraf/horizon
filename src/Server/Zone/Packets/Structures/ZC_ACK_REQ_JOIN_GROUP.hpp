...
#ifndef HORIZON_ZONE_ZC_ACK_REQ_JOIN_GROUP_HPP
#define HORIZON_ZONE_ZC_ACK_REQ_JOIN_GROUP_HPP
 ...
 *
 */ 
class ZC_ACK_REQ_JOIN_GROUP : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_ACK_REQ_JOIN_GROUP(std::shared_ptr<ZoneSocket> sock);
...
#endif /* HORIZON_ZONE_ZC_ACK_REQ_JOIN_GROUP_HPP */

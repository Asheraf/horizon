...
#ifndef HORIZON_ZONE_ZC_ITEM_PREVIEW_HPP
#define HORIZON_ZONE_ZC_ITEM_PREVIEW_HPP
 ...
 *
 */ 
class ZC_ITEM_PREVIEW : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_ITEM_PREVIEW(std::shared_ptr<ZoneSocket> sock);
	~ZC_ITEM_PREVIEW();
...
#endif /* HORIZON_ZONE_ZC_ITEM_PREVIEW_HPP */

...
#ifndef HORIZON_ZONE_ZC_EQUIP_ARROW_HPP
#define HORIZON_ZONE_ZC_EQUIP_ARROW_HPP
 ...
 *
 */ 
class ZC_EQUIP_ARROW : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_EQUIP_ARROW(std::shared_ptr<ZoneSocket> sock);
	~ZC_EQUIP_ARROW();
...
#endif /* HORIZON_ZONE_ZC_EQUIP_ARROW_HPP */

...
#ifndef HORIZON_ZONE_CZ_REQ_USER_COUNT_HPP
#define HORIZON_ZONE_CZ_REQ_USER_COUNT_HPP
...
/**
 * @brief Main object for the aegis packet: CZ_REQ_USER_COUNT
 * Size : 2 @ 0
 *
 */ 
class CZ_REQ_USER_COUNT : public Base::NetworkPacket<ZoneSocket>
{
public:
	CZ_REQ_USER_COUNT(std::shared_ptr<ZoneSocket> sock);
	~CZ_REQ_USER_COUNT();
...
#endif /* HORIZON_ZONE_CZ_REQ_USER_COUNT_HPP */

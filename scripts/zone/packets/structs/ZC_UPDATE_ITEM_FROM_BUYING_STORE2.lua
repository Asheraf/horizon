...
local ZC_UPDATE_ITEM_FROM_BUYING_STORE2 = {
	_id = pid,
	_length = 0,
	_buffer = nil
}
...
function ZC_UPDATE_ITEM_FROM_BUYING_STORE2.new(o)
	o = o or ZC_UPDATE_ITEM_FROM_BUYING_STORE2
	setmetatable(o, self)
	self.__index = self
	return o
end

function ZC_UPDATE_ITEM_FROM_BUYING_STORE2.serialize()

end

return ZC_UPDATE_ITEM_FROM_BUYING_STORE2

...
#ifndef HORIZON_ZONE_ZC_NOTIFY_BARGAIN_SALE_SELLING_HPP
#define HORIZON_ZONE_ZC_NOTIFY_BARGAIN_SALE_SELLING_HPP
 ...
 *
 */ 
class ZC_NOTIFY_BARGAIN_SALE_SELLING : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_NOTIFY_BARGAIN_SALE_SELLING(std::shared_ptr<ZoneSocket> sock);
...
#endif /* HORIZON_ZONE_ZC_NOTIFY_BARGAIN_SALE_SELLING_HPP */

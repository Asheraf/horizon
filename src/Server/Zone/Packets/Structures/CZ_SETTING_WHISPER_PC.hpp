...
#ifndef HORIZON_ZONE_CZ_SETTING_WHISPER_PC_HPP
#define HORIZON_ZONE_CZ_SETTING_WHISPER_PC_HPP
...
enum {
	...
	ID_CZ_SETTING_WHISPER_PC = 0x00cf
...
/**
 * @brief Main object for the aegis packet: CZ_SETTING_WHISPER_PC
 * Size : 27 @ 0
 *
 */ 
class CZ_SETTING_WHISPER_PC : public Base::NetworkPacket<ZoneSocket>
{
public:
	CZ_SETTING_WHISPER_PC(std::shared_ptr<ZoneSocket> sock);
...
#endif /* HORIZON_ZONE_CZ_SETTING_WHISPER_PC_HPP */

...
#ifndef HORIZON_ZONE_ZC_NPCACK_SERVERMOVE_HPP
#define HORIZON_ZONE_ZC_NPCACK_SERVERMOVE_HPP
 ...
 *
 */ 
class ZC_NPCACK_SERVERMOVE : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_NPCACK_SERVERMOVE(std::shared_ptr<ZoneSocket> sock);
...
#endif /* HORIZON_ZONE_ZC_NPCACK_SERVERMOVE_HPP */

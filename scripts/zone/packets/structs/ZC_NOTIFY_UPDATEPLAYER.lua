...
function ZC_NOTIFY_UPDATEPLAYER.new(o)
	o = o or ZC_NOTIFY_UPDATEPLAYER
	setmetatable(o, self)
	self.__index = self
	return o
end

function ZC_NOTIFY_UPDATEPLAYER.serialize()

end

return ZC_NOTIFY_UPDATEPLAYER

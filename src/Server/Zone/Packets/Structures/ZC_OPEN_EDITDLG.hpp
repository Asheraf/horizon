...
#ifndef HORIZON_ZONE_ZC_OPEN_EDITDLG_HPP
#define HORIZON_ZONE_ZC_OPEN_EDITDLG_HPP
 ...
 *
 */ 
class ZC_OPEN_EDITDLG : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_OPEN_EDITDLG(std::shared_ptr<ZoneSocket> sock);
	~ZC_OPEN_EDITDLG();
...
#endif /* HORIZON_ZONE_ZC_OPEN_EDITDLG_HPP */

...
function CZ_TRYCAPTURE_MONSTER.new(o)
	o = o or CZ_TRYCAPTURE_MONSTER
	setmetatable(o, self)
	self.__index = self
	return o
end

function CZ_TRYCAPTURE_MONSTER.deserialize(buf)

end

return CZ_TRYCAPTURE_MONSTER

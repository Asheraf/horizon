...
#ifndef HORIZON_ZONE_CZ_REQ_NEXT_SCRIPT_HPP
#define HORIZON_ZONE_CZ_REQ_NEXT_SCRIPT_HPP
...
/**
 * @brief Main object for the aegis packet: CZ_REQ_NEXT_SCRIPT
 * Size : 6 @ 0
 *
 */ 
class CZ_REQ_NEXT_SCRIPT : public Base::NetworkPacket<ZoneSocket>
{
public:
	CZ_REQ_NEXT_SCRIPT(std::shared_ptr<ZoneSocket> sock);
	~CZ_REQ_NEXT_SCRIPT();
...
#endif /* HORIZON_ZONE_CZ_REQ_NEXT_SCRIPT_HPP */

...
#ifndef HORIZON_ZONE_ZC_SPRITE_CHANGE2_HPP
#define HORIZON_ZONE_ZC_SPRITE_CHANGE2_HPP
 ...
 *
 */ 
class ZC_SPRITE_CHANGE2 : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_SPRITE_CHANGE2(std::shared_ptr<ZoneSocket> sock);
	~ZC_SPRITE_CHANGE2();
...
#endif /* HORIZON_ZONE_ZC_SPRITE_CHANGE2_HPP */

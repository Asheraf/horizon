...
#ifndef HORIZON_ZONE_ZC_BROADCAST_HPP
#define HORIZON_ZONE_ZC_BROADCAST_HPP
 ...
 *
 */ 
class ZC_BROADCAST : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_BROADCAST(std::shared_ptr<ZoneSocket> sock);
	~ZC_BROADCAST();
...
#endif /* HORIZON_ZONE_ZC_BROADCAST_HPP */

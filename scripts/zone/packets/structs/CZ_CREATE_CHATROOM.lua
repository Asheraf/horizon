...
function CZ_CREATE_CHATROOM.new(o)
	o = o or CZ_CREATE_CHATROOM
	setmetatable(o, self)
	self.__index = self
	return o
end

function CZ_CREATE_CHATROOM.deserialize(buf)

end

return CZ_CREATE_CHATROOM

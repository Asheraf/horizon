...
function CZ_ACK_STORE_PASSWORD.new(o)
	o = o or CZ_ACK_STORE_PASSWORD
	setmetatable(o, self)
	self.__index = self
	return o
end

function CZ_ACK_STORE_PASSWORD.serialize()

end

return CZ_ACK_STORE_PASSWORD

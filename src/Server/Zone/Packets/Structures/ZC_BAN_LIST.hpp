...
#ifndef HORIZON_ZONE_ZC_BAN_LIST_HPP
#define HORIZON_ZONE_ZC_BAN_LIST_HPP
 ...
 *
 */ 
class ZC_BAN_LIST : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_BAN_LIST(std::shared_ptr<ZoneSocket> sock);
	~ZC_BAN_LIST();
...
#endif /* HORIZON_ZONE_ZC_BAN_LIST_HPP */

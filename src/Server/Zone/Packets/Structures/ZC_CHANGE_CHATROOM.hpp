...
#ifndef HORIZON_ZONE_ZC_CHANGE_CHATROOM_HPP
#define HORIZON_ZONE_ZC_CHANGE_CHATROOM_HPP
 ...
 *
 */ 
class ZC_CHANGE_CHATROOM : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_CHANGE_CHATROOM(std::shared_ptr<ZoneSocket> sock);
	~ZC_CHANGE_CHATROOM();
...
#endif /* HORIZON_ZONE_ZC_CHANGE_CHATROOM_HPP */

...
#ifndef HORIZON_ZONE_ZC_NPCACK_ENABLE_HPP
#define HORIZON_ZONE_ZC_NPCACK_ENABLE_HPP
 ...
 *
 */ 
class ZC_NPCACK_ENABLE : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_NPCACK_ENABLE(std::shared_ptr<ZoneSocket> sock);
	~ZC_NPCACK_ENABLE();
...
#endif /* HORIZON_ZONE_ZC_NPCACK_ENABLE_HPP */

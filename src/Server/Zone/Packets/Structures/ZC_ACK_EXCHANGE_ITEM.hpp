...
#ifndef HORIZON_ZONE_ZC_ACK_EXCHANGE_ITEM_HPP
#define HORIZON_ZONE_ZC_ACK_EXCHANGE_ITEM_HPP
 ...
 *
 */ 
class ZC_ACK_EXCHANGE_ITEM : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_ACK_EXCHANGE_ITEM(std::shared_ptr<ZoneSocket> sock);
...
#endif /* HORIZON_ZONE_ZC_ACK_EXCHANGE_ITEM_HPP */

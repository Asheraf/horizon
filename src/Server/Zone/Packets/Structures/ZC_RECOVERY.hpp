...
#ifndef HORIZON_ZONE_ZC_RECOVERY_HPP
#define HORIZON_ZONE_ZC_RECOVERY_HPP
 ...
 *
 */ 
class ZC_RECOVERY : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_RECOVERY(std::shared_ptr<ZoneSocket> sock);
	~ZC_RECOVERY();
...
#endif /* HORIZON_ZONE_ZC_RECOVERY_HPP */

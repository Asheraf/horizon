...
#ifndef HORIZON_ZONE_ZC_SELECT_DEALTYPE_HPP
#define HORIZON_ZONE_ZC_SELECT_DEALTYPE_HPP
 ...
 *
 */ 
class ZC_SELECT_DEALTYPE : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_SELECT_DEALTYPE(std::shared_ptr<ZoneSocket> sock);
	~ZC_SELECT_DEALTYPE();
...
#endif /* HORIZON_ZONE_ZC_SELECT_DEALTYPE_HPP */

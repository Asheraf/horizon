...
function ZC_NOTIFY_MAPPROPERTY2.new(o)
	o = o or ZC_NOTIFY_MAPPROPERTY2
	setmetatable(o, self)
	self.__index = self
	return o
end

function ZC_NOTIFY_MAPPROPERTY2.serialize()

end

return ZC_NOTIFY_MAPPROPERTY2

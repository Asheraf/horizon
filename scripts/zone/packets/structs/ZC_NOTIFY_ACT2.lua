...
elseif packet_version >= 20080102 then
	local pid = 0x02e1
elseif packet_version >= 20071113 then
	local pid = 0x02e1
elseif packet_version >= 0 then
	local pid = 0x02e1
end

local ZC_NOTIFY_ACT2 = {
	_id = pid,
	_length = 0,
	_buffer = nil
}
...
function ZC_NOTIFY_ACT2.new(o)
	o = o or ZC_NOTIFY_ACT2
	setmetatable(o, self)
	self.__index = self
	return o
end

function ZC_NOTIFY_ACT2.serialize()

end

return ZC_NOTIFY_ACT2

...
#ifndef HORIZON_ZONE_ZC_ATTACK_RANGE_HPP
#define HORIZON_ZONE_ZC_ATTACK_RANGE_HPP
 ...
 *
 */ 
class ZC_ATTACK_RANGE : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_ATTACK_RANGE(std::shared_ptr<ZoneSocket> sock);
	~ZC_ATTACK_RANGE();
...
#endif /* HORIZON_ZONE_ZC_ATTACK_RANGE_HPP */

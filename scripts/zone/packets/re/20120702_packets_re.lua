...
d:add(0x0815, 26, require('CZ_REQ_CLOSE_BUYING_STORE'))
...
d:add(0x0989, 6, require('ZC_ACK_CLAN_LEAVE'))
d:add(0x098a, -1, require('ZC_CLANINFO'))
d:add(0x0988, 2, require('ZC_NOTIFY_CLAN_CONNECTINFO'))

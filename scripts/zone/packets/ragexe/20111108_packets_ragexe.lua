...
d:add(0x07ec, 18, require('CZ_JOIN_BATTLE_FIELD'))
d:add(0x0364, -1, require('CZ_MOVE_ITEM_FROM_BODY_TO_STORE2'))
d:add(0x0365, 10, require('CZ_MOVE_ITEM_FROM_STORE_TO_BODY2'))
d:add(0x02c4, 8, require('CZ_PARTY_JOIN_REQ'))
d:add(0x08f7, 3, require('CZ_PARTY_RECRUIT_ACK_RECALL'))
d:add(0x08f9, 6, require('CZ_PARTY_RECRUIT_REFUSE_VOLUNTEER'))
...
d:add(0x08f5, -1, require('CZ_UNKNOWN_BOOKING_SOMMON_MEMBER_08f5'))
d:add(0x0438, 8, require('CZ_USE_SKILL2'))
d:add(0x0366, 90, require('CZ_USE_SKILL_TOGROUND2'))
d:add(0x08e2, 25, require('ZC_NAVIGATION_ACTIVE'))
d:add(0x08f8, 7, require('ZC_PARTY_RECRUIT_FAILED_RECALL'))
d:add(0x08f6, 22, require('ZC_PARTY_RECRUIT_RECALL_COST'))
d:add(0x08fa, 6, require('ZC_PARTY_RECRUIT_REFUSE_VOLUNTEER'))

...
local CZ_PRIVATE_AIRSHIP_REQUEST = {
	_id = pid,
	_length = 0,
	_buffer = nil
}
...
function CZ_PRIVATE_AIRSHIP_REQUEST.new(o)
	o = o or CZ_PRIVATE_AIRSHIP_REQUEST
	setmetatable(o, self)
	self.__index = self
	return o
end

function CZ_PRIVATE_AIRSHIP_REQUEST.deserialize(buf)

end

return CZ_PRIVATE_AIRSHIP_REQUEST

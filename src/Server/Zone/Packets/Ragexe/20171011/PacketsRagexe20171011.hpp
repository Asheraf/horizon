...
#ifndef HORIZON_ZONE_RAGEXE_20171011_PACKETS_HPP
#define HORIZON_ZONE_RAGEXE_20171011_PACKETS_HPP
...
enum packets
{
	...
	CZ_ADD_FRIENDS = 0x087b,
	CZ_CHANGE_DIRECTION = 0x0954,
...
#endif /* HORIZON_ZONE_RAGEXE_20171011_PACKETS_HPP */

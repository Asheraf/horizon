...
function ZC_ACK_REQ_JOIN_GUILD.new(o)
	o = o or ZC_ACK_REQ_JOIN_GUILD
	setmetatable(o, self)
	self.__index = self
	return o
end

function ZC_ACK_REQ_JOIN_GUILD.serialize()

end

return ZC_ACK_REQ_JOIN_GUILD

...
#ifndef HORIZON_ZONE_CZ_REQ_ITEMCOMPOSITION_HPP
#define HORIZON_ZONE_CZ_REQ_ITEMCOMPOSITION_HPP
...
enum {
	...
	ID_CZ_REQ_ITEMCOMPOSITION = 0x017c
...
/**
 * @brief Main object for the aegis packet: CZ_REQ_ITEMCOMPOSITION
 * Size : 6 @ 0
 *
 */ 
class CZ_REQ_ITEMCOMPOSITION : public Base::NetworkPacket<ZoneSocket>
{
public:
	CZ_REQ_ITEMCOMPOSITION(std::shared_ptr<ZoneSocket> sock);
...
#endif /* HORIZON_ZONE_CZ_REQ_ITEMCOMPOSITION_HPP */

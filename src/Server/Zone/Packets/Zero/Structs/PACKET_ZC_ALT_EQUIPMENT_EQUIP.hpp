...
#ifndef HORIZON_ZONE_ZERO_PACKET_ZC_ALT_EQUIPMENT_EQUIP_HPP
#define HORIZON_ZONE_ZERO_PACKET_ZC_ALT_EQUIPMENT_EQUIP_HPP
...
#endif /* HORIZON_ZONE_ZERO_PACKET_ZC_ALT_EQUIPMENT_EQUIP_HPP */

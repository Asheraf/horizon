...
function CZ_JOIN_BATTLE_FIELD.new(o)
	o = o or CZ_JOIN_BATTLE_FIELD
	setmetatable(o, self)
	self.__index = self
	return o
end

function CZ_JOIN_BATTLE_FIELD.deserialize(buf)

end

return CZ_JOIN_BATTLE_FIELD

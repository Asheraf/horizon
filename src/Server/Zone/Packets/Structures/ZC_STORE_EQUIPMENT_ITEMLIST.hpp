...
#ifndef HORIZON_ZONE_ZC_STORE_EQUIPMENT_ITEMLIST_HPP
#define HORIZON_ZONE_ZC_STORE_EQUIPMENT_ITEMLIST_HPP
 ...
 *
 */ 
class ZC_STORE_EQUIPMENT_ITEMLIST : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_STORE_EQUIPMENT_ITEMLIST(std::shared_ptr<ZoneSocket> sock);
...
#endif /* HORIZON_ZONE_ZC_STORE_EQUIPMENT_ITEMLIST_HPP */

...
#ifndef HORIZON_ZONE_RAGEXE_PACKET_ZC_ACK_REQNAME_BYGID_HPP
#define HORIZON_ZONE_RAGEXE_PACKET_ZC_ACK_REQNAME_BYGID_HPP
...
#endif /* HORIZON_ZONE_RAGEXE_PACKET_ZC_ACK_REQNAME_BYGID_HPP */

...
#ifndef HORIZON_ZONE_CZ_DELETE_FRIENDS_HPP
#define HORIZON_ZONE_CZ_DELETE_FRIENDS_HPP
...
/**
 * @brief Main object for the aegis packet: CZ_DELETE_FRIENDS
 * Size : 10 @ 0
 *
 */ 
class CZ_DELETE_FRIENDS : public Base::NetworkPacket<ZoneSocket>
{
public:
	CZ_DELETE_FRIENDS(std::shared_ptr<ZoneSocket> sock);
	~CZ_DELETE_FRIENDS();
...
#endif /* HORIZON_ZONE_CZ_DELETE_FRIENDS_HPP */

...
#ifndef HORIZON_ZONE_ZC_ITEM_PICKUP_ACK_V5_HPP
#define HORIZON_ZONE_ZC_ITEM_PICKUP_ACK_V5_HPP
 ...
 *
 */ 
class ZC_ITEM_PICKUP_ACK_V5 : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_ITEM_PICKUP_ACK_V5(std::shared_ptr<ZoneSocket> sock);
...
#endif /* HORIZON_ZONE_ZC_ITEM_PICKUP_ACK_V5_HPP */

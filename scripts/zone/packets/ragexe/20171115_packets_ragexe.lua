...
d:add(0x086d, 4, require('CZ_GANGSI_RANK'))
d:add(0x086f, -1, require('CZ_ITEMLISTWIN_RES'))
d:add(0x0926, 6, require('CZ_ITEM_PICKUP'))
d:add(0x0365, 6, require('CZ_ITEM_THROW'))
d:add(0x0883, 8, require('CZ_JOIN_BATTLE_FIELD'))
d:add(0x088b, 8, require('CZ_MOVE_ITEM_FROM_BODY_TO_STORE'))
d:add(0x087e, 8, require('CZ_MOVE_ITEM_FROM_STORE_TO_BODY'))
d:add(0x0890, 18, require('CZ_PARTY_BOOKING_REQ_REGISTER'))

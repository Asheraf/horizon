...
d:add(0x035f, 36, require('CZ_ACK_STORE_PASSWORD'))
d:add(0x0860, 26, require('CZ_ADD_FRIENDS'))
d:add(0x0899, 5, require('CZ_CHANGE_DIRECTION'))
d:add(0x0871, 5, require('CZ_COMMAND_MER'))
d:add(0x094b, 19, require('CZ_ENTER'))
d:add(0x0953, 4, require('CZ_GANGSI_RANK'))
d:add(0x093b, -1, require('CZ_ITEMLISTWIN_RES'))
d:add(0x087f, 6, require('CZ_ITEM_PICKUP'))
...
d:add(0x0940, 6, require('CZ_REQNAME'))

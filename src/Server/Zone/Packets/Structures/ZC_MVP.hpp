...
#ifndef HORIZON_ZONE_ZC_MVP_HPP
#define HORIZON_ZONE_ZC_MVP_HPP
 ...
 *
 */ 
class ZC_MVP : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_MVP(std::shared_ptr<ZoneSocket> sock);
	~ZC_MVP();

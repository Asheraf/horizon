...
#ifndef HORIZON_ZONE_CZ_REQ_EXPEL_MEMBER_HPP
#define HORIZON_ZONE_CZ_REQ_EXPEL_MEMBER_HPP
...
/**
 * @brief Main object for the aegis packet: CZ_REQ_EXPEL_MEMBER
 * Size : 26 @ 0
 *
 */ 
class CZ_REQ_EXPEL_MEMBER : public Base::NetworkPacket<ZoneSocket>
{
public:
	CZ_REQ_EXPEL_MEMBER(std::shared_ptr<ZoneSocket> sock);
	~CZ_REQ_EXPEL_MEMBER();
...
#endif /* HORIZON_ZONE_CZ_REQ_EXPEL_MEMBER_HPP */

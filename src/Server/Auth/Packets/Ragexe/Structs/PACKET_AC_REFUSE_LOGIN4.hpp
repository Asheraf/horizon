...
#ifndef HORIZON_AUTH_RAGEXE_PACKET_AC_REFUSE_LOGIN4_HPP
#define HORIZON_AUTH_RAGEXE_PACKET_AC_REFUSE_LOGIN4_HPP
...
#endif /* HORIZON_AUTH_RAGEXE_PACKET_AC_REFUSE_LOGIN4_HPP */

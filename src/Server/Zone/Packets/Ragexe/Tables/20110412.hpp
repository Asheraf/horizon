...
#ifndef HORIZON_ZONE_SHUFFLE_PACKET_LENGTH_TABLE_20110412
#define HORIZON_ZONE_SHUFFLE_PACKET_LENGTH_TABLE_20110412
...
#define ADD_PKT(i, j, k) _packet_length_table.insert(i, std::make_pair<uint16_t, NetworkPacket>(j, k))
		...
		ADD_PKT(0x0368, 19, CZ_REQNAME2(sock));
		ADD_PKT(0x0369, 4, CZ_REQNAME_BYGID2(sock));
...
#endif /* HORIZON_ZONE_SHUFFLE_PACKET_LENGTH_TABLE_20110412 */
...
#ifndef HORIZON_ZONE_ZC_NOTIFY_OFFLINE_STORE_HPP
#define HORIZON_ZONE_ZC_NOTIFY_OFFLINE_STORE_HPP
 ...
 *
 */ 
class ZC_NOTIFY_OFFLINE_STORE : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_NOTIFY_OFFLINE_STORE(std::shared_ptr<ZoneSocket> sock);
...
#endif /* HORIZON_ZONE_ZC_NOTIFY_OFFLINE_STORE_HPP */

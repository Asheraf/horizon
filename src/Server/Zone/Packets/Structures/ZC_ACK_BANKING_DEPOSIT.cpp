...
#include "ZC_ACK_BANKING_DEPOSIT.hpp"
#include "Server/Zone/Socket/ZoneSocket.hpp"

using namespace Horizon::Zone::Packet;

ZC_ACK_BANKING_DEPOSIT::ZC_ACK_BANKING_DEPOSIT(std::shared_ptr<ZoneSocket> sock)
: NetworkPacket(ID_ZC_ACK_BANKING_DEPOSIT, sock) { }

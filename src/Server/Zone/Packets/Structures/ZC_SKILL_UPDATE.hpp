...
#ifndef HORIZON_ZONE_ZC_SKILL_UPDATE_HPP
#define HORIZON_ZONE_ZC_SKILL_UPDATE_HPP
 ...
 *
 */ 
class ZC_SKILL_UPDATE : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_SKILL_UPDATE(std::shared_ptr<ZoneSocket> sock);
	~ZC_SKILL_UPDATE();
...
#endif /* HORIZON_ZONE_ZC_SKILL_UPDATE_HPP */

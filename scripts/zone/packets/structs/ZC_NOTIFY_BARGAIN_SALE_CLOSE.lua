...
local ZC_NOTIFY_BARGAIN_SALE_CLOSE = {
	_id = pid,
	_length = 0,
	_buffer = nil
}
...
function ZC_NOTIFY_BARGAIN_SALE_CLOSE.new(o)
	o = o or ZC_NOTIFY_BARGAIN_SALE_CLOSE
	setmetatable(o, self)
	self.__index = self
	return o
end

function ZC_NOTIFY_BARGAIN_SALE_CLOSE.serialize()

end

return ZC_NOTIFY_BARGAIN_SALE_CLOSE

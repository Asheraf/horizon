...
#ifndef HORIZON_ZONE_CZ_MAKE_GROUP2_HPP
#define HORIZON_ZONE_CZ_MAKE_GROUP2_HPP
...
/**
 * @brief Main object for the aegis packet: CZ_MAKE_GROUP2
 * Size : 28 @ 0
 *
 */ 
class CZ_MAKE_GROUP2 : public Base::NetworkPacket<ZoneSocket>
{
public:
	CZ_MAKE_GROUP2(std::shared_ptr<ZoneSocket> sock);
	~CZ_MAKE_GROUP2();
...
#endif /* HORIZON_ZONE_CZ_MAKE_GROUP2_HPP */

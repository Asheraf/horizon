...
#ifndef HORIZON_ZONE_ZC_STARSKILL_HPP
#define HORIZON_ZONE_ZC_STARSKILL_HPP
 ...
 *
 */ 
class ZC_STARSKILL : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_STARSKILL(std::shared_ptr<ZoneSocket> sock);
	~ZC_STARSKILL();
...
#endif /* HORIZON_ZONE_ZC_STARSKILL_HPP */

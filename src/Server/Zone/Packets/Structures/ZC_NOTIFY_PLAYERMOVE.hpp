...
#ifndef HORIZON_ZONE_ZC_NOTIFY_PLAYERMOVE_HPP
#define HORIZON_ZONE_ZC_NOTIFY_PLAYERMOVE_HPP
 ...
 *
 */ 
class ZC_NOTIFY_PLAYERMOVE : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_NOTIFY_PLAYERMOVE(std::shared_ptr<ZoneSocket> sock);
...
#endif /* HORIZON_ZONE_ZC_NOTIFY_PLAYERMOVE_HPP */

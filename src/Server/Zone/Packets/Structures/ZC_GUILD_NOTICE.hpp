...
#ifndef HORIZON_ZONE_ZC_GUILD_NOTICE_HPP
#define HORIZON_ZONE_ZC_GUILD_NOTICE_HPP
 ...
 *
 */ 
class ZC_GUILD_NOTICE : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_GUILD_NOTICE(std::shared_ptr<ZoneSocket> sock);
	~ZC_GUILD_NOTICE();
...
#endif /* HORIZON_ZONE_ZC_GUILD_NOTICE_HPP */

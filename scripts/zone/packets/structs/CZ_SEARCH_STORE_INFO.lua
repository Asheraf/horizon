...
function CZ_SEARCH_STORE_INFO.new(o)
	o = o or CZ_SEARCH_STORE_INFO
	setmetatable(o, self)
	self.__index = self
	return o
end

function CZ_SEARCH_STORE_INFO.deserialize(buf)

end

return CZ_SEARCH_STORE_INFO

...
#ifndef HORIZON_ZONE_ZC_USESKILL_ACK_HPP
#define HORIZON_ZONE_ZC_USESKILL_ACK_HPP
 ...
 *
 */ 
class ZC_USESKILL_ACK : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_USESKILL_ACK(std::shared_ptr<ZoneSocket> sock);
	~ZC_USESKILL_ACK();
...
#endif /* HORIZON_ZONE_ZC_USESKILL_ACK_HPP */

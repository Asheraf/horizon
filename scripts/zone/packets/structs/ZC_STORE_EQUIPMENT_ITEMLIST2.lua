...
local ZC_STORE_EQUIPMENT_ITEMLIST2 = {
	_id = pid,
	_length = 0,
	_buffer = nil
}
...
function ZC_STORE_EQUIPMENT_ITEMLIST2.new(o)
	o = o or ZC_STORE_EQUIPMENT_ITEMLIST2
	setmetatable(o, self)
	self.__index = self
	return o
end

function ZC_STORE_EQUIPMENT_ITEMLIST2.serialize()

end

return ZC_STORE_EQUIPMENT_ITEMLIST2

...
#ifndef HORIZON_ZONE_ZC_STATE_CHANGE3_HPP
#define HORIZON_ZONE_ZC_STATE_CHANGE3_HPP
 ...
 *
 */ 
class ZC_STATE_CHANGE3 : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_STATE_CHANGE3(std::shared_ptr<ZoneSocket> sock);
	~ZC_STATE_CHANGE3();
...
#endif /* HORIZON_ZONE_ZC_STATE_CHANGE3_HPP */

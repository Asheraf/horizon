...
#ifndef HORIZON_ZONE_CZ_IRMAIL_LIST_HPP
#define HORIZON_ZONE_CZ_IRMAIL_LIST_HPP
...
/**
 * @brief Main object for the aegis packet: CZ_IRMAIL_LIST
 * Size : 2 @ 20080415
 *
 */ 
class CZ_IRMAIL_LIST : public Base::NetworkPacket<ZoneSocket>
{
public:
	CZ_IRMAIL_LIST(std::shared_ptr<ZoneSocket> sock);
	~CZ_IRMAIL_LIST();
...
#endif /* HORIZON_ZONE_CZ_IRMAIL_LIST_HPP */

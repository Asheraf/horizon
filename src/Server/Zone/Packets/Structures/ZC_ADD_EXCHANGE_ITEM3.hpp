...
#ifndef HORIZON_ZONE_ZC_ADD_EXCHANGE_ITEM3_HPP
#define HORIZON_ZONE_ZC_ADD_EXCHANGE_ITEM3_HPP
 ...
 *
 */ 
class ZC_ADD_EXCHANGE_ITEM3 : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_ADD_EXCHANGE_ITEM3(std::shared_ptr<ZoneSocket> sock);
...
#endif /* HORIZON_ZONE_ZC_ADD_EXCHANGE_ITEM3_HPP */

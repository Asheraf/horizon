...
function CZ_REQ_EXPEL_MEMBER.new(o)
	o = o or CZ_REQ_EXPEL_MEMBER
	setmetatable(o, self)
	self.__index = self
	return o
end

function CZ_REQ_EXPEL_MEMBER.deserialize(buf)

end

return CZ_REQ_EXPEL_MEMBER

...
#ifndef HORIZON_ZONE_CZ_ITEM_CREATE_HPP
#define HORIZON_ZONE_CZ_ITEM_CREATE_HPP
...
/**
 * @brief Main object for the aegis packet: CZ_ITEM_CREATE
 * Size : 26 @ 0
 *
 */ 
class CZ_ITEM_CREATE : public Base::NetworkPacket<ZoneSocket>
{
public:
	CZ_ITEM_CREATE(std::shared_ptr<ZoneSocket> sock);
	~CZ_ITEM_CREATE();
...
#endif /* HORIZON_ZONE_CZ_ITEM_CREATE_HPP */

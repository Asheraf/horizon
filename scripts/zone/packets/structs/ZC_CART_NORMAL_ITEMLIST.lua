...
function ZC_CART_NORMAL_ITEMLIST.new(o)
	o = o or ZC_CART_NORMAL_ITEMLIST
	setmetatable(o, self)
	self.__index = self
	return o
end

function ZC_CART_NORMAL_ITEMLIST.serialize()

end

return ZC_CART_NORMAL_ITEMLIST

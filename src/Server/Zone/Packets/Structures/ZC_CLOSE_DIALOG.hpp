...
#ifndef HORIZON_ZONE_ZC_CLOSE_CoreLog_HPP
#define HORIZON_ZONE_ZC_CLOSE_CoreLog_HPP
...
/**
 * @brief Main object for the aegis packet: ZC_CLOSE_CoreLog
 * Size : 6 @ 0
 *
 */ 
class ZC_CLOSE_CoreLog : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_CLOSE_CoreLog(std::shared_ptr<ZoneSocket> sock);
	~ZC_CLOSE_CoreLog();
...
#endif /* HORIZON_ZONE_ZC_CLOSE_CoreLog_HPP */

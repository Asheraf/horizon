...
d:add(0x085d, 36, require('CZ_ACK_STORE_PASSWORD'))
d:add(0x0939, 26, require('CZ_ADD_FRIENDS'))
d:add(0x0926, 5, require('CZ_CHANGE_DIRECTION'))
d:add(0x0362, 5, require('CZ_COMMAND_MER'))
d:add(0x092e, 19, require('CZ_ENTER'))
d:add(0x095f, 4, require('CZ_GANGSI_RANK'))
d:add(0x0937, -1, require('CZ_ITEMLISTWIN_RES'))
d:add(0x0929, 6, require('CZ_ITEM_PICKUP'))
d:add(0x08a8, 6, require('CZ_ITEM_THROW'))
d:add(0x0917, 8, require('CZ_JOIN_BATTLE_FIELD'))
d:add(0x0363, 8, require('CZ_MOVE_ITEM_FROM_BODY_TO_STORE'))
...
d:add(0x0888, -1, require('CZ_SEARCH_STORE_INFO'))

...
#ifndef HORIZON_ZONE_ZC_ACK_ADD_ITEM_RODEX_HPP
#define HORIZON_ZONE_ZC_ACK_ADD_ITEM_RODEX_HPP
 ...
 *
 */ 
class ZC_ACK_ADD_ITEM_RODEX : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_ACK_ADD_ITEM_RODEX(std::shared_ptr<ZoneSocket> sock);
...
#endif /* HORIZON_ZONE_ZC_ACK_ADD_ITEM_RODEX_HPP */

...
local ZC_ATTACK_FAILURE_FOR_DISTANCE = {
	_id = pid,
	_length = 0,
	_buffer = nil
}
...
function ZC_ATTACK_FAILURE_FOR_DISTANCE.new(o)
	o = o or ZC_ATTACK_FAILURE_FOR_DISTANCE
	setmetatable(o, self)
	self.__index = self
	return o
end

function ZC_ATTACK_FAILURE_FOR_DISTANCE.serialize()

end

return ZC_ATTACK_FAILURE_FOR_DISTANCE

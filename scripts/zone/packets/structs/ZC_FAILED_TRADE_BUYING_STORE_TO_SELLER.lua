...
local ZC_FAILED_TRADE_BUYING_STORE_TO_SELLER = {
	_id = pid,
	_length = 0,
	_buffer = nil
}
...
function ZC_FAILED_TRADE_BUYING_STORE_TO_SELLER.new(o)
	o = o or ZC_FAILED_TRADE_BUYING_STORE_TO_SELLER
	setmetatable(o, self)
	self.__index = self
	return o
end

function ZC_FAILED_TRADE_BUYING_STORE_TO_SELLER.serialize()

end

return ZC_FAILED_TRADE_BUYING_STORE_TO_SELLER

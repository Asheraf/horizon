...
local CZ_MOVE_ITEM_FROM_BODY_TO_STORE = {
	_id = pid,
	_length = 0,
	_buffer = nil
}
...
function CZ_MOVE_ITEM_FROM_BODY_TO_STORE.new(o)
	o = o or CZ_MOVE_ITEM_FROM_BODY_TO_STORE
	setmetatable(o, self)
	self.__index = self
	return o
end

function CZ_MOVE_ITEM_FROM_BODY_TO_STORE.deserialize(buf)

end

return CZ_MOVE_ITEM_FROM_BODY_TO_STORE

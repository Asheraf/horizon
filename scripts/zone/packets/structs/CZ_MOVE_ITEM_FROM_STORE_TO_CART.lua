...
local CZ_MOVE_ITEM_FROM_STORE_TO_CART = {
	_id = pid,
	_length = 0,
	_buffer = nil
}
...
function CZ_MOVE_ITEM_FROM_STORE_TO_CART.new(o)
	o = o or CZ_MOVE_ITEM_FROM_STORE_TO_CART
	setmetatable(o, self)
	self.__index = self
	return o
end

function CZ_MOVE_ITEM_FROM_STORE_TO_CART.deserialize(buf)

end

return CZ_MOVE_ITEM_FROM_STORE_TO_CART

...
function ZC_RECV_ROULETTE_ITEM.new(o)
	o = o or ZC_RECV_ROULETTE_ITEM
	setmetatable(o, self)
	self.__index = self
	return o
end

function ZC_RECV_ROULETTE_ITEM.serialize()

end

return ZC_RECV_ROULETTE_ITEM

...
local ZC_PC_PURCHASE_ITEMLIST_FROMMC = {
	_id = pid,
	_length = 0,
	_buffer = nil
}
...
function ZC_PC_PURCHASE_ITEMLIST_FROMMC.new(o)
	o = o or ZC_PC_PURCHASE_ITEMLIST_FROMMC
	setmetatable(o, self)
	self.__index = self
	return o
end

function ZC_PC_PURCHASE_ITEMLIST_FROMMC.serialize()

end

return ZC_PC_PURCHASE_ITEMLIST_FROMMC

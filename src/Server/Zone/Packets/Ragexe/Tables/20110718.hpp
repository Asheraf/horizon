...
#ifndef HORIZON_ZONE_SHUFFLE_PACKET_LENGTH_TABLE_20110718
#define HORIZON_ZONE_SHUFFLE_PACKET_LENGTH_TABLE_20110718
...
#define ADD_PKT(i, j, k) _packet_length_table.insert(i, std::make_pair<uint16_t, NetworkPacket>(j, k))
		...
		ADD_PKT(0x0361, 90, CZ_CHANGE_DIRECTION2(sock));
		ADD_PKT(0x0436, 6, CZ_ENTER2(sock));
		ADD_PKT(0x0281, 18, CZ_GANGSI_RANK(sock));
		ADD_PKT(0x07e4, 4, CZ_ITEMLISTWIN_RES(sock));
		ADD_PKT(0x0363, 2, CZ_ITEM_THROW2(sock));
		ADD_PKT(0x07ec, 12, CZ_JOIN_BATTLE_FIELD(sock));
		...
		ADD_PKT(0x0835, 8, CZ_SEARCH_STORE_INFO(sock));
		ADD_PKT(0x0838, 8, CZ_SEARCH_STORE_INFO_NEXT_PAGE(sock));
		ADD_PKT(0x083c, 10, CZ_SSILIST_ITEM_CLICK(sock));
		ADD_PKT(0x0438, 10, CZ_USE_SKILL2(sock));
		ADD_PKT(0x0367, 19, CZ_USE_SKILL_TOGROUND_WITHTALKBOX2(sock));
#undef ADD_PKT
	}
...
#endif /* HORIZON_ZONE_SHUFFLE_PACKET_LENGTH_TABLE_20110718 */
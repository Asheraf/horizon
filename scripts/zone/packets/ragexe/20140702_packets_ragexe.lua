...
d:add(0x092c, 19, require('CZ_ENTER'))
d:add(0x0933, 4, require('CZ_GANGSI_RANK'))
d:add(0x0364, -1, require('CZ_ITEMLISTWIN_RES'))
d:add(0x08a2, 6, require('CZ_ITEM_PICKUP'))
d:add(0x085a, 6, require('CZ_ITEM_THROW'))
d:add(0x0895, 8, require('CZ_JOIN_BATTLE_FIELD'))
d:add(0x0438, 8, require('CZ_MOVE_ITEM_FROM_BODY_TO_STORE'))
d:add(0x0892, 8, require('CZ_MOVE_ITEM_FROM_STORE_TO_BODY'))
...
d:add(0x0887, 5, require('CZ_REQUEST_MOVE'))
...
d:add(0x0835, 12, require('CZ_SSILIST_ITEM_CLICK'))
d:add(0x083c, 10, require('CZ_USE_SKILL'))
d:add(0x07e4, 10, require('CZ_USE_SKILL_TOGROUND'))

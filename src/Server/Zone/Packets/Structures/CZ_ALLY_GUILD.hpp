...
#ifndef HORIZON_ZONE_CZ_ALLY_GUILD_HPP
#define HORIZON_ZONE_CZ_ALLY_GUILD_HPP
...
/**
 * @brief Main object for the aegis packet: CZ_ALLY_GUILD
 * Size : 10 @ 0
 *
 */ 
class CZ_ALLY_GUILD : public Base::NetworkPacket<ZoneSocket>
{
public:
	CZ_ALLY_GUILD(std::shared_ptr<ZoneSocket> sock);
	~CZ_ALLY_GUILD();
...
#endif /* HORIZON_ZONE_CZ_ALLY_GUILD_HPP */

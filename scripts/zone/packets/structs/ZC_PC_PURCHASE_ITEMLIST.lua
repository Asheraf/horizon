...
function ZC_PC_PURCHASE_ITEMLIST.new(o)
	o = o or ZC_PC_PURCHASE_ITEMLIST
	setmetatable(o, self)
	self.__index = self
	return o
end

function ZC_PC_PURCHASE_ITEMLIST.serialize()

end

return ZC_PC_PURCHASE_ITEMLIST

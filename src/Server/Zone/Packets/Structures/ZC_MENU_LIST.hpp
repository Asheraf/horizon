...
#ifndef HORIZON_ZONE_ZC_MENU_LIST_HPP
#define HORIZON_ZONE_ZC_MENU_LIST_HPP
 ...
 *
 */ 
class ZC_MENU_LIST : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_MENU_LIST(std::shared_ptr<ZoneSocket> sock);
	~ZC_MENU_LIST();
...
#endif /* HORIZON_ZONE_ZC_MENU_LIST_HPP */

...
local ZC_PARTY_RECRUIT_RECALL_COST = {
	_id = pid,
	_length = 0,
	_buffer = nil
}
...
function ZC_PARTY_RECRUIT_RECALL_COST.new(o)
	o = o or ZC_PARTY_RECRUIT_RECALL_COST
	setmetatable(o, self)
	self.__index = self
	return o
end

function ZC_PARTY_RECRUIT_RECALL_COST.serialize()

end

return ZC_PARTY_RECRUIT_RECALL_COST

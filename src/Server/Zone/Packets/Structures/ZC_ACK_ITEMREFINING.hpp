...
#ifndef HORIZON_ZONE_ZC_ACK_ITEMREFINING_HPP
#define HORIZON_ZONE_ZC_ACK_ITEMREFINING_HPP
 ...
 *
 */ 
class ZC_ACK_ITEMREFINING : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_ACK_ITEMREFINING(std::shared_ptr<ZoneSocket> sock);
	~ZC_ACK_ITEMREFINING();
...
#endif /* HORIZON_ZONE_ZC_ACK_ITEMREFINING_HPP */

...
d:add(0x00c5, 10, require('CZ_ACK_SELECT_DEALTYPE'))
d:add(0x00e8, 5, require('CZ_ADD_EXCHANGE_ITEM'))
d:add(0x0202, -1, require('CZ_ADD_FRIENDS'))
d:add(0x0217, -1, require('CZ_BLACKSMITH_RANK'))
d:add(0x0099, 60, require('CZ_BROADCAST'))
d:add(0x00ed, -1, require('CZ_CANCEL_EXCHANGE_ITEM'))
d:add(0x0118, 8, require('CZ_CANCEL_LOCKON'))
...
d:add(0x0102, 17, require('CZ_CHANGE_GROUPEXPOPTION'))
...
d:add(0x00d5, 81, require('CZ_CREATE_CHATROOM'))
d:add(0x0203, 34, require('CZ_DELETE_FRIENDS'))
d:add(0x00ce, 11, require('CZ_DISCONNECT_ALL_CHARACTER'))
d:add(0x01e7, 39, require('CZ_DORIDORI'))
d:add(0x00ef, 30, require('CZ_EXEC_EXCHANGE_ITEM'))
d:add(0x00e3, 35, require('CZ_EXIT_ROOM'))
d:add(0x017e, 29, require('CZ_GUILD_CHAT'))
d:add(0x0143, 26, require('CZ_INPUT_EDITDLG'))
d:add(0x01d5, -1, require('CZ_INPUT_EDITDLGSTR'))
d:add(0x02f6, 2, require('CZ_IRMAIL_LIST'))
d:add(0x02f3, 26, require('CZ_IRMAIL_SEND'))
...
d:add(0x019c, 55, require('CZ_LOCALBROADCAST'))
d:add(0x00f9, 6, require('CZ_MAKE_GROUP'))
d:add(0x01e8, 53, require('CZ_MAKE_GROUP2'))
...
d:add(0x0128, 11, require('CZ_MOVE_ITEM_FROM_STORE_TO_CART'))
...
d:add(0x01bd, 9, require('CZ_RECALL_GID'))
...
d:add(0x0108, 11, require('CZ_REQUEST_CHAT_PARTY'))
d:add(0x035f, -1, require('CZ_REQUEST_MOVE2'))
d:add(0x0232, 4, require('CZ_REQUEST_MOVENPC'))
...
d:add(0x00bf, 65, require('CZ_REQ_EMOTION'))
d:add(0x00d9, 4, require('CZ_REQ_ENTER_ROOM'))
d:add(0x0103, 79, require('CZ_REQ_EXPEL_GROUP_MEMBER'))
d:add(0x00e2, 6, require('CZ_REQ_EXPEL_MEMBER'))
d:add(0x0149, 6, require('CZ_REQ_GIVE_MANNER_POINT'))
d:add(0x014f, 13, require('CZ_REQ_GUILD_MENU'))
d:add(0x014d, 30, require('CZ_REQ_GUILD_MENUINTERFACE'))
d:add(0x017c, 21, require('CZ_REQ_ITEMCOMPOSITION'))
d:add(0x017a, 4, require('CZ_REQ_ITEMCOMPOSITION_LIST'))
d:add(0x0178, 33, require('CZ_REQ_ITEMIDENTIFY'))
d:add(0x01fd, 26, require('CZ_REQ_ITEMREPAIR'))
d:add(0x00fc, -1, require('CZ_REQ_JOIN_GROUP'))
d:add(0x0168, 282, require('CZ_REQ_JOIN_GUILD'))
d:add(0x0100, 186, require('CZ_REQ_LEAVE_GROUP'))
...
d:add(0x00ab, 53, require('CZ_REQ_TAKEOFF_EQUIP'))
d:add(0x00a9, 6, require('CZ_REQ_WEAR_EQUIP'))
d:add(0x00d3, 6, require('CZ_REQ_WHISPER_LIST'))
d:add(0x00b2, 2, require('CZ_RESTART'))
d:add(0x01ce, 22, require('CZ_SELECTAUTOSPELL'))
d:add(0x01a7, 30, require('CZ_SELECT_PETEGG'))
...
d:add(0x01bb, 16, require('CZ_SHIFT'))
d:add(0x00bb, 10, require('CZ_STATUS_CHANGE'))
d:add(0x019f, 20, require('CZ_TRYCAPTURE_MONSTER'))
...
d:add(0x0096, 31, require('CZ_WHISPER'))
d:add(0x0073, 6, require('ZC_ACCEPT_ENTER'))
d:add(0x0083, -1, require('ZC_ACCEPT_QUIT'))
d:add(0x012c, 58, require('ZC_ACK_ADDITEM_TO_CART'))
d:add(0x00ea, 30, require('ZC_ACK_ADD_EXCHANGE_ITEM'))
...
d:add(0x015a, 31, require('ZC_ACK_LEAVE_GUILD'))
d:add(0x0274, 10, require('ZC_ACK_MAIL_RETURN'))
d:add(0x00fa, 8, require('ZC_ACK_MAKE_GROUP'))
...
d:add(0x018b, 12, require('ZC_ACK_REQ_DISCONNECT'))
...
d:add(0x0209, 39, require('ZC_ADD_FRIENDS_LIST'))
d:add(0x0124, 32, require('ZC_ADD_ITEM_TO_CART'))
...
d:add(0x0163, 68, require('ZC_BAN_LIST'))
d:add(0x0219, 30, require('ZC_BLACKSMITH_RANK'))
d:add(0x009a, -1, require('ZC_BROADCAST'))
d:add(0x00ee, 18, require('ZC_CANCEL_EXCHANGE_ITEM'))
d:add(0x0122, 4, require('ZC_CART_EQUIPMENT_ITEMLIST'))
d:add(0x0123, 28, require('ZC_CART_NORMAL_ITEMLIST'))
d:add(0x01ef, 6, require('ZC_CART_NORMAL_ITEMLIST2'))
d:add(0x01a4, -1, require('ZC_CHANGESTATE_PET'))
d:add(0x00df, 90, require('ZC_CHANGE_CHATROOM'))
d:add(0x009c, 26, require('ZC_CHANGE_DIRECTION'))
d:add(0x00b6, 11, require('ZC_CLOSE_DIALOG'))
...
d:add(0x0141, 18, require('ZC_COUPLESTATUS'))
d:add(0x0137, 8, require('ZC_DELETEITEM_FROM_MCSTORE'))
d:add(0x020a, 32, require('ZC_DELETE_FRIENDS'))
...
d:add(0x00d8, 5, require('ZC_DESTROY_ROOM'))
d:add(0x01cf, 15, require('ZC_DEVOTIONLIST'))
d:add(0x00c0, 30, require('ZC_EMOTION'))
d:add(0x00db, 3, require('ZC_ENTER_ROOM'))
d:add(0x00a4, -1, require('ZC_EQUIPMENT_ITEMLIST'))
d:add(0x013c, 8, require('ZC_EQUIP_ARROW'))
d:add(0x00f0, -1, require('ZC_EXEC_EXCHANGE_ITEM'))
d:add(0x022f, -1, require('ZC_FEED_MER'))
d:add(0x01a3, -1, require('ZC_FEED_PET'))
d:add(0x0201, 26, require('ZC_FRIENDS_LIST'))
...
d:add(0x0162, 66, require('ZC_GUILD_SKILLINFO'))
d:add(0x0235, 12, require('ZC_HOSKILLINFO_LIST'))
...
d:add(0x009d, 8, require('ZC_ITEM_ENTRY'))
...
d:add(0x00af, 29, require('ZC_ITEM_THROW_ACK'))
d:add(0x00b1, 6, require('ZC_LONGPAR_CHANGE'))
d:add(0x01ad, 8, require('ZC_MAKINGARROW_LIST'))
d:add(0x0154, 5, require('ZC_MEMBERMGR_INFO'))
d:add(0x00dd, 7, require('ZC_MEMBER_EXIT'))
d:add(0x00dc, 27, require('ZC_MEMBER_NEWENTRY'))
d:add(0x00b7, -1, require('ZC_MENU_LIST'))
d:add(0x018c, -1, require('ZC_MONSTER_INFO'))
d:add(0x0196, 67, require('ZC_MSG_STATE_CHANGE'))
d:add(0x010c, 30, require('ZC_MVP'))
d:add(0x010a, 102, require('ZC_MVP_GETTING_ITEM'))
d:add(0x014c, 16, require('ZC_MYGUILD_BASIC_INFO'))
d:add(0x00a3, 4, require('ZC_NORMAL_ITEMLIST'))
d:add(0x01ee, -1, require('ZC_NORMAL_ITEMLIST2'))
d:add(0x008a, 9, require('ZC_NOTIFY_ACT'))
d:add(0x02e1, 10, require('ZC_NOTIFY_ACT2'))
d:add(0x0121, 4, require('ZC_NOTIFY_CARTITEM_COUNTINFO'))
d:add(0x008d, 2, require('ZC_NOTIFY_CHAT'))
d:add(0x0109, -1, require('ZC_NOTIFY_CHAT_PARTY'))
d:add(0x019b, 27, require('ZC_NOTIFY_EFFECT'))
...
d:add(0x0189, 24, require('ZC_NOTIFY_MAPINFO'))
...
d:add(0x007b, 42, require('ZC_NOTIFY_MOVEENTRY'))
...
d:add(0x022b, 7, require('ZC_NOTIFY_NEWENTRY3'))
d:add(0x02ed, 97, require('ZC_NOTIFY_NEWENTRY4'))
d:add(0x008e, 7, require('ZC_NOTIFY_PLAYERCHAT'))
d:add(0x0087, 282, require('ZC_NOTIFY_PLAYERMOVE'))
...
d:add(0x0078, 22, require('ZC_NOTIFY_STANDENTRY'))
...
d:add(0x007f, 13, require('ZC_NOTIFY_TIME'))
...
d:add(0x0091, 14, require('ZC_NPCACK_MAPMOVE'))
...
d:add(0x00c7, 3, require('ZC_PC_SELL_ITEMLIST'))
...
d:add(0x00d2, 11, require('ZC_SETTING_WHISPER_STATE'))
d:add(0x01b3, 60, require('ZC_SHOW_IMAGE2'))
d:add(0x010f, -1, require('ZC_SKILLINFO_LIST'))
d:add(0x010e, 2, require('ZC_SKILLINFO_UPDATE'))
d:add(0x0120, 28, require('ZC_SKILL_DISAPPEAR'))
...
d:add(0x01e1, 43, require('ZC_SPIRITS2'))
d:add(0x01d7, 9, require('ZC_SPRITE_CHANGE2'))
...
d:add(0x00be, 54, require('ZC_STATUS_CHANGE'))
...
d:add(0x0226, 36, require('ZC_TAEKWON_RANK'))
...
d:add(0x016c, 54, require('ZC_UPDATE_GDID'))

...
function CZ_PC_PURCHASE_ITEMLIST.new(o)
	o = o or CZ_PC_PURCHASE_ITEMLIST
	setmetatable(o, self)
	self.__index = self
	return o
end

function CZ_PC_PURCHASE_ITEMLIST.deserialize(buf)

end

return CZ_PC_PURCHASE_ITEMLIST

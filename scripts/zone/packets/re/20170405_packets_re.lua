...
d:add(0x0865, 5, require('CZ_CHANGE_DIRECTION'))
d:add(0x0835, 5, require('CZ_COMMAND_MER'))
d:add(0x08a5, 19, require('CZ_ENTER'))
d:add(0x0363, 4, require('CZ_GANGSI_RANK'))
d:add(0x0860, -1, require('CZ_ITEMLISTWIN_RES'))
...
d:add(0x0281, 18, require('CZ_PARTY_BOOKING_REQ_REGISTER'))

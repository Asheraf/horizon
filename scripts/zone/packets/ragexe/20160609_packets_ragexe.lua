...
d:add(0x07ec, 5, require('CZ_CHANGE_DIRECTION'))
d:add(0x089b, 5, require('CZ_COMMAND_MER'))
d:add(0x0437, 19, require('CZ_ENTER'))
d:add(0x093b, 4, require('CZ_GANGSI_RANK'))
d:add(0x022d, -1, require('CZ_ITEMLISTWIN_RES'))
d:add(0x0899, 6, require('CZ_ITEM_PICKUP'))
d:add(0x094d, 6, require('CZ_ITEM_THROW'))
d:add(0x085c, 8, require('CZ_JOIN_BATTLE_FIELD'))
...
d:add(0x0889, -1, require('CZ_REQ_TRADE_BUYING_STORE'))

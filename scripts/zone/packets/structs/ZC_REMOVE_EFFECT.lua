...
if packet_version >= 20180919 then
	local pid = 0x0b0d
...
function ZC_REMOVE_EFFECT.new(o)
	o = o or ZC_REMOVE_EFFECT
	setmetatable(o, self)
	self.__index = self
	return o
end

function ZC_REMOVE_EFFECT.serialize()

end

return ZC_REMOVE_EFFECT

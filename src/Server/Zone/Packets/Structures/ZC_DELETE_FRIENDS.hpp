...
#ifndef HORIZON_ZONE_ZC_DELETE_FRIENDS_HPP
#define HORIZON_ZONE_ZC_DELETE_FRIENDS_HPP
 ...
 *
 */ 
class ZC_DELETE_FRIENDS : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_DELETE_FRIENDS(std::shared_ptr<ZoneSocket> sock);
	~ZC_DELETE_FRIENDS();
...
#endif /* HORIZON_ZONE_ZC_DELETE_FRIENDS_HPP */

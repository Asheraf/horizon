...
#ifndef HORIZON_ZONE_ZC_NOTIFY_NEWENTRY3_HPP
#define HORIZON_ZONE_ZC_NOTIFY_NEWENTRY3_HPP
 ...
 *
 */ 
class ZC_NOTIFY_NEWENTRY3 : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_NOTIFY_NEWENTRY3(std::shared_ptr<ZoneSocket> sock);
	~ZC_NOTIFY_NEWENTRY3();
...
#endif /* HORIZON_ZONE_ZC_NOTIFY_NEWENTRY3_HPP */

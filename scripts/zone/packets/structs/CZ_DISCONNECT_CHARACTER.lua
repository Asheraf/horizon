...
function CZ_DISCONNECT_CHARACTER.new(o)
	o = o or CZ_DISCONNECT_CHARACTER
	setmetatable(o, self)
	self.__index = self
	return o
end

function CZ_DISCONNECT_CHARACTER.serialize()

end

return CZ_DISCONNECT_CHARACTER

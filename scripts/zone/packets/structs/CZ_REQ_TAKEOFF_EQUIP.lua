...
function CZ_REQ_TAKEOFF_EQUIP.new(o)
	o = o or CZ_REQ_TAKEOFF_EQUIP
	setmetatable(o, self)
	self.__index = self
	return o
end

function CZ_REQ_TAKEOFF_EQUIP.deserialize(buf)

end

return CZ_REQ_TAKEOFF_EQUIP

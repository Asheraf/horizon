...
d:add(0x0365, 36, require('CZ_ACK_STORE_PASSWORD'))
d:add(0x093b, 26, require('CZ_ADD_FRIENDS'))
d:add(0x0930, 5, require('CZ_CHANGE_DIRECTION'))
d:add(0x088b, 5, require('CZ_COMMAND_MER'))
d:add(0x0925, 19, require('CZ_ENTER'))
d:add(0x088d, 4, require('CZ_GANGSI_RANK'))
d:add(0x092a, -1, require('CZ_ITEMLISTWIN_RES'))
d:add(0x086d, 6, require('CZ_ITEM_PICKUP'))
d:add(0x0939, 6, require('CZ_ITEM_THROW'))
d:add(0x0878, 8, require('CZ_JOIN_BATTLE_FIELD'))
d:add(0x0918, 8, require('CZ_MOVE_ITEM_FROM_BODY_TO_STORE'))
d:add(0x087f, 8, require('CZ_MOVE_ITEM_FROM_STORE_TO_BODY'))
d:add(0x092c, 18, require('CZ_PARTY_BOOKING_REQ_REGISTER'))

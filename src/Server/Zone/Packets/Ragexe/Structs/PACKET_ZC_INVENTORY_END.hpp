...
#ifndef HORIZON_ZONE_RAGEXE_PACKET_ZC_INVENTORY_END_HPP
#define HORIZON_ZONE_RAGEXE_PACKET_ZC_INVENTORY_END_HPP
...
#endif /* HORIZON_ZONE_RAGEXE_PACKET_ZC_INVENTORY_END_HPP */

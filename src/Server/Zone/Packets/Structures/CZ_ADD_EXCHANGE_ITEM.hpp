...
#ifndef HORIZON_ZONE_CZ_ADD_EXCHANGE_ITEM_HPP
#define HORIZON_ZONE_CZ_ADD_EXCHANGE_ITEM_HPP
...
enum {
	...
	ID_CZ_ADD_EXCHANGE_ITEM = 0x00e8
...
/**
 * @brief Main object for the aegis packet: CZ_ADD_EXCHANGE_ITEM
 * Size : 8 @ 0
 *
 */ 
class CZ_ADD_EXCHANGE_ITEM : public Base::NetworkPacket<ZoneSocket>
{
public:
	CZ_ADD_EXCHANGE_ITEM(std::shared_ptr<ZoneSocket> sock);
...
#endif /* HORIZON_ZONE_CZ_ADD_EXCHANGE_ITEM_HPP */

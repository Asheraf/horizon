...
#ifndef HORIZON_ZONE_ZC_BLACKSMITH_RANK_HPP
#define HORIZON_ZONE_ZC_BLACKSMITH_RANK_HPP
 ...
 *
 */ 
class ZC_BLACKSMITH_RANK : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_BLACKSMITH_RANK(std::shared_ptr<ZoneSocket> sock);
	~ZC_BLACKSMITH_RANK();
...
#endif /* HORIZON_ZONE_ZC_BLACKSMITH_RANK_HPP */

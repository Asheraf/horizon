...
function ZC_ACK_OPEN_ROULETTE.new(o)
	o = o or ZC_ACK_OPEN_ROULETTE
	setmetatable(o, self)
	self.__index = self
	return o
end

function ZC_ACK_OPEN_ROULETTE.serialize()

end

return ZC_ACK_OPEN_ROULETTE

...
#ifndef HORIZON_ZONE_ZC_ATTACK_FAILURE_FOR_DISTANCE_HPP
#define HORIZON_ZONE_ZC_ATTACK_FAILURE_FOR_DISTANCE_HPP
 ...
 *
 */ 
class ZC_ATTACK_FAILURE_FOR_DISTANCE : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_ATTACK_FAILURE_FOR_DISTANCE(std::shared_ptr<ZoneSocket> sock);
...
#endif /* HORIZON_ZONE_ZC_ATTACK_FAILURE_FOR_DISTANCE_HPP */

...
function CZ_REQ_ROLE_CHANGE.new(o)
	o = o or CZ_REQ_ROLE_CHANGE
	setmetatable(o, self)
	self.__index = self
	return o
end

function CZ_REQ_ROLE_CHANGE.deserialize(buf)

end

return CZ_REQ_ROLE_CHANGE

...
d:add(0x095a, 6, require('CZ_ITEM_PICKUP'))
d:add(0x0947, 6, require('CZ_ITEM_THROW'))
d:add(0x0918, 8, require('CZ_JOIN_BATTLE_FIELD'))
...
d:add(0x0940, 5, require('CZ_REQUEST_MOVE'))

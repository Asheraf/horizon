...
local CZ_SETTING_WHISPER_STATE = {
	_id = pid,
	_length = 0,
	_buffer = nil
}
...
function CZ_SETTING_WHISPER_STATE.new(o)
	o = o or CZ_SETTING_WHISPER_STATE
	setmetatable(o, self)
	self.__index = self
	return o
end

function CZ_SETTING_WHISPER_STATE.deserialize(buf)

end

return CZ_SETTING_WHISPER_STATE

...
#ifndef HORIZON_ZONE_CZ_PC_SELL_ITEMLIST_HPP
#define HORIZON_ZONE_CZ_PC_SELL_ITEMLIST_HPP
...
/**
 * @brief Main object for the aegis packet: CZ_PC_SELL_ITEMLIST
 * Size : -1 @ 0
 *
 */ 
class CZ_PC_SELL_ITEMLIST : public Base::NetworkPacket<ZoneSocket>
{
public:
	CZ_PC_SELL_ITEMLIST(std::shared_ptr<ZoneSocket> sock);
	~CZ_PC_SELL_ITEMLIST();
...
#endif /* HORIZON_ZONE_CZ_PC_SELL_ITEMLIST_HPP */

...
#ifndef HORIZON_ZONE_ZC_MEMBERMGR_INFO_HPP
#define HORIZON_ZONE_ZC_MEMBERMGR_INFO_HPP
 ...
 *
 */ 
class ZC_MEMBERMGR_INFO : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_MEMBERMGR_INFO(std::shared_ptr<ZoneSocket> sock);
	~ZC_MEMBERMGR_INFO();
...
#endif /* HORIZON_ZONE_ZC_MEMBERMGR_INFO_HPP */

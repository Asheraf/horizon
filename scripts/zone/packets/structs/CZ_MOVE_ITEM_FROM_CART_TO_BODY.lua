...
local CZ_MOVE_ITEM_FROM_CART_TO_BODY = {
	_id = pid,
	_length = 0,
	_buffer = nil
}
...
function CZ_MOVE_ITEM_FROM_CART_TO_BODY.new(o)
	o = o or CZ_MOVE_ITEM_FROM_CART_TO_BODY
	setmetatable(o, self)
	self.__index = self
	return o
end

function CZ_MOVE_ITEM_FROM_CART_TO_BODY.deserialize(buf)

end

return CZ_MOVE_ITEM_FROM_CART_TO_BODY

...
local CZ_REQ_COUNT_BARGAIN_SALE_ITEM = {
	_id = pid,
	_length = 0,
	_buffer = nil
}
...
function CZ_REQ_COUNT_BARGAIN_SALE_ITEM.new(o)
	o = o or CZ_REQ_COUNT_BARGAIN_SALE_ITEM
	setmetatable(o, self)
	self.__index = self
	return o
end

function CZ_REQ_COUNT_BARGAIN_SALE_ITEM.deserialize(buf)

end

return CZ_REQ_COUNT_BARGAIN_SALE_ITEM

...
function CZ_REQ_LEAVE_GUILD.new(o)
	o = o or CZ_REQ_LEAVE_GUILD
	setmetatable(o, self)
	self.__index = self
	return o
end

function CZ_REQ_LEAVE_GUILD.deserialize(buf)

end

return CZ_REQ_LEAVE_GUILD

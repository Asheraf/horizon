...
local ZC_SETTING_WHISPER_STATE = {
	_id = pid,
	_length = 0,
	_buffer = nil
}
...
function ZC_SETTING_WHISPER_STATE.new(o)
	o = o or ZC_SETTING_WHISPER_STATE
	setmetatable(o, self)
	self.__index = self
	return o
end

function ZC_SETTING_WHISPER_STATE.serialize()

end

return ZC_SETTING_WHISPER_STATE

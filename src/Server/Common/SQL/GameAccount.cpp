...
//		HLog(warn) <<"GameAccount::verify_credentials: {}", e.what());
//	}
//
//	return false;
//}
...
//		s.close();
//	} catch (const mysqlx::Error &e) {
//		HLog(warn) <<"GameAccount::verify_credentials_scrypt: {}", e.what());
//	}
//
//	return false;
//}
...
//		s.close();
//	} catch (const mysqlx::Error &e) {
//		HLog(warn) <<"GameAccount::load: {}", e.what());
//	}
//
//	return false;
//}
...
//		s.close();
//	} catch (const mysqlx::Error &e) {
//		HLog(warn) <<"GameAccount::update: {}", e.what());
//	}
//}

...
Horizon::Zone::Entities::Traits::BasicAttributeNotifier<NOTIFIABLE_TYPE, NOTIFIABLES ...>::notify(std::tuple<Tp...> &t)
{
...
template <status_point_type NOTIFIABLE_TYPE, class ... NOTIFIABLES>
void Horizon::Zone::Entities::Traits::BasicAttributeNotifier<NOTIFIABLE_TYPE, NOTIFIABLES ...>::notify_sum()
{
	using namespace Horizon::Zone::Entities;
	std::shared_ptr<Entity> entity = get_entity();
...
void Horizon::Zone::Entities::Traits::ExperienceNotifier<NOTIFIABLE_TYPE, NOTIFIABLE>::notify()
{
	using namespace Horizon::Zone::Entities;
...
template <status_point_type NOTIFIABLE_TYPE, class NOTIFIABLE>
void Horizon::Zone::Entities::Traits::StatusPointRequirementNotifier<NOTIFIABLE_TYPE, NOTIFIABLE>::notify()
{
	using namespace Horizon::Zone::Entities;
	std::shared_ptr<typename NOTIFIABLE::element_type> notifiable = _notifiable.lock();
	std::shared_ptr<Entity> entity = get_entity();
...
template <status_point_type NOTIFIABLE_TYPE, class NOTIFIABLE>
void Horizon::Zone::Entities::Traits::StatusPointNotifier<NOTIFIABLE_TYPE, NOTIFIABLE>::notify()
{
	using namespace Horizon::Zone::Entities;
	std::shared_ptr<typename NOTIFIABLE::element_type> notifiable = _notifiable.lock();
	std::shared_ptr<Entity> entity = get_entity();
...
template <status_point_type NOTIFIABLE_TYPE, class NOTIFIABLE>
void Horizon::Zone::Entities::Traits::AttackRangeNotifier<NOTIFIABLE_TYPE, NOTIFIABLE>::notify()
{
	using namespace Horizon::Zone::Entities;
	std::shared_ptr<typename NOTIFIABLE::element_type> notifiable = _notifiable.lock();
	std::shared_ptr<Entity> entity = get_entity();

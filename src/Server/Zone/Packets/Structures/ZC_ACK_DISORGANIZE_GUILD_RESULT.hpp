...
#ifndef HORIZON_ZONE_ZC_ACK_DISORGANIZE_GUILD_RESULT_HPP
#define HORIZON_ZONE_ZC_ACK_DISORGANIZE_GUILD_RESULT_HPP
 ...
 *
 */ 
class ZC_ACK_DISORGANIZE_GUILD_RESULT : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_ACK_DISORGANIZE_GUILD_RESULT(std::shared_ptr<ZoneSocket> sock);
...
#endif /* HORIZON_ZONE_ZC_ACK_DISORGANIZE_GUILD_RESULT_HPP */

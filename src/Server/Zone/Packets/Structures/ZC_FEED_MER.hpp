...
#ifndef HORIZON_ZONE_ZC_FEED_MER_HPP
#define HORIZON_ZONE_ZC_FEED_MER_HPP
 ...
 *
 */ 
class ZC_FEED_MER : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_FEED_MER(std::shared_ptr<ZoneSocket> sock);
	~ZC_FEED_MER();
...
#endif /* HORIZON_ZONE_ZC_FEED_MER_HPP */

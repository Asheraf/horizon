...
#ifndef HORIZON_ZONE_CZ_REQ_ROLE_CHANGE_HPP
#define HORIZON_ZONE_CZ_REQ_ROLE_CHANGE_HPP
...
/**
 * @brief Main object for the aegis packet: CZ_REQ_ROLE_CHANGE
 * Size : 30 @ 0
 *
 */ 
class CZ_REQ_ROLE_CHANGE : public Base::NetworkPacket<ZoneSocket>
{
public:
	CZ_REQ_ROLE_CHANGE(std::shared_ptr<ZoneSocket> sock);
	~CZ_REQ_ROLE_CHANGE();
...
#endif /* HORIZON_ZONE_CZ_REQ_ROLE_CHANGE_HPP */

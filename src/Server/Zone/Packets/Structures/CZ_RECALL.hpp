...
#ifndef HORIZON_ZONE_CZ_RECALL_HPP
#define HORIZON_ZONE_CZ_RECALL_HPP
...
/**
 * @brief Main object for the aegis packet: CZ_RECALL
 * Size : 26 @ 0
 *
 */ 
class CZ_RECALL : public Base::NetworkPacket<ZoneSocket>
{
public:
	CZ_RECALL(std::shared_ptr<ZoneSocket> sock);
	~CZ_RECALL();
...
#endif /* HORIZON_ZONE_CZ_RECALL_HPP */

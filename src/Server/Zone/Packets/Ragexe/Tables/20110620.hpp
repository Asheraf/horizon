...
#ifndef HORIZON_ZONE_SHUFFLE_PACKET_LENGTH_TABLE_20110620
#define HORIZON_ZONE_SHUFFLE_PACKET_LENGTH_TABLE_20110620
...
#define ADD_PKT(i, j, k) _packet_length_table.insert(i, std::make_pair<uint16_t, NetworkPacket>(j, k))
		...
		ADD_PKT(0x0361, 4, CZ_CHANGE_DIRECTION2(sock));
		...
		ADD_PKT(0x083c, 6, CZ_SSILIST_ITEM_CLICK(sock));
		ADD_PKT(0x0438, 18, CZ_USE_SKILL2(sock));
...
#endif /* HORIZON_ZONE_SHUFFLE_PACKET_LENGTH_TABLE_20110620 */
...
if packet_version >= 20131023 then
	local pid = 0x09d9
...
function CZ_REQ_GUILDSTORAGE_LOG.new(o)
	o = o or CZ_REQ_GUILDSTORAGE_LOG
	setmetatable(o, self)
	self.__index = self
	return o
end

function CZ_REQ_GUILDSTORAGE_LOG.deserialize(buf)

end

return CZ_REQ_GUILDSTORAGE_LOG

...
#ifndef HORIZON_ZONE_ZC_MAKABLEITEMLIST_HPP
#define HORIZON_ZONE_ZC_MAKABLEITEMLIST_HPP
 ...
 *
 */ 
class ZC_MAKABLEITEMLIST : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_MAKABLEITEMLIST(std::shared_ptr<ZoneSocket> sock);
	~ZC_MAKABLEITEMLIST();
...
#endif /* HORIZON_ZONE_ZC_MAKABLEITEMLIST_HPP */

...
elseif packet_version >= 20180103 then
	local pid = 0x02b8
elseif packet_version >= 20070604 then
	local pid = 0x02b8
elseif packet_version >= 0 then
	local pid = 0x02b8
end

local ZC_ITEM_PICKUP_PARTY = {
	_id = pid,
	_length = 0,
	_buffer = nil
}
...
function ZC_ITEM_PICKUP_PARTY.new(o)
	o = o or ZC_ITEM_PICKUP_PARTY
	setmetatable(o, self)
	self.__index = self
	return o
end

function ZC_ITEM_PICKUP_PARTY.serialize()

end

return ZC_ITEM_PICKUP_PARTY

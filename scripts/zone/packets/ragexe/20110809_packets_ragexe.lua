...
d:add(0x0281, 18, require('CZ_GANGSI_RANK'))
...
d:add(0x083c, 5, require('CZ_SSILIST_ITEM_CLICK'))
...
d:add(0x08ce, 2, require('ZC_FAILED_GET_ITEM_FROM_ZONEDA'))
d:add(0x08d2, 10, require('ZC_FASTMOVE'))
d:add(0x08d1, 7, require('ZC_REQ_TAKEOFF_EQUIP_ACK2'))
d:add(0x08d0, 9, require('ZC_REQ_WEAR_EQUIP_ACK2'))
d:add(0x08cf, 10, require('ZC_SPIRITS_ATTRIBUTE'))

...
#ifndef HORIZON_ZONE_ZC_DISPEL_HPP
#define HORIZON_ZONE_ZC_DISPEL_HPP
 ...
 *
 */ 
class ZC_DISPEL : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_DISPEL(std::shared_ptr<ZoneSocket> sock);
	~ZC_DISPEL();
...
#endif /* HORIZON_ZONE_ZC_DISPEL_HPP */

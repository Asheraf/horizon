...
#ifndef HORIZON_ZONE_ZC_SETTING_WHISPER_STATE_HPP
#define HORIZON_ZONE_ZC_SETTING_WHISPER_STATE_HPP
 ...
 *
 */ 
class ZC_SETTING_WHISPER_STATE : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_SETTING_WHISPER_STATE(std::shared_ptr<ZoneSocket> sock);
...
#endif /* HORIZON_ZONE_ZC_SETTING_WHISPER_STATE_HPP */

...
#ifndef HORIZON_ZONE_CZ_REMEMBER_WARPPOINT_HPP
#define HORIZON_ZONE_CZ_REMEMBER_WARPPOINT_HPP
...
enum {
	...
	ID_CZ_REMEMBER_WARPPOINT = 0x011d
...
/**
 * @brief Main object for the aegis packet: CZ_REMEMBER_WARPPOINT
 * Size : 2 @ 0
 *
 */ 
class CZ_REMEMBER_WARPPOINT : public Base::NetworkPacket<ZoneSocket>
{
public:
	CZ_REMEMBER_WARPPOINT(std::shared_ptr<ZoneSocket> sock);
...
#endif /* HORIZON_ZONE_CZ_REMEMBER_WARPPOINT_HPP */

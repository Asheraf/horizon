...
#ifndef HORIZON_ZONE_ZC_ACK_BAN_GUILD_HPP
#define HORIZON_ZONE_ZC_ACK_BAN_GUILD_HPP
 ...
 *
 */ 
class ZC_ACK_BAN_GUILD : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_ACK_BAN_GUILD(std::shared_ptr<ZoneSocket> sock);
	~ZC_ACK_BAN_GUILD();
...
#endif /* HORIZON_ZONE_ZC_ACK_BAN_GUILD_HPP */

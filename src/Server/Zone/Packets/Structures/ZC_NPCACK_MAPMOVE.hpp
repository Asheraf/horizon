...
#ifndef HORIZON_ZONE_ZC_NPCACK_MAPMOVE_HPP
#define HORIZON_ZONE_ZC_NPCACK_MAPMOVE_HPP
 ...
 *
 */ 
class ZC_NPCACK_MAPMOVE : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_NPCACK_MAPMOVE(std::shared_ptr<ZoneSocket> sock);
	~ZC_NPCACK_MAPMOVE();
...
#endif /* HORIZON_ZONE_ZC_NPCACK_MAPMOVE_HPP */

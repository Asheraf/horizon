...
#ifndef HORIZON_ZONE_ZC_ACK_ITEMREPAIR_HPP
#define HORIZON_ZONE_ZC_ACK_ITEMREPAIR_HPP
 ...
 *
 */ 
class ZC_ACK_ITEMREPAIR : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_ACK_ITEMREPAIR(std::shared_ptr<ZoneSocket> sock);
	~ZC_ACK_ITEMREPAIR();
...
#endif /* HORIZON_ZONE_ZC_ACK_ITEMREPAIR_HPP */

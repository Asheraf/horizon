...
#ifndef HORIZON_ZONE_CZ_CHOOSE_MENU_HPP
#define HORIZON_ZONE_CZ_CHOOSE_MENU_HPP
...
/**
 * @brief Main object for the aegis packet: CZ_CHOOSE_MENU
 * Size : 7 @ 0
 *
 */ 
class CZ_CHOOSE_MENU : public Base::NetworkPacket<ZoneSocket>
{
public:
	CZ_CHOOSE_MENU(std::shared_ptr<ZoneSocket> sock);
	~CZ_CHOOSE_MENU();
...
#endif /* HORIZON_ZONE_CZ_CHOOSE_MENU_HPP */

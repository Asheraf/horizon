...
function ZC_ACK_CREATE_CHATROOM.new(o)
	o = o or ZC_ACK_CREATE_CHATROOM
	setmetatable(o, self)
	self.__index = self
	return o
end

function ZC_ACK_CREATE_CHATROOM.serialize()

end

return ZC_ACK_CREATE_CHATROOM

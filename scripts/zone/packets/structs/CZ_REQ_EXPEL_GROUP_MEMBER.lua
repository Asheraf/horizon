...
local CZ_REQ_EXPEL_GROUP_MEMBER = {
	_id = pid,
	_length = 0,
	_buffer = nil
}
...
function CZ_REQ_EXPEL_GROUP_MEMBER.new(o)
	o = o or CZ_REQ_EXPEL_GROUP_MEMBER
	setmetatable(o, self)
	self.__index = self
	return o
end

function CZ_REQ_EXPEL_GROUP_MEMBER.deserialize(buf)

end

return CZ_REQ_EXPEL_GROUP_MEMBER

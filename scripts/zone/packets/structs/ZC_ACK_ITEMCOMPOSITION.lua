...
function ZC_ACK_ITEMCOMPOSITION.new(o)
	o = o or ZC_ACK_ITEMCOMPOSITION
	setmetatable(o, self)
	self.__index = self
	return o
end

function ZC_ACK_ITEMCOMPOSITION.serialize()

end

return ZC_ACK_ITEMCOMPOSITION

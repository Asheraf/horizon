...
local CZ_SIMPLE_BUY_CASH_POINT_ITEM = {
	_id = pid,
	_length = 0,
	_buffer = nil
}
...
function CZ_SIMPLE_BUY_CASH_POINT_ITEM.new(o)
	o = o or CZ_SIMPLE_BUY_CASH_POINT_ITEM
	setmetatable(o, self)
	self.__index = self
	return o
end

function CZ_SIMPLE_BUY_CASH_POINT_ITEM.deserialize(buf)

end

return CZ_SIMPLE_BUY_CASH_POINT_ITEM

...
#ifndef HORIZON_ZONE_ZC_NOTIFY_ACT_HPP
#define HORIZON_ZONE_ZC_NOTIFY_ACT_HPP
 ...
 *
 */ 
class ZC_NOTIFY_ACT : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_NOTIFY_ACT(std::shared_ptr<ZoneSocket> sock);
	~ZC_NOTIFY_ACT();
...
#endif /* HORIZON_ZONE_ZC_NOTIFY_ACT_HPP */

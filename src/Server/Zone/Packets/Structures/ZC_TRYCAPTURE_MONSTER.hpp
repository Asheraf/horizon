...
#ifndef HORIZON_ZONE_ZC_TRYCAPTURE_MONSTER_HPP
#define HORIZON_ZONE_ZC_TRYCAPTURE_MONSTER_HPP
 ...
 *
 */ 
class ZC_TRYCAPTURE_MONSTER : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_TRYCAPTURE_MONSTER(std::shared_ptr<ZoneSocket> sock);
...
#endif /* HORIZON_ZONE_ZC_TRYCAPTURE_MONSTER_HPP */

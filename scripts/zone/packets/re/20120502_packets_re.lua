...
d:add(0x097d, 288, require('ZC_ACK_RANKING'))
d:add(0x091b, 2, require('ZC_PRNPC_STATE'))
d:add(0x097f, -1, require('ZC_SELECTCART'))
d:add(0x097e, 12, require('ZC_UPDATE_RANKING_POINT'))

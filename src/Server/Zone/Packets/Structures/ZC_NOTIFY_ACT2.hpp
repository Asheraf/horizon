...
#ifndef HORIZON_ZONE_ZC_NOTIFY_ACT2_HPP
#define HORIZON_ZONE_ZC_NOTIFY_ACT2_HPP
 ...
 *
 */ 
class ZC_NOTIFY_ACT2 : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_NOTIFY_ACT2(std::shared_ptr<ZoneSocket> sock);
	~ZC_NOTIFY_ACT2();
...
#endif /* HORIZON_ZONE_ZC_NOTIFY_ACT2_HPP */

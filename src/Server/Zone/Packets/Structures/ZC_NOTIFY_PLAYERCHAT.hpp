...
#ifndef HORIZON_ZONE_ZC_NOTIFY_PLAYERCHAT_HPP
#define HORIZON_ZONE_ZC_NOTIFY_PLAYERCHAT_HPP
 ...
 *
 */ 
class ZC_NOTIFY_PLAYERCHAT : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_NOTIFY_PLAYERCHAT(std::shared_ptr<ZoneSocket> sock);
...
#endif /* HORIZON_ZONE_ZC_NOTIFY_PLAYERCHAT_HPP */

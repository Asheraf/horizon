...
if packet_version >= 20090204 then
	local pid = 0x0122
...
local ZC_CART_EQUIPMENT_ITEMLIST = {
	_id = pid,
	_length = 0,
	_buffer = nil
}
...
function ZC_CART_EQUIPMENT_ITEMLIST.new(o)
	o = o or ZC_CART_EQUIPMENT_ITEMLIST
	setmetatable(o, self)
	self.__index = self
	return o
end

function ZC_CART_EQUIPMENT_ITEMLIST.serialize()

end

return ZC_CART_EQUIPMENT_ITEMLIST

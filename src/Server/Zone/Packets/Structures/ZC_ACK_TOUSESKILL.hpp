...
#ifndef HORIZON_ZONE_ZC_ACK_TOUSESKILL_HPP
#define HORIZON_ZONE_ZC_ACK_TOUSESKILL_HPP
 ...
 *
 */ 
class ZC_ACK_TOUSESKILL : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_ACK_TOUSESKILL(std::shared_ptr<ZoneSocket> sock);
	~ZC_ACK_TOUSESKILL();
...
#endif /* HORIZON_ZONE_ZC_ACK_TOUSESKILL_HPP */

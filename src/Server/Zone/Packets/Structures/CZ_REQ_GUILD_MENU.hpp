...
#ifndef HORIZON_ZONE_CZ_REQ_GUILD_MENU_HPP
#define HORIZON_ZONE_CZ_REQ_GUILD_MENU_HPP
...
/**
 * @brief Main object for the aegis packet: CZ_REQ_GUILD_MENU
 * Size : 6 @ 0
 *
 */ 
class CZ_REQ_GUILD_MENU : public Base::NetworkPacket<ZoneSocket>
{
public:
	CZ_REQ_GUILD_MENU(std::shared_ptr<ZoneSocket> sock);
	~CZ_REQ_GUILD_MENU();
...
#endif /* HORIZON_ZONE_CZ_REQ_GUILD_MENU_HPP */

...
d:add(0x0118, 33, require('CZ_CANCEL_LOCKON'))
...
d:add(0x022d, 14, require('CZ_COMMAND_MER'))
d:add(0x01a1, -1, require('CZ_COMMAND_PET'))
d:add(0x00eb, 14, require('CZ_CONCLUDE_EXCHANGE_ITEM'))
...
d:add(0x00cc, 5, require('CZ_DISCONNECT_CHARACTER'))
d:add(0x01e7, 15, require('CZ_DORIDORI'))
d:add(0x0436, -1, require('CZ_ENTER2'))
d:add(0x00ef, 39, require('CZ_EXEC_EXCHANGE_ITEM'))
...
d:add(0x0129, 22, require('CZ_MOVE_ITEM_FROM_CART_TO_STORE'))
d:add(0x0365, 4, require('CZ_MOVE_ITEM_FROM_STORE_TO_BODY2'))
d:add(0x0128, 6, require('CZ_MOVE_ITEM_FROM_STORE_TO_CART'))
d:add(0x007d, 282, require('CZ_NOTIFY_ACTORINIT'))
d:add(0x00c8, 42, require('CZ_PC_PURCHASE_ITEMLIST'))
...
d:add(0x0360, 29, require('CZ_REQUEST_TIME2'))
d:add(0x0170, 79, require('CZ_REQ_ALLY_GUILD'))
...
d:add(0x012e, 65, require('CZ_REQ_CLOSESTORE'))
d:add(0x018a, 8, require('CZ_REQ_DISCONNECT'))
d:add(0x00bf, 86, require('CZ_REQ_EMOTION'))
...
d:add(0x00d6, 18, require('ZC_ACK_CREATE_CHATROOM'))
...
d:add(0x0194, 12, require('ZC_ACK_REQNAME_BYGID'))
...
d:add(0x01e9, 17, require('ZC_ADD_MEMBER_TO_GROUP2'))
...
d:add(0x00ee, 16, require('ZC_CANCEL_EXCHANGE_ITEM'))
d:add(0x0122, 9, require('ZC_CART_EQUIPMENT_ITEMLIST'))
...
d:add(0x00a4, 54, require('ZC_EQUIPMENT_ITEMLIST'))
d:add(0x0295, -1, require('ZC_EQUIPMENT_ITEMLIST2'))
d:add(0x013c, 5, require('ZC_EQUIP_ARROW'))
d:add(0x00f0, 26, require('ZC_EXEC_EXCHANGE_ITEM'))
d:add(0x022f, 2, require('ZC_FEED_MER'))
...
d:add(0x00fb, 282, require('ZC_GROUP_LIST'))
d:add(0x017f, 30, require('ZC_GUILD_CHAT'))
d:add(0x01b6, 16, require('ZC_GUILD_INFO2'))
...
d:add(0x0239, 7, require('ZC_HOSKILLINFO_UPDATE'))
...
d:add(0x02e1, 7, require('ZC_NOTIFY_ACT2'))
...
d:add(0x0109, 11, require('ZC_NOTIFY_CHAT_PARTY'))
...
d:add(0x008e, 60, require('ZC_NOTIFY_PLAYERCHAT'))
...
d:add(0x0114, 60, require('ZC_NOTIFY_SKILL'))
...
d:add(0x0287, 29, require('ZC_PC_CASH_POINT_ITEMLIST'))
...
d:add(0x01c9, 32, require('ZC_SKILL_ENTRY2'))
...
d:add(0x00a5, 24, require('ZC_STORE_NORMAL_ITEMLIST'))
...
d:add(0x0097, 37, require('ZC_WHISPER'))

...
elseif packet_version >= 20180103 then
	local pid = 0x084b
elseif packet_version >= 20101019 then
	local pid = 0x084b
elseif packet_version >= 0 then
	local pid = 0x084b
end

local ZC_ITEM_FALL_ENTRY4 = {
	_id = pid,
	_length = 0,
	_buffer = nil
}
...
function ZC_ITEM_FALL_ENTRY4.new(o)
	o = o or ZC_ITEM_FALL_ENTRY4
	setmetatable(o, self)
	self.__index = self
	return o
end

function ZC_ITEM_FALL_ENTRY4.serialize()

end

return ZC_ITEM_FALL_ENTRY4

...
d:add(0x0924, 5, require('CZ_CHANGE_DIRECTION'))
d:add(0x0817, 5, require('CZ_COMMAND_MER'))
d:add(0x0363, 19, require('CZ_ENTER'))
d:add(0x0927, 4, require('CZ_GANGSI_RANK'))
d:add(0x0960, -1, require('CZ_ITEMLISTWIN_RES'))
d:add(0x0958, 6, require('CZ_ITEM_PICKUP'))
d:add(0x0885, 6, require('CZ_ITEM_THROW'))
d:add(0x02c4, 8, require('CZ_JOIN_BATTLE_FIELD'))

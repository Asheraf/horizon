...
#ifndef HORIZON_CHAR_HC_UPDATE_CHARINFO_HPP
#define HORIZON_CHAR_HC_UPDATE_CHARINFO_HPP
 ...
 *
 */ 
class HC_UPDATE_CHARINFO : public Base::NetworkPacket<CharSocket>
{
public:
	HC_UPDATE_CHARINFO(std::shared_ptr<CharSocket> sock);
	~HC_UPDATE_CHARINFO();
...
#endif /* HORIZON_CHAR_HC_UPDATE_CHARINFO_HPP */

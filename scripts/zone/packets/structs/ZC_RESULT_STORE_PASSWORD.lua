...
local ZC_RESULT_STORE_PASSWORD = {
	_id = pid,
	_length = 0,
	_buffer = nil
}
...
function ZC_RESULT_STORE_PASSWORD.new(o)
	o = o or ZC_RESULT_STORE_PASSWORD
	setmetatable(o, self)
	self.__index = self
	return o
end

function ZC_RESULT_STORE_PASSWORD.serialize()

end

return ZC_RESULT_STORE_PASSWORD

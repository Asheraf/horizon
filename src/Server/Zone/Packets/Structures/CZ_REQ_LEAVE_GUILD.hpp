...
#ifndef HORIZON_ZONE_CZ_REQ_LEAVE_GUILD_HPP
#define HORIZON_ZONE_CZ_REQ_LEAVE_GUILD_HPP
...
/**
 * @brief Main object for the aegis packet: CZ_REQ_LEAVE_GUILD
 * Size : 54 @ 0
 *
 */ 
class CZ_REQ_LEAVE_GUILD : public Base::NetworkPacket<ZoneSocket>
{
public:
	CZ_REQ_LEAVE_GUILD(std::shared_ptr<ZoneSocket> sock);
	~CZ_REQ_LEAVE_GUILD();
...
#endif /* HORIZON_ZONE_CZ_REQ_LEAVE_GUILD_HPP */

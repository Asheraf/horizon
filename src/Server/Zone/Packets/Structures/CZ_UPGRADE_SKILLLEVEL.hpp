...
#ifndef HORIZON_ZONE_CZ_UPGRADE_SKILLLEVEL_HPP
#define HORIZON_ZONE_CZ_UPGRADE_SKILLLEVEL_HPP
...
enum {
	...
	ID_CZ_UPGRADE_SKILLLEVEL = 0x0112
...
/**
 * @brief Main object for the aegis packet: CZ_UPGRADE_SKILLLEVEL
 * Size : 4 @ 0
 *
 */ 
class CZ_UPGRADE_SKILLLEVEL : public Base::NetworkPacket<ZoneSocket>
{
public:
	CZ_UPGRADE_SKILLLEVEL(std::shared_ptr<ZoneSocket> sock);
...
#endif /* HORIZON_ZONE_CZ_UPGRADE_SKILLLEVEL_HPP */

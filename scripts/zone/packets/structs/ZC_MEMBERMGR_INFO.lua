...
if packet_version >= 20161026 then
	local pid = 0x0aa5
...
function ZC_MEMBERMGR_INFO.new(o)
	o = o or ZC_MEMBERMGR_INFO
	setmetatable(o, self)
	self.__index = self
	return o
end

function ZC_MEMBERMGR_INFO.serialize()

end

return ZC_MEMBERMGR_INFO

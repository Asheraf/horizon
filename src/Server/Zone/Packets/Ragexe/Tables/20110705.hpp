...
#ifndef HORIZON_ZONE_SHUFFLE_PACKET_LENGTH_TABLE_20110705
#define HORIZON_ZONE_SHUFFLE_PACKET_LENGTH_TABLE_20110705
...
#define ADD_PKT(i, j, k) _packet_length_table.insert(i, std::make_pair<uint16_t, NetworkPacket>(j, k))
		...
		ADD_PKT(0x0281, 6, CZ_GANGSI_RANK(sock));
		ADD_PKT(0x07e4, 8, CZ_ITEMLISTWIN_RES(sock));
		...
		ADD_PKT(0x0802, 7, CZ_PARTY_BOOKING_REQ_REGISTER(sock));
		ADD_PKT(0x02c4, 4, CZ_PARTY_JOIN_REQ(sock));
		ADD_PKT(0x0369, 18, CZ_REQNAME_BYGID2(sock));
		...
		ADD_PKT(0x0835, 36, CZ_SEARCH_STORE_INFO(sock));
...
#endif /* HORIZON_ZONE_SHUFFLE_PACKET_LENGTH_TABLE_20110705 */
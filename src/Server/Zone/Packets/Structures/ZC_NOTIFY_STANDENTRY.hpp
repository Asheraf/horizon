...
#ifndef HORIZON_ZONE_ZC_NOTIFY_STANDENTRY_HPP
#define HORIZON_ZONE_ZC_NOTIFY_STANDENTRY_HPP
 ...
 *
 */ 
class ZC_NOTIFY_STANDENTRY : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_NOTIFY_STANDENTRY(std::shared_ptr<ZoneSocket> sock);
...
#endif /* HORIZON_ZONE_ZC_NOTIFY_STANDENTRY_HPP */

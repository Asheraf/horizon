...
#ifndef HORIZON_ZONE_CZ_PC_PURCHASE_ITEMLIST_FROMMC_HPP
#define HORIZON_ZONE_CZ_PC_PURCHASE_ITEMLIST_FROMMC_HPP
...
enum {
	...
	ID_CZ_PC_PURCHASE_ITEMLIST_FROMMC = 0x0134
...
/**
 * @brief Main object for the aegis packet: CZ_PC_PURCHASE_ITEMLIST_FROMMC
 * Size : -1 @ 0
 *
 */ 
class CZ_PC_PURCHASE_ITEMLIST_FROMMC : public Base::NetworkPacket<ZoneSocket>
{
public:
	CZ_PC_PURCHASE_ITEMLIST_FROMMC(std::shared_ptr<ZoneSocket> sock);
...
#endif /* HORIZON_ZONE_CZ_PC_PURCHASE_ITEMLIST_FROMMC_HPP */

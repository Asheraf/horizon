...
local ZC_NOTIFY_BARGAIN_SALE_SELLING = {
	_id = pid,
	_length = 0,
	_buffer = nil
}
...
function ZC_NOTIFY_BARGAIN_SALE_SELLING.new(o)
	o = o or ZC_NOTIFY_BARGAIN_SALE_SELLING
	setmetatable(o, self)
	self.__index = self
	return o
end

function ZC_NOTIFY_BARGAIN_SALE_SELLING.serialize()

end

return ZC_NOTIFY_BARGAIN_SALE_SELLING

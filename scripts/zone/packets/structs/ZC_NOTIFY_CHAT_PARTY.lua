...
function ZC_NOTIFY_CHAT_PARTY.new(o)
	o = o or ZC_NOTIFY_CHAT_PARTY
	setmetatable(o, self)
	self.__index = self
	return o
end

function ZC_NOTIFY_CHAT_PARTY.serialize()

end

return ZC_NOTIFY_CHAT_PARTY

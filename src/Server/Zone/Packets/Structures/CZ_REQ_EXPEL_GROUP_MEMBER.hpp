...
#ifndef HORIZON_ZONE_CZ_REQ_EXPEL_GROUP_MEMBER_HPP
#define HORIZON_ZONE_CZ_REQ_EXPEL_GROUP_MEMBER_HPP
...
enum {
	...
	ID_CZ_REQ_EXPEL_GROUP_MEMBER = 0x0103
...
/**
 * @brief Main object for the aegis packet: CZ_REQ_EXPEL_GROUP_MEMBER
 * Size : 30 @ 0
 *
 */ 
class CZ_REQ_EXPEL_GROUP_MEMBER : public Base::NetworkPacket<ZoneSocket>
{
public:
	CZ_REQ_EXPEL_GROUP_MEMBER(std::shared_ptr<ZoneSocket> sock);
...
#endif /* HORIZON_ZONE_CZ_REQ_EXPEL_GROUP_MEMBER_HPP */

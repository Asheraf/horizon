...
#ifndef HORIZON_ZONE_CZ_REQ_ALLY_GUILD_HPP
#define HORIZON_ZONE_CZ_REQ_ALLY_GUILD_HPP
...
/**
 * @brief Main object for the aegis packet: CZ_REQ_ALLY_GUILD
 * Size : 14 @ 0
 *
 */ 
class CZ_REQ_ALLY_GUILD : public Base::NetworkPacket<ZoneSocket>
{
public:
	CZ_REQ_ALLY_GUILD(std::shared_ptr<ZoneSocket> sock);
	~CZ_REQ_ALLY_GUILD();
...
#endif /* HORIZON_ZONE_CZ_REQ_ALLY_GUILD_HPP */

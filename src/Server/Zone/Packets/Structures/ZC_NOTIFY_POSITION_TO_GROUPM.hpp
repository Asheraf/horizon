...
#ifndef HORIZON_ZONE_ZC_NOTIFY_POSITION_TO_GROUPM_HPP
#define HORIZON_ZONE_ZC_NOTIFY_POSITION_TO_GROUPM_HPP
 ...
 *
 */ 
class ZC_NOTIFY_POSITION_TO_GROUPM : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_NOTIFY_POSITION_TO_GROUPM(std::shared_ptr<ZoneSocket> sock);
...
#endif /* HORIZON_ZONE_ZC_NOTIFY_POSITION_TO_GROUPM_HPP */

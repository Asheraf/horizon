...
#ifndef HORIZON_ZONE_CZ_REQ_EMOTION_HPP
#define HORIZON_ZONE_CZ_REQ_EMOTION_HPP
...
/**
 * @brief Main object for the aegis packet: CZ_REQ_EMOTION
 * Size : 3 @ 0
 *
 */ 
class CZ_REQ_EMOTION : public Base::NetworkPacket<ZoneSocket>
{
public:
	CZ_REQ_EMOTION(std::shared_ptr<ZoneSocket> sock);
	~CZ_REQ_EMOTION();
...
#endif /* HORIZON_ZONE_CZ_REQ_EMOTION_HPP */

...
#ifndef HORIZON_ZONE_ZC_ACK_REMEMBER_WARPPOINT_HPP
#define HORIZON_ZONE_ZC_ACK_REMEMBER_WARPPOINT_HPP
 ...
 *
 */ 
class ZC_ACK_REMEMBER_WARPPOINT : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_ACK_REMEMBER_WARPPOINT(std::shared_ptr<ZoneSocket> sock);
...
#endif /* HORIZON_ZONE_ZC_ACK_REMEMBER_WARPPOINT_HPP */

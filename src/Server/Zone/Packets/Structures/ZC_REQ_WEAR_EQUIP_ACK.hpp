...
#ifndef HORIZON_ZONE_ZC_REQ_WEAR_EQUIP_ACK_HPP
#define HORIZON_ZONE_ZC_REQ_WEAR_EQUIP_ACK_HPP
 ...
 *
 */ 
class ZC_REQ_WEAR_EQUIP_ACK : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_REQ_WEAR_EQUIP_ACK(std::shared_ptr<ZoneSocket> sock);
...
#endif /* HORIZON_ZONE_ZC_REQ_WEAR_EQUIP_ACK_HPP */

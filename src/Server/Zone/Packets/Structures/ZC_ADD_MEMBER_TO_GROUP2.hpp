...
#ifndef HORIZON_ZONE_ZC_ADD_MEMBER_TO_GROUP2_HPP
#define HORIZON_ZONE_ZC_ADD_MEMBER_TO_GROUP2_HPP
 ...
 *
 */ 
class ZC_ADD_MEMBER_TO_GROUP2 : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_ADD_MEMBER_TO_GROUP2(std::shared_ptr<ZoneSocket> sock);
...
#endif /* HORIZON_ZONE_ZC_ADD_MEMBER_TO_GROUP2_HPP */

...
#ifndef HORIZON_ZONE_CZ_REQ_ITEMCOMPOSITION_LIST_HPP
#define HORIZON_ZONE_CZ_REQ_ITEMCOMPOSITION_LIST_HPP
...
enum {
	...
	ID_CZ_REQ_ITEMCOMPOSITION_LIST = 0x017a
...
/**
 * @brief Main object for the aegis packet: CZ_REQ_ITEMCOMPOSITION_LIST
 * Size : 4 @ 0
 *
 */ 
class CZ_REQ_ITEMCOMPOSITION_LIST : public Base::NetworkPacket<ZoneSocket>
{
public:
	CZ_REQ_ITEMCOMPOSITION_LIST(std::shared_ptr<ZoneSocket> sock);
...
#endif /* HORIZON_ZONE_CZ_REQ_ITEMCOMPOSITION_LIST_HPP */

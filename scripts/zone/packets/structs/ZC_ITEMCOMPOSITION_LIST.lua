...
function ZC_ITEMCOMPOSITION_LIST.new(o)
	o = o or ZC_ITEMCOMPOSITION_LIST
	setmetatable(o, self)
	self.__index = self
	return o
end

function ZC_ITEMCOMPOSITION_LIST.serialize()

end

return ZC_ITEMCOMPOSITION_LIST

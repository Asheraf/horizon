...
d:add(0x0865, 36, require('CZ_ACK_STORE_PASSWORD'))
d:add(0x089b, 26, require('CZ_ADD_FRIENDS'))
d:add(0x08a7, 5, require('CZ_CHANGE_DIRECTION'))
d:add(0x092d, 5, require('CZ_COMMAND_MER'))
d:add(0x0966, 19, require('CZ_ENTER'))
d:add(0x095b, 4, require('CZ_GANGSI_RANK'))
d:add(0x0965, -1, require('CZ_ITEMLISTWIN_RES'))
d:add(0x0940, 6, require('CZ_ITEM_PICKUP'))
d:add(0x0361, 6, require('CZ_ITEM_THROW'))
d:add(0x088a, 8, require('CZ_JOIN_BATTLE_FIELD'))
d:add(0x088e, 8, require('CZ_MOVE_ITEM_FROM_BODY_TO_STORE'))
d:add(0x0367, 8, require('CZ_MOVE_ITEM_FROM_STORE_TO_BODY'))

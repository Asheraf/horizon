...
local CZ_REQ_GIVE_MANNER_POINT = {
	_id = pid,
	_length = 0,
	_buffer = nil
}
...
function CZ_REQ_GIVE_MANNER_POINT.new(o)
	o = o or CZ_REQ_GIVE_MANNER_POINT
	setmetatable(o, self)
	self.__index = self
	return o
end

function CZ_REQ_GIVE_MANNER_POINT.deserialize(buf)

end

return CZ_REQ_GIVE_MANNER_POINT

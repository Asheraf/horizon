...
elseif packet_version >= 20100105 then
	local pid = 0x02c4
elseif packet_version >= 20070821 then
	local pid = 0x02c4
elseif packet_version >= 0 then
	local pid = 0x02c4
end

local CZ_PARTY_JOIN_REQ = {
	_id = pid,
	_length = 0,
	_buffer = nil
}
...
function CZ_PARTY_JOIN_REQ.new(o)
	o = o or CZ_PARTY_JOIN_REQ
	setmetatable(o, self)
	self.__index = self
	return o
end

function CZ_PARTY_JOIN_REQ.deserialize(buf)

end

return CZ_PARTY_JOIN_REQ

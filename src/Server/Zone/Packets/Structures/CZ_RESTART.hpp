...
#ifndef HORIZON_ZONE_CZ_RESTART_HPP
#define HORIZON_ZONE_CZ_RESTART_HPP
...
/**
 * @brief Main object for the aegis packet: CZ_RESTART
 * Size : 3 @ 0
 *
 */ 
class CZ_RESTART : public Base::NetworkPacket<ZoneSocket>
{
public:
	CZ_RESTART(std::shared_ptr<ZoneSocket> sock);
	~CZ_RESTART();
...
#endif /* HORIZON_ZONE_CZ_RESTART_HPP */

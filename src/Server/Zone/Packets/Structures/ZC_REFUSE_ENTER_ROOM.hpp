...
#ifndef HORIZON_ZONE_ZC_REFUSE_ENTER_ROOM_HPP
#define HORIZON_ZONE_ZC_REFUSE_ENTER_ROOM_HPP
 ...
 *
 */ 
class ZC_REFUSE_ENTER_ROOM : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_REFUSE_ENTER_ROOM(std::shared_ptr<ZoneSocket> sock);
...
#endif /* HORIZON_ZONE_ZC_REFUSE_ENTER_ROOM_HPP */

...
#ifndef HORIZON_ZONE_ZC_NOTIFY_MOVE_HPP
#define HORIZON_ZONE_ZC_NOTIFY_MOVE_HPP
 ...
 *
 */ 
class ZC_NOTIFY_MOVE : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_NOTIFY_MOVE(std::shared_ptr<ZoneSocket> sock);
	~ZC_NOTIFY_MOVE();
...
#endif /* HORIZON_ZONE_ZC_NOTIFY_MOVE_HPP */

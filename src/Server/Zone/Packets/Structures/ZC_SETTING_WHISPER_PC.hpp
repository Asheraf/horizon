...
#ifndef HORIZON_ZONE_ZC_SETTING_WHISPER_PC_HPP
#define HORIZON_ZONE_ZC_SETTING_WHISPER_PC_HPP
 ...
 *
 */ 
class ZC_SETTING_WHISPER_PC : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_SETTING_WHISPER_PC(std::shared_ptr<ZoneSocket> sock);
...
#endif /* HORIZON_ZONE_ZC_SETTING_WHISPER_PC_HPP */

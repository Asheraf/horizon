...
#ifndef HORIZON_ZONE_ZC_NOTIFY_SKILL2_HPP
#define HORIZON_ZONE_ZC_NOTIFY_SKILL2_HPP
 ...
 *
 */ 
class ZC_NOTIFY_SKILL2 : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_NOTIFY_SKILL2(std::shared_ptr<ZoneSocket> sock);
	~ZC_NOTIFY_SKILL2();
...
#endif /* HORIZON_ZONE_ZC_NOTIFY_SKILL2_HPP */

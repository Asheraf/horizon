...
local ZC_ACK_GENERATE_ROULETTE = {
	_id = pid,
	_length = 0,
	_buffer = nil
}
...
function ZC_ACK_GENERATE_ROULETTE.new(o)
	o = o or ZC_ACK_GENERATE_ROULETTE
	setmetatable(o, self)
	self.__index = self
	return o
end

function ZC_ACK_GENERATE_ROULETTE.serialize()

end

return ZC_ACK_GENERATE_ROULETTE

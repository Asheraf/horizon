...
#ifndef HORIZON_ZONE_ZC_SKILL_ENTRY_HPP
#define HORIZON_ZONE_ZC_SKILL_ENTRY_HPP
 ...
 *
 */ 
class ZC_SKILL_ENTRY : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_SKILL_ENTRY(std::shared_ptr<ZoneSocket> sock);
	~ZC_SKILL_ENTRY();
...
#endif /* HORIZON_ZONE_ZC_SKILL_ENTRY_HPP */

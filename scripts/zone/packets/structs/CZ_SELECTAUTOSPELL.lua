...
function CZ_SELECTAUTOSPELL.new(o)
	o = o or CZ_SELECTAUTOSPELL
	setmetatable(o, self)
	self.__index = self
	return o
end

function CZ_SELECTAUTOSPELL.deserialize(buf)

end

return CZ_SELECTAUTOSPELL

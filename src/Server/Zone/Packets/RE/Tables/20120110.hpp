...
#ifndef HORIZON_ZONE_SHUFFLE_PACKET_LENGTH_TABLE_20120110
#define HORIZON_ZONE_SHUFFLE_PACKET_LENGTH_TABLE_20120110
...
#define ADD_PKT(i, j, k) _packet_length_table.insert(i, std::make_pair<uint16_t, NetworkPacket>(j, k))
		...
		ADD_PKT(0x0361, 12, CZ_CHANGE_DIRECTION2(sock));
...
#endif /* HORIZON_ZONE_SHUFFLE_PACKET_LENGTH_TABLE_20120110 */
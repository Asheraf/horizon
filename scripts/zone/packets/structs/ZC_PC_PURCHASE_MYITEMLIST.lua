...
local ZC_PC_PURCHASE_MYITEMLIST = {
	_id = pid,
	_length = 0,
	_buffer = nil
}
...
function ZC_PC_PURCHASE_MYITEMLIST.new(o)
	o = o or ZC_PC_PURCHASE_MYITEMLIST
	setmetatable(o, self)
	self.__index = self
	return o
end

function ZC_PC_PURCHASE_MYITEMLIST.serialize()

end

return ZC_PC_PURCHASE_MYITEMLIST

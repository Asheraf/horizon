...
#ifndef HORIZON_ZONE_SHUFFLE_PACKET_LENGTH_TABLE_20111122
#define HORIZON_ZONE_SHUFFLE_PACKET_LENGTH_TABLE_20111122
...
#define ADD_PKT(i, j, k) _packet_length_table.insert(i, std::make_pair<uint16_t, NetworkPacket>(j, k))
		...
		ADD_PKT(0x022d, 7, CZ_COMMAND_MER(sock));
		...
		ADD_PKT(0x0363, 90, CZ_ITEM_THROW2(sock));
		...
		ADD_PKT(0x0367, 4, CZ_USE_SKILL_TOGROUND_WITHTALKBOX2(sock));
...
#endif /* HORIZON_ZONE_SHUFFLE_PACKET_LENGTH_TABLE_20111122 */
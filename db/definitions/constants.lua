...
---------------------------------------------------------------------------
-- Generic Constants Database
---------------------------------------------------------------------------
-- This database is a composition of variables that could be used in
-- NPC and item scripts.
---------------------------------------------------------------------------
...
-- Short-Hand Global Defines
spr = constants.NPCSpriteID
eff = constants.EffectID

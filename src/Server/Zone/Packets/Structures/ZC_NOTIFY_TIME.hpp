...
#ifndef HORIZON_ZONE_ZC_NOTIFY_TIME_HPP
#define HORIZON_ZONE_ZC_NOTIFY_TIME_HPP
 ...
 *
 */ 
class ZC_NOTIFY_TIME : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_NOTIFY_TIME(std::shared_ptr<ZoneSocket> sock);
	~ZC_NOTIFY_TIME();
...
#endif /* HORIZON_ZONE_ZC_NOTIFY_TIME_HPP */

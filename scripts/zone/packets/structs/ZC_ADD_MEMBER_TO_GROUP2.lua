...
elseif packet_version >= 20031117 then
	local pid = 0x01e9
elseif packet_version >= 20031103 then
	local pid = 0x01e9
elseif packet_version >= 0 then
	local pid = 0x01e9
end

local ZC_ADD_MEMBER_TO_GROUP2 = {
	_id = pid,
	_length = 0,
	_buffer = nil
}
...
function ZC_ADD_MEMBER_TO_GROUP2.new(o)
	o = o or ZC_ADD_MEMBER_TO_GROUP2
	setmetatable(o, self)
	self.__index = self
	return o
end

function ZC_ADD_MEMBER_TO_GROUP2.serialize()

end

return ZC_ADD_MEMBER_TO_GROUP2

...
#ifndef HORIZON_ZONE_RAGEXE_PACKET_ZC_ADD_EXCHANGE_ITEM4_HPP
#define HORIZON_ZONE_RAGEXE_PACKET_ZC_ADD_EXCHANGE_ITEM4_HPP
...
#endif /* HORIZON_ZONE_RAGEXE_PACKET_ZC_ADD_EXCHANGE_ITEM4_HPP */

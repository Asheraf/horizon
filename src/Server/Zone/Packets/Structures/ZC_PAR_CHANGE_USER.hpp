...
#ifndef HORIZON_ZONE_ZC_PAR_CHANGE_USER_HPP
#define HORIZON_ZONE_ZC_PAR_CHANGE_USER_HPP
 ...
 *
 */ 
class ZC_PAR_CHANGE_USER : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_PAR_CHANGE_USER(std::shared_ptr<ZoneSocket> sock);
	~ZC_PAR_CHANGE_USER();
...
#endif /* HORIZON_ZONE_ZC_PAR_CHANGE_USER_HPP */

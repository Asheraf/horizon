...
#ifndef HORIZON_ZONE_CZ_REQ_WHISPER_LIST_HPP
#define HORIZON_ZONE_CZ_REQ_WHISPER_LIST_HPP
...
/**
 * @brief Main object for the aegis packet: CZ_REQ_WHISPER_LIST
 * Size : 2 @ 0
 *
 */ 
class CZ_REQ_WHISPER_LIST : public Base::NetworkPacket<ZoneSocket>
{
public:
	CZ_REQ_WHISPER_LIST(std::shared_ptr<ZoneSocket> sock);
	~CZ_REQ_WHISPER_LIST();
...
#endif /* HORIZON_ZONE_CZ_REQ_WHISPER_LIST_HPP */

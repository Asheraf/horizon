...
#ifndef HORIZON_ZONE_ZC_REPAIRITEMLIST_HPP
#define HORIZON_ZONE_ZC_REPAIRITEMLIST_HPP
 ...
 *
 */ 
class ZC_REPAIRITEMLIST : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_REPAIRITEMLIST(std::shared_ptr<ZoneSocket> sock);
	~ZC_REPAIRITEMLIST();
...
#endif /* HORIZON_ZONE_ZC_REPAIRITEMLIST_HPP */

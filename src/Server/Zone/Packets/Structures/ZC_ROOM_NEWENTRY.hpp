...
#ifndef HORIZON_ZONE_ZC_ROOM_NEWENTRY_HPP
#define HORIZON_ZONE_ZC_ROOM_NEWENTRY_HPP
 ...
 *
 */ 
class ZC_ROOM_NEWENTRY : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_ROOM_NEWENTRY(std::shared_ptr<ZoneSocket> sock);
	~ZC_ROOM_NEWENTRY();
...
#endif /* HORIZON_ZONE_ZC_ROOM_NEWENTRY_HPP */

...
#ifndef HORIZON_ZONE_ZC_DELETE_ITEM_FROM_CART_HPP
#define HORIZON_ZONE_ZC_DELETE_ITEM_FROM_CART_HPP
 ...
 *
 */ 
class ZC_DELETE_ITEM_FROM_CART : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_DELETE_ITEM_FROM_CART(std::shared_ptr<ZoneSocket> sock);
...
#endif /* HORIZON_ZONE_ZC_DELETE_ITEM_FROM_CART_HPP */

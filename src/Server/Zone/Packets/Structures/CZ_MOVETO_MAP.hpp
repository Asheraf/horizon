...
#ifndef HORIZON_ZONE_CZ_MOVETO_MAP_HPP
#define HORIZON_ZONE_CZ_MOVETO_MAP_HPP
...
/**
 * @brief Main object for the aegis packet: CZ_MOVETO_MAP
 * Size : 22 @ 0
 *
 */ 
class CZ_MOVETO_MAP : public Base::NetworkPacket<ZoneSocket>
{
public:
	CZ_MOVETO_MAP(std::shared_ptr<ZoneSocket> sock);
	~CZ_MOVETO_MAP();
...
#endif /* HORIZON_ZONE_CZ_MOVETO_MAP_HPP */

...
#ifndef HORIZON_ZONE_ZC_ACK_REQNAMEALL_HPP
#define HORIZON_ZONE_ZC_ACK_REQNAMEALL_HPP
 ...
 *
 */ 
class ZC_ACK_REQNAMEALL : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_ACK_REQNAMEALL(std::shared_ptr<ZoneSocket> sock);
	~ZC_ACK_REQNAMEALL();
...
#endif /* HORIZON_ZONE_ZC_ACK_REQNAMEALL_HPP */

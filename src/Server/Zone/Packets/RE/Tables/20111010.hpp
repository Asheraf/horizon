...
#ifndef HORIZON_ZONE_SHUFFLE_PACKET_LENGTH_TABLE_20111010
#define HORIZON_ZONE_SHUFFLE_PACKET_LENGTH_TABLE_20111010
...
#define ADD_PKT(i, j, k) _packet_length_table.insert(i, std::make_pair<uint16_t, NetworkPacket>(j, k))
		...
		ADD_PKT(0x0363, 7, CZ_ITEM_THROW2(sock));
		ADD_PKT(0x07ec, 26, CZ_JOIN_BATTLE_FIELD(sock));
		ADD_PKT(0x0364, 19, CZ_MOVE_ITEM_FROM_BODY_TO_STORE2(sock));
		ADD_PKT(0x0365, 2, CZ_MOVE_ITEM_FROM_STORE_TO_BODY2(sock));
		ADD_PKT(0x0802, 12, CZ_PARTY_BOOKING_REQ_REGISTER(sock));
		...
		ADD_PKT(0x083c, -1, CZ_SSILIST_ITEM_CLICK(sock));
...
#endif /* HORIZON_ZONE_SHUFFLE_PACKET_LENGTH_TABLE_20111010 */
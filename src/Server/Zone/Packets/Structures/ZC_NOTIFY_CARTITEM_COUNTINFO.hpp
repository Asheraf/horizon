...
#ifndef HORIZON_ZONE_ZC_NOTIFY_CARTITEM_COUNTINFO_HPP
#define HORIZON_ZONE_ZC_NOTIFY_CARTITEM_COUNTINFO_HPP
 ...
 *
 */ 
class ZC_NOTIFY_CARTITEM_COUNTINFO : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_NOTIFY_CARTITEM_COUNTINFO(std::shared_ptr<ZoneSocket> sock);
...
#endif /* HORIZON_ZONE_ZC_NOTIFY_CARTITEM_COUNTINFO_HPP */

...
if packet_version >= 20181002 then
	local pid = 0x0b08
...
function ZC_INVENTORY_START.new(o)
	o = o or ZC_INVENTORY_START
	setmetatable(o, self)
	self.__index = self
	return o
end

function ZC_INVENTORY_START.serialize()

end

return ZC_INVENTORY_START

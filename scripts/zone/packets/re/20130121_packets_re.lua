...
d:add(0x086c, 19, require('CZ_ENTER'))
d:add(0x085a, 4, require('CZ_GANGSI_RANK'))
d:add(0x0969, -1, require('CZ_ITEMLISTWIN_RES'))
d:add(0x091f, 6, require('CZ_ITEM_PICKUP'))
d:add(0x094f, 6, require('CZ_ITEM_THROW'))
d:add(0x035f, 8, require('CZ_JOIN_BATTLE_FIELD'))
d:add(0x0874, 8, require('CZ_MOVE_ITEM_FROM_BODY_TO_STORE'))
d:add(0x0963, 8, require('CZ_MOVE_ITEM_FROM_STORE_TO_BODY'))
d:add(0x0369, 18, require('CZ_PARTY_BOOKING_REQ_REGISTER'))
d:add(0x095b, 26, require('CZ_PARTY_JOIN_REQ'))
d:add(0x096a, 6, require('CZ_REQNAME'))
d:add(0x0368, 6, require('CZ_REQNAME_BYGID'))
d:add(0x0802, 7, require('CZ_REQUEST_ACT'))
...
d:add(0x0884, -1, require('CZ_SEARCH_STORE_INFO'))

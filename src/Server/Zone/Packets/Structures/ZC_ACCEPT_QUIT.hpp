...
#ifndef HORIZON_ZONE_ZC_ACCEPT_QUIT_HPP
#define HORIZON_ZONE_ZC_ACCEPT_QUIT_HPP
 ...
 *
 */ 
class ZC_ACCEPT_QUIT : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_ACCEPT_QUIT(std::shared_ptr<ZoneSocket> sock);
	~ZC_ACCEPT_QUIT();
...
#endif /* HORIZON_ZONE_ZC_ACCEPT_QUIT_HPP */

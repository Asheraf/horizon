...
#ifndef HORIZON_ZONE_CZ_KILLER_RANK_HPP
#define HORIZON_ZONE_CZ_KILLER_RANK_HPP
...
/**
 * @brief Main object for the aegis packet: CZ_KILLER_RANK
 * Size : 2 @ 0
 *
 */ 
class CZ_KILLER_RANK : public Base::NetworkPacket<ZoneSocket>
{
public:
	CZ_KILLER_RANK(std::shared_ptr<ZoneSocket> sock);
	~CZ_KILLER_RANK();
...
#endif /* HORIZON_ZONE_CZ_KILLER_RANK_HPP */

...
d:add(0x0875, 26, require('CZ_ADD_FRIENDS'))
...
d:add(0x0967, 6, require('CZ_ITEM_PICKUP'))
d:add(0x08a3, 6, require('CZ_ITEM_THROW'))
d:add(0x0889, 8, require('CZ_JOIN_BATTLE_FIELD'))
d:add(0x0877, 8, require('CZ_MOVE_ITEM_FROM_BODY_TO_STORE'))
d:add(0x0961, 8, require('CZ_MOVE_ITEM_FROM_STORE_TO_BODY'))
d:add(0x08a1, 18, require('CZ_PARTY_BOOKING_REQ_REGISTER'))
d:add(0x0870, 26, require('CZ_PARTY_JOIN_REQ'))
d:add(0x0888, 6, require('CZ_REQNAME'))

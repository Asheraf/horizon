...
#ifndef HORIZON_ZONE_ZC_NOTIFY_MOVEENTRY_HPP
#define HORIZON_ZONE_ZC_NOTIFY_MOVEENTRY_HPP
 ...
 *
 */ 
class ZC_NOTIFY_MOVEENTRY : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_NOTIFY_MOVEENTRY(std::shared_ptr<ZoneSocket> sock);
	~ZC_NOTIFY_MOVEENTRY();
...
#endif /* HORIZON_ZONE_ZC_NOTIFY_MOVEENTRY_HPP */

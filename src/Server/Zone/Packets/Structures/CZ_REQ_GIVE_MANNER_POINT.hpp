...
#ifndef HORIZON_ZONE_CZ_REQ_GIVE_MANNER_POINT_HPP
#define HORIZON_ZONE_CZ_REQ_GIVE_MANNER_POINT_HPP
...
enum {
	...
	ID_CZ_REQ_GIVE_MANNER_POINT = 0x0149
...
/**
 * @brief Main object for the aegis packet: CZ_REQ_GIVE_MANNER_POINT
 * Size : 9 @ 0
 *
 */ 
class CZ_REQ_GIVE_MANNER_POINT : public Base::NetworkPacket<ZoneSocket>
{
public:
	CZ_REQ_GIVE_MANNER_POINT(std::shared_ptr<ZoneSocket> sock);
...
#endif /* HORIZON_ZONE_CZ_REQ_GIVE_MANNER_POINT_HPP */

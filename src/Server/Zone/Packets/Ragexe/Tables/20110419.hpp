...
#ifndef HORIZON_ZONE_SHUFFLE_PACKET_LENGTH_TABLE_20110419
#define HORIZON_ZONE_SHUFFLE_PACKET_LENGTH_TABLE_20110419
...
#define ADD_PKT(i, j, k) _packet_length_table.insert(i, std::make_pair<uint16_t, NetworkPacket>(j, k))
		...
		ADD_PKT(0x0436, 36, CZ_ENTER2(sock));
		ADD_PKT(0x0281, 8, CZ_GANGSI_RANK(sock));
		...
		ADD_PKT(0x0802, 6, CZ_PARTY_BOOKING_REQ_REGISTER(sock));
		ADD_PKT(0x02c4, -1, CZ_PARTY_JOIN_REQ(sock));
		...
		ADD_PKT(0x0819, 26, CZ_REQ_TRADE_BUYING_STORE(sock));
...
#endif /* HORIZON_ZONE_SHUFFLE_PACKET_LENGTH_TABLE_20110419 */
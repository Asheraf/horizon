...
d:add(0x095f, 36, require('CZ_ACK_STORE_PASSWORD'))
d:add(0x0817, 26, require('CZ_ADD_FRIENDS'))
d:add(0x095b, 5, require('CZ_CHANGE_DIRECTION'))
...
d:add(0x0863, 6, require('CZ_ITEM_PICKUP'))
...
d:add(0x0870, 8, require('CZ_MOVE_ITEM_FROM_STORE_TO_BODY'))
...
d:add(0x0202, 2, require('CZ_REQ_CLOSE_BUYING_STORE'))

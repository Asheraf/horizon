...
#ifndef HORIZON_ZONE_ZC_SPIRITS_HPP
#define HORIZON_ZONE_ZC_SPIRITS_HPP
 ...
 *
 */ 
class ZC_SPIRITS : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_SPIRITS(std::shared_ptr<ZoneSocket> sock);
	~ZC_SPIRITS();
...
#endif /* HORIZON_ZONE_ZC_SPIRITS_HPP */

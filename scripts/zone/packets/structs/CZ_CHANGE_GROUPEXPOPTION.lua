...
local CZ_CHANGE_GROUPEXPOPTION = {
	_id = pid,
	_length = 0,
	_buffer = nil
}
...
function CZ_CHANGE_GROUPEXPOPTION.new(o)
	o = o or CZ_CHANGE_GROUPEXPOPTION
	setmetatable(o, self)
	self.__index = self
	return o
end

function CZ_CHANGE_GROUPEXPOPTION.deserialize(buf)

end

return CZ_CHANGE_GROUPEXPOPTION

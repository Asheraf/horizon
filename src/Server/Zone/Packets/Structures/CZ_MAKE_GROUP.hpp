...
#ifndef HORIZON_ZONE_CZ_MAKE_GROUP_HPP
#define HORIZON_ZONE_CZ_MAKE_GROUP_HPP
...
/**
 * @brief Main object for the aegis packet: CZ_MAKE_GROUP
 * Size : 26 @ 0
 *
 */ 
class CZ_MAKE_GROUP : public Base::NetworkPacket<ZoneSocket>
{
public:
	CZ_MAKE_GROUP(std::shared_ptr<ZoneSocket> sock);
	~CZ_MAKE_GROUP();
...
#endif /* HORIZON_ZONE_CZ_MAKE_GROUP_HPP */

...
local ZC_OFFLINE_STORE_VISIBLE = {
	_id = pid,
	_length = 0,
	_buffer = nil
}
...
function ZC_OFFLINE_STORE_VISIBLE.new(o)
	o = o or ZC_OFFLINE_STORE_VISIBLE
	setmetatable(o, self)
	self.__index = self
	return o
end

function ZC_OFFLINE_STORE_VISIBLE.serialize()

end

return ZC_OFFLINE_STORE_VISIBLE

...
#ifndef HORIZON_ZONE_CZ_REQ_GUILD_MENUINTERFACE_HPP
#define HORIZON_ZONE_CZ_REQ_GUILD_MENUINTERFACE_HPP
...
enum {
	...
	ID_CZ_REQ_GUILD_MENUINTERFACE = 0x014d
...
/**
 * @brief Main object for the aegis packet: CZ_REQ_GUILD_MENUINTERFACE
 * Size : 2 @ 0
 *
 */ 
class CZ_REQ_GUILD_MENUINTERFACE : public Base::NetworkPacket<ZoneSocket>
{
public:
	CZ_REQ_GUILD_MENUINTERFACE(std::shared_ptr<ZoneSocket> sock);
...
#endif /* HORIZON_ZONE_CZ_REQ_GUILD_MENUINTERFACE_HPP */

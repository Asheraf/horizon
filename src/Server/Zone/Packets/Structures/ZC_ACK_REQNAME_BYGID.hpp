...
#ifndef HORIZON_ZONE_ZC_ACK_REQNAME_BYGID_HPP
#define HORIZON_ZONE_ZC_ACK_REQNAME_BYGID_HPP
 ...
 *
 */ 
class ZC_ACK_REQNAME_BYGID : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_ACK_REQNAME_BYGID(std::shared_ptr<ZoneSocket> sock);
...
#endif /* HORIZON_ZONE_ZC_ACK_REQNAME_BYGID_HPP */

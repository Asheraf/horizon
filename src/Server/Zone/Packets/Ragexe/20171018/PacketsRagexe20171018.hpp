...
#ifndef HORIZON_ZONE_RAGEXE_20171018_PACKETS_HPP
#define HORIZON_ZONE_RAGEXE_20171018_PACKETS_HPP
...
enum packets
{
	CZ_ACK_STORE_PASSWORD = 0x0944,
	CZ_ADD_FRIENDS = 0x094a,
	CZ_CHANGE_DIRECTION = 0x08a6,
	CZ_COMMAND_MER = 0x087e,
	CZ_ENTER = 0x0363,
	CZ_GANGSI_RANK = 0x086a,
	CZ_ITEMLISTWIN_RES = 0x0938,
	CZ_ITEM_PICKUP = 0x0436,
	CZ_ITEM_THROW = 0x089a,
	CZ_JOIN_BATTLE_FIELD = 0x087a,
	CZ_MOVE_ITEM_FROM_BODY_TO_STORE = 0x0364,
	CZ_MOVE_ITEM_FROM_STORE_TO_BODY = 0x0889,
	CZ_PARTY_BOOKING_REQ_REGISTER = 0x094f,
	CZ_PARTY_JOIN_REQ = 0x089f,
	CZ_REQNAME = 0x096a,
...
#endif /* HORIZON_ZONE_RAGEXE_20171018_PACKETS_HPP */

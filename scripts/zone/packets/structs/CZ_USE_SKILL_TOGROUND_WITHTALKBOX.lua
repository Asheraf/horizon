...
elseif packet_version >= 20040726 then
	local pid = 0x0190
elseif packet_version >= 20040713 then
	local pid = 0x0190
elseif packet_version >= 20040712 then
	local pid = 0x0190
...
local CZ_USE_SKILL_TOGROUND_WITHTALKBOX = {
	_id = pid,
	_length = 0,
	_buffer = nil
}
...
function CZ_USE_SKILL_TOGROUND_WITHTALKBOX.new(o)
	o = o or CZ_USE_SKILL_TOGROUND_WITHTALKBOX
	setmetatable(o, self)
	self.__index = self
	return o
end

function CZ_USE_SKILL_TOGROUND_WITHTALKBOX.deserialize(buf)

end

return CZ_USE_SKILL_TOGROUND_WITHTALKBOX

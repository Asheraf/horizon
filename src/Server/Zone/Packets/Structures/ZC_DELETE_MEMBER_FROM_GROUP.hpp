...
#ifndef HORIZON_ZONE_ZC_DELETE_MEMBER_FROM_GROUP_HPP
#define HORIZON_ZONE_ZC_DELETE_MEMBER_FROM_GROUP_HPP
 ...
 *
 */ 
class ZC_DELETE_MEMBER_FROM_GROUP : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_DELETE_MEMBER_FROM_GROUP(std::shared_ptr<ZoneSocket> sock);
...
#endif /* HORIZON_ZONE_ZC_DELETE_MEMBER_FROM_GROUP_HPP */

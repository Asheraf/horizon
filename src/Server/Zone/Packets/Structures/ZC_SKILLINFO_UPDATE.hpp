...
#ifndef HORIZON_ZONE_ZC_SKILLINFO_UPDATE_HPP
#define HORIZON_ZONE_ZC_SKILLINFO_UPDATE_HPP
 ...
 *
 */ 
class ZC_SKILLINFO_UPDATE : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_SKILLINFO_UPDATE(std::shared_ptr<ZoneSocket> sock);
	~ZC_SKILLINFO_UPDATE();
...
#endif /* HORIZON_ZONE_ZC_SKILLINFO_UPDATE_HPP */

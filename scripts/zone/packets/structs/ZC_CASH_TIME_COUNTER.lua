...
function ZC_CASH_TIME_COUNTER.new(o)
	o = o or ZC_CASH_TIME_COUNTER
	setmetatable(o, self)
	self.__index = self
	return o
end

function ZC_CASH_TIME_COUNTER.serialize()

end

return ZC_CASH_TIME_COUNTER

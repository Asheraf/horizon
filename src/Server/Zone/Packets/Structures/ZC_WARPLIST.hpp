...
#ifndef HORIZON_ZONE_ZC_WARPLIST_HPP
#define HORIZON_ZONE_ZC_WARPLIST_HPP
 ...
 *
 */ 
class ZC_WARPLIST : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_WARPLIST(std::shared_ptr<ZoneSocket> sock);
	~ZC_WARPLIST();
...
#endif /* HORIZON_ZONE_ZC_WARPLIST_HPP */

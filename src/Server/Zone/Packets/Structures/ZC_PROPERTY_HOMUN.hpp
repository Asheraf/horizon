...
#ifndef HORIZON_ZONE_ZC_PROPERTY_HOMUN_HPP
#define HORIZON_ZONE_ZC_PROPERTY_HOMUN_HPP
 ...
 *
 */ 
class ZC_PROPERTY_HOMUN : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_PROPERTY_HOMUN(std::shared_ptr<ZoneSocket> sock);
	~ZC_PROPERTY_HOMUN();
...
#endif /* HORIZON_ZONE_ZC_PROPERTY_HOMUN_HPP */

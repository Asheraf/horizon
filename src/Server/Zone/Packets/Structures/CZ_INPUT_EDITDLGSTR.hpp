...
#ifndef HORIZON_ZONE_CZ_INPUT_EDITDLGSTR_HPP
#define HORIZON_ZONE_CZ_INPUT_EDITDLGSTR_HPP
...
/**
 * @brief Main object for the aegis packet: CZ_INPUT_EDITDLGSTR
 * Size : -1 @ 0
 *
 */ 
class CZ_INPUT_EDITDLGSTR : public Base::NetworkPacket<ZoneSocket>
{
public:
	CZ_INPUT_EDITDLGSTR(std::shared_ptr<ZoneSocket> sock);
	~CZ_INPUT_EDITDLGSTR();
...
#endif /* HORIZON_ZONE_CZ_INPUT_EDITDLGSTR_HPP */

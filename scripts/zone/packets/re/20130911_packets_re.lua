...
d:add(0x086b, 36, require('CZ_ACK_STORE_PASSWORD'))
d:add(0x0948, 26, require('CZ_ADD_FRIENDS'))
d:add(0x091e, 5, require('CZ_CHANGE_DIRECTION'))
d:add(0x0891, 5, require('CZ_COMMAND_MER'))
...
d:add(0x0967, 6, require('CZ_ITEM_THROW'))
...
d:add(0x085c, 26, require('CZ_PARTY_JOIN_REQ'))

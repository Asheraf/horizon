...
#ifndef HORIZON_ZONE_ZC_NOTIFY_EFFECT_HPP
#define HORIZON_ZONE_ZC_NOTIFY_EFFECT_HPP
 ...
 *
 */ 
class ZC_NOTIFY_EFFECT : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_NOTIFY_EFFECT(std::shared_ptr<ZoneSocket> sock);
	~ZC_NOTIFY_EFFECT();
...
#endif /* HORIZON_ZONE_ZC_NOTIFY_EFFECT_HPP */

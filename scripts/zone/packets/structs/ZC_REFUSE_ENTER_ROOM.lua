...
function ZC_REFUSE_ENTER_ROOM.new(o)
	o = o or ZC_REFUSE_ENTER_ROOM
	setmetatable(o, self)
	self.__index = self
	return o
end

function ZC_REFUSE_ENTER_ROOM.serialize()

end

return ZC_REFUSE_ENTER_ROOM

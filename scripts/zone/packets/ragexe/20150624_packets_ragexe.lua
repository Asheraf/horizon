...
d:add(0x0870, 36, require('CZ_ACK_STORE_PASSWORD'))
...
d:add(0x0940, 8, require('CZ_MOVE_ITEM_FROM_STORE_TO_BODY'))
d:add(0x0364, 18, require('CZ_PARTY_BOOKING_REQ_REGISTER'))

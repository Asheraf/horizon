...
function ZC_ADD_ITEM_TO_CART2.new(o)
	o = o or ZC_ADD_ITEM_TO_CART2
	setmetatable(o, self)
	self.__index = self
	return o
end

function ZC_ADD_ITEM_TO_CART2.serialize()

end

return ZC_ADD_ITEM_TO_CART2

...
#ifndef HORIZON_ZONE_ZC_ACK_CREATE_CHATROOM_HPP
#define HORIZON_ZONE_ZC_ACK_CREATE_CHATROOM_HPP
 ...
 *
 */ 
class ZC_ACK_CREATE_CHATROOM : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_ACK_CREATE_CHATROOM(std::shared_ptr<ZoneSocket> sock);
...
#endif /* HORIZON_ZONE_ZC_ACK_CREATE_CHATROOM_HPP */

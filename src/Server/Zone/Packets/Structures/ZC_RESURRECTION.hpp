...
#ifndef HORIZON_ZONE_ZC_RESURRECTION_HPP
#define HORIZON_ZONE_ZC_RESURRECTION_HPP
 ...
 *
 */ 
class ZC_RESURRECTION : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_RESURRECTION(std::shared_ptr<ZoneSocket> sock);
	~ZC_RESURRECTION();
...
#endif /* HORIZON_ZONE_ZC_RESURRECTION_HPP */

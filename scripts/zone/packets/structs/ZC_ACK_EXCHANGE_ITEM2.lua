...
elseif packet_version >= 20080102 then
	local pid = 0x01f5
elseif packet_version >= 20040302 then
	local pid = 0x01f5
elseif packet_version >= 0 then
	local pid = 0x01f5
end

local ZC_ACK_EXCHANGE_ITEM2 = {
	_id = pid,
	_length = 0,
	_buffer = nil
}
...
function ZC_ACK_EXCHANGE_ITEM2.new(o)
	o = o or ZC_ACK_EXCHANGE_ITEM2
	setmetatable(o, self)
	self.__index = self
	return o
end

function ZC_ACK_EXCHANGE_ITEM2.serialize()

end

return ZC_ACK_EXCHANGE_ITEM2

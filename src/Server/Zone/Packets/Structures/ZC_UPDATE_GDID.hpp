...
#ifndef HORIZON_ZONE_ZC_UPDATE_GDID_HPP
#define HORIZON_ZONE_ZC_UPDATE_GDID_HPP
 ...
 *
 */ 
class ZC_UPDATE_GDID : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_UPDATE_GDID(std::shared_ptr<ZoneSocket> sock);
	~ZC_UPDATE_GDID();
...
#endif /* HORIZON_ZONE_ZC_UPDATE_GDID_HPP */

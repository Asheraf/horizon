...
if packet_version >= 20090401 then
	local pid = 0x01f0
...
elseif packet_version >= 20080102 then
	local pid = 0x01f0
elseif packet_version >= 20031218 then
	local pid = 0x01f0
elseif packet_version >= 0 then
	local pid = 0x01f0
end

local ZC_STORE_NORMAL_ITEMLIST2 = {
	_id = pid,
	_length = 0,
	_buffer = nil
}
...
function ZC_STORE_NORMAL_ITEMLIST2.new(o)
	o = o or ZC_STORE_NORMAL_ITEMLIST2
	setmetatable(o, self)
	self.__index = self
	return o
end

function ZC_STORE_NORMAL_ITEMLIST2.serialize()

end

return ZC_STORE_NORMAL_ITEMLIST2

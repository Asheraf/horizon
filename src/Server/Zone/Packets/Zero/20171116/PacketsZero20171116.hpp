...
#ifndef HORIZON_ZONE_ZERO_20171116_PACKETS_HPP
#define HORIZON_ZONE_ZERO_20171116_PACKETS_HPP
...
enum packets
{
	CZ_ACK_STORE_PASSWORD = 0x0922,
	CZ_ADD_FRIENDS = 0x0966,
	CZ_CHANGE_DIRECTION = 0x0959,
	CZ_COMMAND_MER = 0x091c,
	CZ_ENTER = 0x0881,
...
#endif /* HORIZON_ZONE_ZERO_20171116_PACKETS_HPP */

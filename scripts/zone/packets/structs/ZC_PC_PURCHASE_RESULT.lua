...
function ZC_PC_PURCHASE_RESULT.new(o)
	o = o or ZC_PC_PURCHASE_RESULT
	setmetatable(o, self)
	self.__index = self
	return o
end

function ZC_PC_PURCHASE_RESULT.serialize()

end

return ZC_PC_PURCHASE_RESULT

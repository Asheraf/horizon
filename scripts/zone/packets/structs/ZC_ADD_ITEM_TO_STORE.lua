...
function ZC_ADD_ITEM_TO_STORE.new(o)
	o = o or ZC_ADD_ITEM_TO_STORE
	setmetatable(o, self)
	self.__index = self
	return o
end

function ZC_ADD_ITEM_TO_STORE.serialize()

end

return ZC_ADD_ITEM_TO_STORE

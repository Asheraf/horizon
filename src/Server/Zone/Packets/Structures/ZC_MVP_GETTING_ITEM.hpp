...
#ifndef HORIZON_ZONE_ZC_MVP_GETTING_ITEM_HPP
#define HORIZON_ZONE_ZC_MVP_GETTING_ITEM_HPP
 ...
 *
 */ 
class ZC_MVP_GETTING_ITEM : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_MVP_GETTING_ITEM(std::shared_ptr<ZoneSocket> sock);
	~ZC_MVP_GETTING_ITEM();
...
#endif /* HORIZON_ZONE_ZC_MVP_GETTING_ITEM_HPP */

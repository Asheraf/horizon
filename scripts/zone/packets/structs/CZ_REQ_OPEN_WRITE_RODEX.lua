...
function CZ_REQ_OPEN_WRITE_RODEX.new(o)
	o = o or CZ_REQ_OPEN_WRITE_RODEX
	setmetatable(o, self)
	self.__index = self
	return o
end

function CZ_REQ_OPEN_WRITE_RODEX.deserialize(buf)

end

return CZ_REQ_OPEN_WRITE_RODEX

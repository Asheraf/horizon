...
if packet_version >= 20180425 then
	local pid = 0x0afb
...
function ZC_AUTOSPELLLIST.new(o)
	o = o or ZC_AUTOSPELLLIST
	setmetatable(o, self)
	self.__index = self
	return o
end

function ZC_AUTOSPELLLIST.serialize()

end

return ZC_AUTOSPELLLIST

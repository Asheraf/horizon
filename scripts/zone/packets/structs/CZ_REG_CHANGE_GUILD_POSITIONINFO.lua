...
local CZ_REG_CHANGE_GUILD_POSITIONINFO = {
	_id = pid,
	_length = 0,
	_buffer = nil
}
...
function CZ_REG_CHANGE_GUILD_POSITIONINFO.new(o)
	o = o or CZ_REG_CHANGE_GUILD_POSITIONINFO
	setmetatable(o, self)
	self.__index = self
	return o
end

function CZ_REG_CHANGE_GUILD_POSITIONINFO.deserialize(buf)

end

return CZ_REG_CHANGE_GUILD_POSITIONINFO

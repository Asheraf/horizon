...
#ifndef HORIZON_ZONE_ZC_GUILD_CHAT_HPP
#define HORIZON_ZONE_ZC_GUILD_CHAT_HPP
 ...
 *
 */ 
class ZC_GUILD_CHAT : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_GUILD_CHAT(std::shared_ptr<ZoneSocket> sock);
	~ZC_GUILD_CHAT();
...
#endif /* HORIZON_ZONE_ZC_GUILD_CHAT_HPP */

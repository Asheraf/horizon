...
#ifndef HORIZON_ZONE_ZC_MSG_STATE_CHANGE_HPP
#define HORIZON_ZONE_ZC_MSG_STATE_CHANGE_HPP
 ...
 *
 */ 
class ZC_MSG_STATE_CHANGE : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_MSG_STATE_CHANGE(std::shared_ptr<ZoneSocket> sock);
	~ZC_MSG_STATE_CHANGE();
...
#endif /* HORIZON_ZONE_ZC_MSG_STATE_CHANGE_HPP */

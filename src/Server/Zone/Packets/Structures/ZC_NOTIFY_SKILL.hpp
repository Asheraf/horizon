...
#ifndef HORIZON_ZONE_ZC_NOTIFY_SKILL_HPP
#define HORIZON_ZONE_ZC_NOTIFY_SKILL_HPP
 ...
 *
 */ 
class ZC_NOTIFY_SKILL : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_NOTIFY_SKILL(std::shared_ptr<ZoneSocket> sock);
	~ZC_NOTIFY_SKILL();
...
#endif /* HORIZON_ZONE_ZC_NOTIFY_SKILL_HPP */

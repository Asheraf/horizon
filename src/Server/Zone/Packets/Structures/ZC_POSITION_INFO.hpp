...
#ifndef HORIZON_ZONE_ZC_POSITION_INFO_HPP
#define HORIZON_ZONE_ZC_POSITION_INFO_HPP
 ...
 *
 */ 
class ZC_POSITION_INFO : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_POSITION_INFO(std::shared_ptr<ZoneSocket> sock);
	~ZC_POSITION_INFO();
...
#endif /* HORIZON_ZONE_ZC_POSITION_INFO_HPP */

...
#ifndef HORIZON_ZONE_ZC_PC_SELL_ITEMLIST_HPP
#define HORIZON_ZONE_ZC_PC_SELL_ITEMLIST_HPP
 ...
 *
 */ 
class ZC_PC_SELL_ITEMLIST : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_PC_SELL_ITEMLIST(std::shared_ptr<ZoneSocket> sock);
	~ZC_PC_SELL_ITEMLIST();
...
#endif /* HORIZON_ZONE_ZC_PC_SELL_ITEMLIST_HPP */

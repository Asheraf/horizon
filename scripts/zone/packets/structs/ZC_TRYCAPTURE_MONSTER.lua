...
function ZC_TRYCAPTURE_MONSTER.new(o)
	o = o or ZC_TRYCAPTURE_MONSTER
	setmetatable(o, self)
	self.__index = self
	return o
end

function ZC_TRYCAPTURE_MONSTER.serialize()

end

return ZC_TRYCAPTURE_MONSTER

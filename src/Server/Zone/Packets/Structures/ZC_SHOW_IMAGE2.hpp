...
#ifndef HORIZON_ZONE_ZC_SHOW_IMAGE2_HPP
#define HORIZON_ZONE_ZC_SHOW_IMAGE2_HPP
 ...
 *
 */ 
class ZC_SHOW_IMAGE2 : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_SHOW_IMAGE2(std::shared_ptr<ZoneSocket> sock);
	~ZC_SHOW_IMAGE2();
...
#endif /* HORIZON_ZONE_ZC_SHOW_IMAGE2_HPP */

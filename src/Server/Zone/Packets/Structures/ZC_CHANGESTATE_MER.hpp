...
#ifndef HORIZON_ZONE_ZC_CHANGESTATE_MER_HPP
#define HORIZON_ZONE_ZC_CHANGESTATE_MER_HPP
 ...
 *
 */ 
class ZC_CHANGESTATE_MER : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_CHANGESTATE_MER(std::shared_ptr<ZoneSocket> sock);
	~ZC_CHANGESTATE_MER();
...
#endif /* HORIZON_ZONE_ZC_CHANGESTATE_MER_HPP */

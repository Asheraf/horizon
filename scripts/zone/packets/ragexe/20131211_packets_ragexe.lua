...
d:add(0x092b, 36, require('CZ_ACK_STORE_PASSWORD'))
d:add(0x083c, 26, require('CZ_ADD_FRIENDS'))
...
d:add(0x086e, -1, require('CZ_ITEMLISTWIN_RES'))
d:add(0x0366, 6, require('CZ_ITEM_PICKUP'))
d:add(0x08ab, 6, require('CZ_ITEM_THROW'))
d:add(0x094c, 8, require('CZ_JOIN_BATTLE_FIELD'))
d:add(0x0892, 8, require('CZ_MOVE_ITEM_FROM_BODY_TO_STORE'))
d:add(0x0931, 8, require('CZ_MOVE_ITEM_FROM_STORE_TO_BODY'))
d:add(0x08a3, 18, require('CZ_PARTY_BOOKING_REQ_REGISTER'))

...
#ifndef HORIZON_ZONE_CZ_REQNAME_BYGID2_HPP
#define HORIZON_ZONE_CZ_REQNAME_BYGID2_HPP
...
/**
 * @brief Main object for the aegis packet: CZ_REQNAME_BYGID2
 * Size : 26 @ 20080701
 *
 */ 
class CZ_REQNAME_BYGID2 : public Base::NetworkPacket<ZoneSocket>
{
public:
	CZ_REQNAME_BYGID2(std::shared_ptr<ZoneSocket> sock);
	~CZ_REQNAME_BYGID2();
...
#endif /* HORIZON_ZONE_CZ_REQNAME_BYGID2_HPP */

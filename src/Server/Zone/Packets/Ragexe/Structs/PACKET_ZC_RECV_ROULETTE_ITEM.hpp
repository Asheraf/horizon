...
#ifndef HORIZON_ZONE_RAGEXE_PACKET_ZC_RECV_ROULETTE_ITEM_HPP
#define HORIZON_ZONE_RAGEXE_PACKET_ZC_RECV_ROULETTE_ITEM_HPP
...
#endif /* HORIZON_ZONE_RAGEXE_PACKET_ZC_RECV_ROULETTE_ITEM_HPP */

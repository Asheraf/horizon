...
#ifndef HORIZON_ZONE_ZC_RECV_ROULETTE_ITEM_HPP
#define HORIZON_ZONE_ZC_RECV_ROULETTE_ITEM_HPP
 ...
 *
 */ 
class ZC_RECV_ROULETTE_ITEM : public Base::NetworkPacket<ZoneSocket>
{
public:
	ZC_RECV_ROULETTE_ITEM(std::shared_ptr<ZoneSocket> sock);
...
#endif /* HORIZON_ZONE_ZC_RECV_ROULETTE_ITEM_HPP */

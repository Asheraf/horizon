...
#ifndef HORIZON_ZONE_CZ_INPUT_EDITDLG_HPP
#define HORIZON_ZONE_CZ_INPUT_EDITDLG_HPP
...
/**
 * @brief Main object for the aegis packet: CZ_INPUT_EDITDLG
 * Size : 10 @ 0
 *
 */ 
class CZ_INPUT_EDITDLG : public Base::NetworkPacket<ZoneSocket>
{
public:
	CZ_INPUT_EDITDLG(std::shared_ptr<ZoneSocket> sock);
	~CZ_INPUT_EDITDLG();
...
#endif /* HORIZON_ZONE_CZ_INPUT_EDITDLG_HPP */
